...
public final class WindowsAsynchronousFileChannelImplRMHooks {
   ...
   public void close() throws IOException {
      ...
      try {
         ...
         if (var14) {
            JavaIOFileDescriptorAccess var7 = SharedSecrets.getJavaIOFileDescriptorAccess();
            long var8 = var7.getHandle(this.fdObj);
            if (var8 == -1L) {
               var8 = (long)var7.get(this.fdObj);
            }

            ResourceIdImpl var10 = ResourceIdImpl.of((Object)var8);
            ResourceRequest var11 = ApproverGroup.FILEDESCRIPTOR_OPEN_GROUP.getApprover(this.fdObj);
            var11.request(-1L, var10);
            var11 = ApproverGroup.FILE_OPEN_GROUP.getApprover(this);
            var11.request(-1L, var10);
         }
      }

      JavaIOFileDescriptorAccess var1 = SharedSecrets.getJavaIOFileDescriptorAccess();
      long var2 = var1.getHandle(this.fdObj);
      if (var2 == -1L) {
         var2 = (long)var1.get(this.fdObj);
      }

      ResourceIdImpl var4 = ResourceIdImpl.of((Object)var2);
      ResourceRequest var5 = ApproverGroup.FILEDESCRIPTOR_OPEN_GROUP.getApprover(this.fdObj);
