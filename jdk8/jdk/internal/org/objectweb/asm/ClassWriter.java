...
public class ClassWriter extends ClassVisitor {
   ...
   public ClassWriter(int var1) {
      ...
      this.key3 = new Item();
      this.key4 = new Item();
      this.computeMaxs = (var1 & 1) != 0;
      this.computeFrames = (var1 & 2) != 0;
   }
   ...
   public final MethodVisitor visitMethod(int var1, String var2, String var3, String var4, String[] var5) {
      return new MethodWriter(this, var1, var2, var3, var4, var5, this.computeMaxs, this.computeFrames);
   }
   ...
   public byte[] toByteArray() {
      if (this.index > 65535) {
         ...
         if (this.invalidFrames) {
            ...
            (new ClassReader(var7.data)).accept(this, 4);
   ...
   Item newConstItem(Object var1) {
      ...
      if (var1 instanceof Integer) {
         ...
         return this.newDouble(var5);
      } else if (var1 instanceof String) {
         return this.newString((String)var1);
      } else if (var1 instanceof Type) {
         Type var4 = (Type)var1;
         int var3 = var4.getSort();
         if (var3 == 10) {
            return this.newClassItem(var4.getInternalName());
         } else {
            return var3 == 11 ? this.newMethodTypeItem(var4.getDescriptor()) : this.newClassItem(var4.getDescriptor());
         }
      } else if (var1 instanceof Handle) {
         Handle var2 = (Handle)var1;
         return this.newHandleItem(var2.tag, var2.owner, var2.name, var2.desc);
      } else {
   ...
   Item newHandleItem(int var1, String var2, String var3, String var4) {
      this.key4.set(20 + var1, var2, var3, var4);
      Item var5 = this.get(this.key4);
      if (var5 == null) {
         if (var1 <= 4) {
            this.put112(15, var1, this.newField(var2, var3, var4));
         } else {
            this.put112(15, var1, this.newMethod(var2, var3, var4, var1 == 9));
         }

         var5 = new Item(this.index++, this.key4);
         this.put(var5);
      }
   ...
   public int newHandle(int var1, String var2, String var3, String var4) {
      return this.newHandleItem(var1, var2, var3, var4).index;
   }
   ...
   Item newInvokeDynamicItem(String var1, String var2, Handle var3, Object... var4) {
      ...
      var5.putShort(this.newHandle(var3.tag, var3.owner, var3.name, var3.desc));
   ...
   static {
      byte[] var1 = new byte[220];
      String var2 = "AAAAAAAAAAAAAAAABCLMMDDDDDEEEEEEEEEEEEEEEEEEEEAAAAAAAADDDDDEEEEEEEEEEEEEEEEEEEEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAANAAAAAAAAAAAAAAAAAAAAJJJJJJJJJJJJJJJJDOPAAAAAAGGGGGGGHIFBFAAFFAARQJJKKJJJJJJJJJJJJJJJJJJ";

      for(int var0 = 0; var0 < var1.length; ++var0) {
         var1[var0] = (byte)(var2.charAt(var0) - 65);
      }
