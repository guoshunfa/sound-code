...
final class Frame {
   ...
   private static int type(ClassWriter var0, String var1) {
      int var3 = var1.charAt(0) == '(' ? var1.indexOf(41) + 1 : 0;
      String var2;
      ...
      default:
         int var5;
         for(var5 = var3 + 1; var1.charAt(var5) == '['; ++var5) {
         }
         ...
         case 'Y':
         default:
            var2 = var1.substring(var5 + 1, var1.length() - 1);
            var4 = 24117248 | var0.addType(var2);
            break;
         case 'F':
            var4 = 16777218;
            break;
      ...
      case 'J':
         return 16777220;
      case 'L':
         var2 = var1.substring(var3 + 1, var1.length() - 1);
         return 24117248 | var0.addType(var2);
      case 'V':
         return 0;
      }
   }
   ...
   void initInputFrame(ClassWriter var1, int var2, Type[] var3, int var4) {
   ...
   boolean merge(ClassWriter var1, Frame var2, int var3) {
      boolean var4 = false;
      int var10 = this.inputLocals.length;
      int var11 = this.inputStack.length;
      if (var2.inputLocals == null) {
         var2.inputLocals = new int[var10];
         var4 = true;
      }
      ...
      for(var5 = 0; var5 < var10; ++var5) {
         if (this.outputLocals != null && var5 < this.outputLocals.length) {
            var6 = this.outputLocals[var5];
            if (var6 == 0) {
               var9 = this.inputLocals[var5];
            } else {
               var7 = var6 & -268435456;
               var8 = var6 & 251658240;
               if (var8 == 16777216) {
                  ...
                  if (var8 == 33554432) {
                     var9 = var7 + this.inputLocals[var6 & 8388607];
                  } else {
                     var9 = var7 + this.inputStack[var11 - (var6 & 8388607)];
                  }

                  if ((var6 & 8388608) != 0 && (var9 == 16777220 || var9 == 16777219)) {
                     var9 = 16777216;
                  }
               }
            }
         ...
         var4 |= merge(var1, var9, var2.inputLocals, var5);
      }
      ...
      if (var3 > 0) {
         ...
         for(var5 = 0; var5 < var12; ++var5) {
            var9 = this.inputStack[var5];
            if (this.initializations != null) {
               var9 = this.init(var1, var9);
            }

            var4 |= merge(var1, var9, var2.inputStack, var5);
         }

         for(var5 = 0; var5 < this.outputStackTop; ++var5) {
            var6 = this.outputStack[var5];
            var7 = var6 & -268435456;
            var8 = var6 & 251658240;
            if (var8 == 16777216) {
               var9 = var6;
            ...
            var4 |= merge(var1, var9, var2.inputStack, var12 + var5);
         }
