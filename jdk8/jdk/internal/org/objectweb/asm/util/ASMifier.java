...
public class ASMifier extends Printer {
   ...
   public void visit(int var1, int var2, String var3, String var4, String var5, String[] var6) {
      ...
      if (var8 == -1) {
         ...
         this.text.add("package asm." + var3.substring(0, var8).replace('/', '.') + ";\n");
         var7 = var3.substring(var8 + 1);
      }

      this.text.add("import java.util.*;\n");
      this.text.add("import jdk.internal.org.objectweb.asm.*;\n");
      this.text.add("public class " + var7 + "Dump implements Opcodes {\n\n");
   ...
   public Printer visitLocalVariableAnnotation(int var1, TypePath var2, Label[] var3, Label[] var4, int[] var5, String var6, boolean var7) {
      ...
      this.buf.append(var1);
      this.buf.append(", TypePath.fromString(\"").append((Object)var2).append("\"), ");
      this.buf.append("new Label[] {");
   ...
   public ASMifier visitTypeAnnotation(String var1, int var2, TypePath var3, String var4, boolean var5) {
      ...
      this.buf.append(", TypePath.fromString(\"").append((Object)var3).append("\"), ");
      this.appendConstant(var4);
   ...
   static void appendConstant(StringBuffer var0, Object var1) {
      if (var1 == null) {
         ...
         var0.append("new Character((char)").append((int)var4).append(')');
         ...
         if (var1 instanceof byte[]) {
            ...
            for(var3 = 0; var3 < var5.length; ++var3) {
               var0.append(var3 == 0 ? "" : ",").append((int)var5[var3]);
            }
            ...
            for(var3 = 0; var3 < var7.length; ++var3) {
               var0.append(var3 == 0 ? "" : ",").append("(short)").append((int)var7[var3]);
            }
            ...
            for(var3 = 0; var3 < var8.length; ++var3) {
               var0.append(var3 == 0 ? "" : ",").append("(char)").append((int)var8[var3]);
            }
