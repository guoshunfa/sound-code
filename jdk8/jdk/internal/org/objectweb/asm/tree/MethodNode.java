...
public class MethodNode extends MethodVisitor {
   ...
   public void accept(MethodVisitor var1) {
      int var4 = this.parameters == null ? 0 : this.parameters.size();

      int var2;
      for(var2 = 0; var2 < var4; ++var2) {
         ParameterNode var5 = (ParameterNode)this.parameters.get(var2);
         var1.visitParameter(var5.name, var5.access);
      }
      ...
      var4 = this.visibleAnnotations == null ? 0 : this.visibleAnnotations.size();

      AnnotationNode var8;
      for(var2 = 0; var2 < var4; ++var2) {
         var8 = (AnnotationNode)this.visibleAnnotations.get(var2);
      ...
      for(var2 = 0; var2 < var4; ++var2) {
         var8 = (AnnotationNode)this.invisibleAnnotations.get(var2);
      ...
      var4 = this.visibleParameterAnnotations == null ? 0 : this.visibleParameterAnnotations.length;
      ...
      for(var2 = 0; var2 < var4; ++var2) {
         ...
         if (var10 != null) {
            for(var3 = 0; var3 < var10.size(); ++var3) {
               var6 = (AnnotationNode)var10.get(var3);
               var6.accept(var1.visitParameterAnnotation(var2, var6.desc, true));
            }
         }
      }

      var4 = this.invisibleParameterAnnotations == null ? 0 : this.invisibleParameterAnnotations.length;
      ...
      for(var2 = 0; var2 < var4; ++var2) {
         ...
         if (var10 != null) {
            for(var3 = 0; var3 < var10.size(); ++var3) {
               var6 = (AnnotationNode)var10.get(var3);
               var6.accept(var1.visitParameterAnnotation(var2, var6.desc, false));
            }
         }
      }
      ...
      if (this.instructions.size() > 0) {
         var1.visitCode();
         var4 = this.tryCatchBlocks == null ? 0 : this.tryCatchBlocks.size();
         ...
         var4 = this.localVariables == null ? 0 : this.localVariables.size();

         for(var2 = 0; var2 < var4; ++var2) {
            ((LocalVariableNode)this.localVariables.get(var2)).accept(var1);
         }

         var4 = this.visibleLocalVariableAnnotations == null ? 0 : this.visibleLocalVariableAnnotations.size();

         for(var2 = 0; var2 < var4; ++var2) {
            ((LocalVariableAnnotationNode)this.visibleLocalVariableAnnotations.get(var2)).accept(var1, true);
         }

         var4 = this.invisibleLocalVariableAnnotations == null ? 0 : this.invisibleLocalVariableAnnotations.size();
