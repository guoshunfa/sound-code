...
public class Frame<V extends Value> {
   ...
   public void execute(AbstractInsnNode var1, Interpreter<V> var2) throws AnalyzerException {
      ...
      case 58:
         ...
         var8 = ((VarInsnNode)var1).var;
         this.setLocal(var8, var3);
         if (var3.getSize() == 2) {
            this.setLocal(var8 + 1, var2.newValue((Type)null));
         }

         if (var8 > 0) {
            Value var12 = this.getLocal(var8 - 1);
      ...
      case 131:
         ...
         break;
      case 132:
         var8 = ((IincInsnNode)var1).var;
         this.setLocal(var8, var2.unaryOperation(var1, this.getLocal(var8)));
         break;
      case 133:
      case 134:
      case 135:
      ...
      case 185:
         ...
         if (Type.getReturnType(var11) == Type.VOID_TYPE) {
            var2.naryOperation(var1, var7);
         } else {
            this.push(var2.naryOperation(var1, var7));
         }
         break;
      case 186:
         var7 = new ArrayList();
   ...
   public String toString() {
      ...
      for(var2 = 0; var2 < this.getLocals(); ++var2) {
         var1.append((Object)this.getLocal(var2));
      }
