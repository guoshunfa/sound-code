...
public class ClassReader {
      ...
      while(true) {
            ...
            if ("LocalVariableTable".equals(var28)) {
               ...
               if ((var2.flags & 2) == 0) {
                  ...
                  for(var46 = var3; var29 > 0; --var29) {
                     ...
                     var11[var31].line = this.readUnsignedShort(var46 + 12);
                     var46 += 4;
                  }
               }
            } else if ("RuntimeVisibleTypeAnnotations".equals(var28)) {
               var37 = this.readTypeAnnotations(var1, var2, var3 + 8, true);
               ...
               var39 = this.readTypeAnnotations(var1, var2, var3 + 8, false);
         ...
         while(var3 < var10) {
            ...
            if (var44 != null) {
               ...
               if ((var2.flags & 2) == 0 && var44.line > 0) {
                  var1.visitLineNumber(var44.line, var44);
               }
            }

            while(var25 != null && (var25.offset == var27 || var25.offset == -1)) {
               if (var25.offset != -1) {
                  if (var20 && !var21) {
            ...
            case 6:
            case 7:
               var46 = this.items[this.readUnsignedShort(var3 + 1)];
               boolean var51 = var4[var46 - 1] == 11;
               var50 = this.readClass(var46, var5);
               var46 = this.items[this.readUnsignedShort(var46 + 2)];
            ...
            case 8:
               var46 = this.items[this.readUnsignedShort(var3 + 1)];
               var31 = var2.bootstrapMethods[this.readUnsignedShort(var46)];
            ...
            for(var3 += 5; var37 != null && var14 < var37.length && var42 <= var27; var42 = var14 < var37.length && this.readByte(var37[var14]) >= 67 ? this.readUnsignedShort(var37[var14] + 1) : -1) {
               if (var42 == var27) {
                  var46 = this.readAnnotationTarget(var2, var37[var14]);
                  this.readAnnotationValues(var46 + 2, var5, true, var1.visitInsnAnnotation(var2.typeRef, var2.typePath, this.readUTF8(var46, var5), true));
               }
            ...
            while(var39 != null && var40 < var39.length && var17 <= var27) {
               if (var17 == var27) {
                  var46 = this.readAnnotationTarget(var2, var39[var40]);
                  this.readAnnotationValues(var46 + 2, var5, true, var1.visitInsnAnnotation(var2.typeRef, var2.typePath, this.readUTF8(var46, var5), false));
               }
         ...
         if (var37 != null) {
            for(var27 = 0; var27 < var37.length; ++var27) {
               if (this.readByte(var37[var27]) >> 1 == 32) {
                  var43 = this.readAnnotationTarget(var2, var37[var27]);
                  this.readAnnotationValues(var43 + 2, var5, true, var1.visitLocalVariableAnnotation(var2.typeRef, var2.typePath, var2.start, var2.end, var2.index, this.readUTF8(var43, var5), true));
               }
            }
         }
         ...
         if (var39 != null) {
            for(var27 = 0; var27 < var39.length; ++var27) {
               if (this.readByte(var39[var27]) >> 1 == 32) {
                  var43 = this.readAnnotationTarget(var2, var39[var27]);
                  this.readAnnotationValues(var43 + 2, var5, true, var1.visitLocalVariableAnnotation(var2.typeRef, var2.typePath, var2.start, var2.end, var2.index, this.readUTF8(var43, var5), false));
               }
            }
         }

         while(var26 != null) {
            Attribute var47 = var26.next;
            var26.next = null;
   ...
   private void readParameterAnnotations(MethodVisitor var1, Context var2, int var3, boolean var4) {
      ...
      int var7 = Type.getArgumentTypes(var2.desc).length - var6;
      ...
      for(char[] var9 = var2.buffer; var5 < var6 + var7; ++var5) {
         ...
         case 91:
            ...
            case 66:
               ...
               for(var5 = 0; var5 < var6; ++var5) {
                  var7[var5] = (byte)this.readInt(this.items[this.readUnsignedShort(var1)]);
                  var1 += 3;
               }
            ...
            case 67:
               ...
               for(var5 = 0; var5 < var6; ++var5) {
                  var10[var5] = (char)this.readInt(this.items[this.readUnsignedShort(var1)]);
                  var1 += 3;
               }
            ...
            case 68:
               ...
               for(var5 = 0; var5 < var6; ++var5) {
                  var14[var5] = Double.longBitsToDouble(this.readLong(this.items[this.readUnsignedShort(var1)]));
                  var1 += 3;
               }
            ...
            case 70:
               ...
               for(var5 = 0; var5 < var6; ++var5) {
                  var13[var5] = Float.intBitsToFloat(this.readInt(this.items[this.readUnsignedShort(var1)]));
                  var1 += 3;
               }
            ...
            case 73:
               ...
               for(var5 = 0; var5 < var6; ++var5) {
                  var11[var5] = this.readInt(this.items[this.readUnsignedShort(var1)]);
                  var1 += 3;
               }
            ...
            case 74:
               ...
               for(var5 = 0; var5 < var6; ++var5) {
                  var12[var5] = this.readLong(this.items[this.readUnsignedShort(var1)]);
                  var1 += 3;
               }
            ...
            case 83:
               ...
               for(var5 = 0; var5 < var6; ++var5) {
                  var9[var5] = (short)this.readInt(this.items[this.readUnsignedShort(var1)]);
                  var1 += 3;
               }
            ...
            case 90:
               ...
               for(var5 = 0; var5 < var6; ++var5) {
                  var8[var5] = this.readInt(this.items[this.readUnsignedShort(var1)]) != 0;
                  var1 += 3;
               }
