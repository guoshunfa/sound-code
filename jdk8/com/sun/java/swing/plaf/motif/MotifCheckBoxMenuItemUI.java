...
public class MotifCheckBoxMenuItemUI extends BasicCheckBoxMenuItemUI {
   ...
   protected ChangeListener createChangeListener(JComponent var1) {
      return new MotifCheckBoxMenuItemUI.ChangeHandler();
   }

   protected MouseInputListener createMouseInputListener(JComponent var1) {
      return new MotifCheckBoxMenuItemUI.MouseInputHandler();
   }
   ...
   protected class MouseInputHandler implements MouseInputListener {
      ...
      public void mousePressed(MouseEvent var1) {
         ...
         var2.setSelectedPath(MotifCheckBoxMenuItemUI.this.getPath());
      }
