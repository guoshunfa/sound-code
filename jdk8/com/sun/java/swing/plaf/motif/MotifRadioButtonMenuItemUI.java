...
public class MotifRadioButtonMenuItemUI extends BasicRadioButtonMenuItemUI {
   ...
   protected ChangeListener createChangeListener(JComponent var1) {
      return new MotifRadioButtonMenuItemUI.ChangeHandler();
   }

   protected MouseInputListener createMouseInputListener(JComponent var1) {
      return new MotifRadioButtonMenuItemUI.MouseInputHandler();
   }
   ...
   protected class MouseInputHandler implements MouseInputListener {
      ...
      public void mousePressed(MouseEvent var1) {
         ...
         var2.setSelectedPath(MotifRadioButtonMenuItemUI.this.getPath());
      }
   ...
   protected class ChangeHandler implements ChangeListener, Serializable {
      public void stateChanged(ChangeEvent var1) {
         ...
         LookAndFeel.installProperty(var2, "borderPainted", var2.isArmed());
      }
   }
}
