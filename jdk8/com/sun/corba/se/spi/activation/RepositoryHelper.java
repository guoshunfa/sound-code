...
public abstract class RepositoryHelper {
   ...
   public static Repository read(InputStream var0) {
      return narrow(var0.read_Object(_RepositoryStub.class));
   }
   ...
   public static Repository narrow(Object var0) {
      if (var0 == null) {
         return null;
      } else if (var0 instanceof Repository) {
         return (Repository)var0;
      } else if (!var0._is_a(id())) {
         throw new BAD_PARAM();
      } else {
         Delegate var1 = ((ObjectImpl)var0)._get_delegate();
         _RepositoryStub var2 = new _RepositoryStub();
         var2._set_delegate(var1);
         return var2;
      }
   }

   public static Repository unchecked_narrow(Object var0) {
      if (var0 == null) {
         return null;
      } else if (var0 instanceof Repository) {
         return (Repository)var0;
