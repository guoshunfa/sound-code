...
public class PNGMetadataFormat extends IIOMetadataFormatImpl {
   ...
   private PNGMetadataFormat() {
      ...
      this.addAttribute("IHDR", "bitDepth", 2, true, (String)null, Arrays.asList(PNGMetadata.IHDR_bitDepths));
      String[] var1 = new String[]{"Grayscale", "RGB", "Palette", "GrayAlpha", "RGBAlpha"};
      this.addAttribute("IHDR", "colorType", 0, true, (String)null, Arrays.asList(var1));
      this.addAttribute("IHDR", "compressionMethod", 0, true, (String)null, Arrays.asList(PNGMetadata.IHDR_compressionMethodNames));
      this.addAttribute("IHDR", "filterMethod", 0, true, (String)null, Arrays.asList(PNGMetadata.IHDR_filterMethodNames));
      this.addAttribute("IHDR", "interlaceMethod", 0, true, (String)null, Arrays.asList(PNGMetadata.IHDR_interlaceMethodNames));
      ...
      this.addAttribute("iCCP", "compressionMethod", 0, true, (String)null, Arrays.asList(PNGMetadata.iCCP_compressionMethodNames));
      ...
      this.addAttribute("pHYS", "unitSpecifier", 0, true, (String)null, Arrays.asList(PNGMetadata.unitSpecifierNames));
      ...
      this.addAttribute("sRGB", "renderingIntent", 0, true, (String)null, Arrays.asList(PNGMetadata.renderingIntentNames));
      ...
      this.addAttribute("zTXtEntry", "compressionMethod", 0, true, (String)null, Arrays.asList(PNGMetadata.zTXt_compressionMethodNames));
