...
public final class DatatypeConverterImpl implements DatatypeConverterInterface {
   ...
   public static DatatypeFactory getDatatypeFactory() {
      ClassLoader tccl = (ClassLoader)AccessController.doPrivileged(new PrivilegedAction<ClassLoader>() {
      ...
      if (df == null) {
         Class var2 = DatatypeConverterImpl.class;
         synchronized(DatatypeConverterImpl.class) {
            ...
            if (df == null) {
               try {
                  ...
                  throw new Error(Messages.FAILED_TO_INITIALE_DATATYPE_FACTORY.format(), var5);
               }
