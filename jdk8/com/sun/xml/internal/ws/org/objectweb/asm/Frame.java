...
final class Frame {
   ...
   private int init(ClassWriter cw, int t) {
      ...
      for(int j = 0; j < this.initializationCount; ++j) {
         ...
         if (kind == 33554432) {
            u = dim + this.inputLocals[u & 16777215];
         } else if (kind == 50331648) {
            u = dim + this.inputStack[this.inputStack.length - (u & 16777215)];
         }
      ...
      for(i = 0; i < nLocal; ++i) {
         if (this.outputLocals != null && i < this.outputLocals.length) {
            ...
            if (s == 0) {
               ...
               kind = s & 251658240;
               if (kind == 33554432) {
                  t = dim + this.inputLocals[s & 16777215];
               } else if (kind == 50331648) {
                  t = dim + this.inputStack[nStack - (s & 16777215)];
               } else {
                  t = s;
               }
            }
            ...
            if ((u & 267386880) != 24117248 && (u & -268435456) == 0) {
               ...
               if ((t & -1048576) == (u & -1048576)) {
                  if ((u & 267386880) == 24117248) {
                     ...
                     v = 24117248 | cw.addType("java/lang/Object");
                  }
