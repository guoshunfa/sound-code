...
public final class Signature extends Attribute {
   ...
   private static final void matchIdent(Signature.MyByteArrayInputStream in, StringBuffer buf) {
      int ch;
      if ((ch = in.read()) == -1) {
   ...
   private static final void matchGJIdent(Signature.MyByteArrayInputStream in, StringBuffer buf) {
      matchIdent(in, buf);
      int ch = in.read();
      if (ch != 60 && ch != 40) {
         in.unread();
