...
public abstract class Utility {
   ...
   public static final String methodSignatureToString(String signature, String name, String access, boolean chopit, LocalVariableTable vars) throws ClassFormatException {
      ...
      try {
         ...
         int index;
         for(index = 1; signature.charAt(index) != ')'; index += consumed_chars) {
   ...
   public static final String signatureToString(String signature, boolean chopit) {
      ...
      try {
         ...
         throw new ClassFormatException("Invalid signature: " + var8 + ":" + signature);
      }
   }
   ...
   public static String getSignature(String type) {
      ...
      int brackets;
      label58:
      for(brackets = 0; brackets < chars.length; ++brackets) {
         switch(chars[brackets]) {
         case '\t':
         case '\n':
         case '\f':
         case '\r':
   ...
   public static String encode(byte[] bytes, boolean compress) throws IOException {
      ...
      Utility.JavaWriter jw = new Utility.JavaWriter(caw);
   ...
   public static byte[] decode(String s, boolean uncompress) throws IOException {
      ...
      Utility.JavaReader jr = new Utility.JavaReader(car);
