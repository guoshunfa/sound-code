...
public class ConstantPoolGen implements Serializable {
   ...
   public ConstantPoolGen(Constant[] cs) {
      ...
      for(int i = 1; i < this.index; ++i) {
         ...
         if (c instanceof ConstantString) {
            ...
            this.string_table.put(u8.getBytes(), new ConstantPoolGen.Index(i));
         } else if (c instanceof ConstantClass) {
            ConstantClass s = (ConstantClass)c;
            u8 = (ConstantUtf8)this.constants[s.getNameIndex()];
            this.class_table.put(u8.getBytes(), new ConstantPoolGen.Index(i));
            ...
            this.n_a_t_table.put(u8.getBytes() + "%" + u8_2.getBytes(), new ConstantPoolGen.Index(i));
         } else if (c instanceof ConstantUtf8) {
            ConstantUtf8 u = (ConstantUtf8)c;
            this.utf8_table.put(u.getBytes(), new ConstantPoolGen.Index(i));
            ...
            this.cp_table.put(class_name + delim + method_name + delim + signature, new ConstantPoolGen.Index(i));
         }
      }
   ...
   public int lookupString(String str) {
      ConstantPoolGen.Index index = (ConstantPoolGen.Index)this.string_table.get(str);
   ...
   public int addString(String str) {
      ...
      if ((ret = this.lookupString(str)) != -1) {
         ...
         this.string_table.put(str, new ConstantPoolGen.Index(ret));
         return ret;
      }
   }

   public int lookupClass(String str) {
      ConstantPoolGen.Index index = (ConstantPoolGen.Index)this.class_table.get(str.replace('.', '/'));
      return index != null ? index.index : -1;
   }
   ...
   private int addClass_(String clazz) {
      ...
      if ((ret = this.lookupClass(clazz)) != -1) {
         ...
         this.class_table.put(clazz, new ConstantPoolGen.Index(ret));
         return ret;
      }
   }
   ...
   public int lookupUtf8(String n) {
      ConstantPoolGen.Index index = (ConstantPoolGen.Index)this.utf8_table.get(n);
      return index != null ? index.index : -1;
   }
   ...
   public int addUtf8(String n) {
      ...
      if ((ret = this.lookupUtf8(n)) != -1) {
         ...
         this.utf8_table.put(n, new ConstantPoolGen.Index(ret));
         return ret;
      }
   }
   ...
   public int lookupNameAndType(String name, String signature) {
      ConstantPoolGen.Index index = (ConstantPoolGen.Index)this.n_a_t_table.get(name + "%" + signature);
      return index != null ? index.index : -1;
   }
   ...
   public int addNameAndType(String name, String signature) {
      ...
      if ((ret = this.lookupNameAndType(name, signature)) != -1) {
         ...
         this.n_a_t_table.put(name + "%" + signature, new ConstantPoolGen.Index(ret));
         return ret;
      }
   }

   public int lookupMethodref(String class_name, String method_name, String signature) {
      ConstantPoolGen.Index index = (ConstantPoolGen.Index)this.cp_table.get(class_name + ":" + method_name + ":" + signature);
      return index != null ? index.index : -1;
   }
   ...
   public int addMethodref(String class_name, String method_name, String signature) {
      ...
      if ((ret = this.lookupMethodref(class_name, method_name, signature)) != -1) {
         ...
         this.cp_table.put(class_name + ":" + method_name + ":" + signature, new ConstantPoolGen.Index(ret));
         return ret;
      }
   }
   ...
   public int lookupFieldref(String class_name, String field_name, String signature) {
      ConstantPoolGen.Index index = (ConstantPoolGen.Index)this.cp_table.get(class_name + "&" + field_name + "&" + signature);
      return index != null ? index.index : -1;
   }
   ...
   public int addFieldref(String class_name, String field_name, String signature) {
      ...
      if ((ret = this.lookupFieldref(class_name, field_name, signature)) != -1) {
         ...
         this.cp_table.put(class_name + "&" + field_name + "&" + signature, new ConstantPoolGen.Index(ret));
         return ret;
      }
   }
