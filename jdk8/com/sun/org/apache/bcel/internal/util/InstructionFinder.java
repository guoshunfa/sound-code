...
public class InstructionFinder {
   ...
   public final Iterator search(String pattern, InstructionHandle from, InstructionFinder.CodeConstraint constraint) {
      ...
      if (start == -1) {
         ...
         } catch (RESyntaxException var12) {
            System.err.println((Object)var12);
            return null;
         }
      }
   }
   ...
   public final Iterator search(String pattern) {
      return this.search(pattern, this.il.getStart(), (InstructionFinder.CodeConstraint)null);
   }

   public final Iterator search(String pattern, InstructionHandle from) {
      return this.search(pattern, from, (InstructionFinder.CodeConstraint)null);
   }
