...
public class ClassPath implements Serializable {
   ...
   public ClassPath(String class_path) {
      ...
      StringTokenizer tok = new StringTokenizer(class_path, SecuritySupport.getSystemProperty("path.separator"));
         ...
         if (!path.equals("")) {
            ...
            try {
               if (SecuritySupport.getFileExists(file)) {
                  if (file.isDirectory()) {
                     vec.add(new ClassPath.Dir(path));
                  } else {
                     vec.add(new ClassPath.Zip(new ZipFile(file)));
                  }
               }
      ...
      this.paths = new ClassPath.PathEntry[vec.size()];
   ...
   public static final String getClassPath() {
      ...
      while(true) {
         ...
         do {
            ...
            extensions = SecuritySupport.getFileList(ext_dir, new FilenameFilter() {
   ...
   private static class Zip extends ClassPath.PathEntry {
      ...
      ClassPath.ClassFile getClassFile(String name, String suffix) throws IOException {
         ...
         return entry != null ? new ClassPath.ClassFile() {
   ...
   private abstract static class PathEntry implements Serializable {
      ...
      abstract ClassPath.ClassFile getClassFile(String var1, String var2) throws IOException;
