...
public class AbstractDOMParser extends AbstractXMLDocumentParser {
      ...
      if (!this.fDeferNodeExpansion) {
         ...
         if (augs != null) {
            ...
            if (elementPSVI != null && this.fNamespaceAware) {
               ...
               ((ElementNSImpl)el).setType((XSTypeDefinition)type);
            }
         }
         ...
         for(i = attrCount - 1; i >= 0; --i) {
            ...
            this.fDeferredDocumentImpl.setDeferredAttribute(el, attributes.getQName(i), attributes.getURI(i), attributes.getValue(i), attributes.isSpecified(i), id, type);
         }
   ...
   public void characters(XMLString text, Augmentations augs) throws XNIException {
      if (!this.fDeferNodeExpansion) {
         ...
         if (this.fCurrentCDATASectionIndex == -1) {
            cs = this.fDeferredDocumentImpl.createDeferredCDATASection(text.toString());
            ...
            cs = this.fDeferredDocumentImpl.createDeferredTextNode(text.toString(), false);
            this.fDeferredDocumentImpl.appendChild(this.fCurrentNodeIndex, cs);
         }
      } else if (!this.fInDTD) {
         if (text.length == 0) {
      ...
      if (this.fIncludeIgnorableWhitespace && !this.fFilterReject) {
         if (!this.fDeferNodeExpansion) {
            ...
            if (child != null && child.getNodeType() == 3) {
               ...
               textNode = this.fDocument.createTextNode(text.toString());
               if (this.fDocumentImpl != null) {
   ...
   public void endElement(QName element, Augmentations augs) throws XNIException {
      ...
      if (!this.fDeferNodeExpansion) {
         if (augs != null && this.fDocumentImpl != null && (this.fNamespaceAware || this.fStorePSVI)) {
            elementPSVI = (ElementPSVI)augs.getItem("ELEMENT_PSVI");
            if (elementPSVI != null) {
      ...
      if (!this.fDeferNodeExpansion) {
            ...
            if (this.fCurrentEntityDecl != null) {
               if (this.fCurrentEntityDecl != null && this.fCurrentEntityDecl.getFirstChild() == null) {
                  ...
                  for(Node child = this.fCurrentNode.getFirstChild(); child != null; child = child.getNextSibling()) {
                     parent = child.cloneNode(true);
                     this.fCurrentEntityDecl.appendChild(parent);
                  }
         ...
         if (this.fCreateEntityRefNodes) {
            ...
            if (this.fDOMFilter != null && (this.fDOMFilter.getWhatToShow() & 16) != 0) {
               code = this.fDOMFilter.acceptNode(this.fCurrentNode);
               switch(code) {
               case 2:
                  parent = this.fCurrentNode.getParentNode();
                  parent.removeChild(this.fCurrentNode);
         ...
         int childIndex;
         if (this.fDocumentTypeIndex != -1) {
            for(childIndex = this.fDeferredDocumentImpl.getLastChild(this.fDocumentTypeIndex, false); childIndex != -1; childIndex = this.fDeferredDocumentImpl.getRealPrevSibling(childIndex, false)) {
               code = this.fDeferredDocumentImpl.getNodeType(childIndex, false);
               if (code == 6) {
                  String nodeName = this.fDeferredDocumentImpl.getNodeName(childIndex, false);
                  if (nodeName.equals(name)) {
                     this.fDeferredEntityDecl = childIndex;
                     break;
                  }
               }
            }
         ...
         if (this.fDeferredEntityDecl != -1 && this.fDeferredDocumentImpl.getLastChild(this.fDeferredEntityDecl, false) == -1) {
            ...
            for(parentIndex = this.fDeferredDocumentImpl.getLastChild(this.fCurrentNodeIndex, false); parentIndex != -1; parentIndex = this.fDeferredDocumentImpl.getRealPrevSibling(parentIndex, false)) {
               prevIndex = this.fDeferredDocumentImpl.cloneNode(parentIndex, true);
               this.fDeferredDocumentImpl.insertBefore(this.fDeferredEntityDecl, prevIndex, childIndex);
         ...
         if (this.fCreateEntityRefNodes) {
            ...
            parentIndex = this.fDeferredDocumentImpl.getParentNode(this.fCurrentNodeIndex, false);
            prevIndex = this.fCurrentNodeIndex;
            length = childIndex;

            int sibling;
            for(boolean var17 = true; childIndex != -1; childIndex = sibling) {
               this.handleBaseURI(childIndex);
            ...
            if (length != -1) {
               this.fDeferredDocumentImpl.setAsLastChild(parentIndex, length);
            } else {
   ...
   public void internalEntityDecl(String name, XMLString text, XMLString nonNormalizedText, Augmentations augs) throws XNIException {
      if (this.fInternalSubset != null && !this.fInDTDExternalSubset) {
         ...
         this.fInternalSubset.append((char)(singleQuote ? '\'' : '"'));
      ...
      if (!name.startsWith("%")) {
         ...
         if (this.fDocumentTypeIndex != -1) {
            ...
            if (!found) {
               int entityIndex = this.fDeferredDocumentImpl.createDeferredEntity(name, (String)null, (String)null, (String)null, (String)this.fBaseURIStack.peek());
   ...
   public void externalEntityDecl(String name, XMLResourceIdentifier identifier, Augmentations augs) throws XNIException {
      ...
      if (!name.startsWith("%")) {
         ...
         if (this.fDocumentTypeIndex != -1) {
            ...
            if (!found) {
               int entityIndex = this.fDeferredDocumentImpl.createDeferredEntity(name, publicId, literalSystemId, (String)null, identifier.getBaseSystemId());
               this.fDeferredDocumentImpl.appendChild(this.fDocumentTypeIndex, entityIndex);
            }
         }
   ...
   public void attributeDecl(String elementName, String attributeName, String type, String[] enumeration, String defaultType, XMLString defaultValue, XMLString nonNormalizedDefaultValue, Augmentations augs) throws XNIException {
      ...
      if (this.fInternalSubset != null && !this.fInDTDExternalSubset) {
         ...
         if (!type.equals("ENUMERATION")) {
            ...
            for(elementDefIndex = 0; elementDefIndex < enumeration.length; ++elementDefIndex) {
               if (elementDefIndex > 0) {
                  this.fInternalSubset.append('|');
               }

               this.fInternalSubset.append(enumeration[elementDefIndex]);
            }
         ...
         if (defaultValue != null) {
            ...
            for(elementDefIndex = 0; elementDefIndex < defaultValue.length; ++elementDefIndex) {
               char c = defaultValue.ch[defaultValue.offset + elementDefIndex];
               if (c == '\'') {
                  this.fInternalSubset.append("&apos;");
               } else {
      ...
      if (this.fDeferredDocumentImpl != null) {
         if (defaultValue != null) {
            elementDefIndex = this.fDeferredDocumentImpl.lookupElementDefinition(elementName);
