...
public class XMLDTDProcessor implements XMLComponent, XMLDTDFilter, XMLDTDContentModelFilter {
   ...
   public void reset(XMLComponentManager componentManager) throws XMLConfigurationException {
      ...
      if (!parser_settings) {
         ...
         try {
            this.fValidator = (XMLDTDValidator)componentManager.getProperty("http://apache.org/xml/properties/internal/validator/dtd", (Object)null);
      ...
      if (this.fValidation) {
         ...
         if (type == XMLSymbols.fIDSymbol) {
            ...
            if (!this.fTableOfIDAttributeNames.containsKey(elementName)) {
               ...
               previousNOTATIONAttributeName = (String)this.fTableOfIDAttributeNames.get(elementName);
               this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MSG_MORE_THAN_ONE_ID_ATTRIBUTE", new Object[]{elementName, previousNOTATIONAttributeName, attributeName}, (short)1);
            }
         }
         ...
         if (type == XMLSymbols.fNOTATIONSymbol) {
            ...
            if (!this.fTableOfNOTATIONAttributeNames.containsKey(elementName)) {
               ...
               previousNOTATIONAttributeName = (String)this.fTableOfNOTATIONAttributeNames.get(elementName);
         ...
         if (defaultValue != null && (defaultType == null || defaultType != null && defaultType == XMLSymbols.fFIXEDSymbol)) {
            ...
            if (type != XMLSymbols.fNMTOKENSSymbol && type != XMLSymbols.fENTITIESSymbol && type != XMLSymbols.fIDREFSSymbol) {
               if (type != XMLSymbols.fENTITYSymbol && type != XMLSymbols.fIDSymbol && type != XMLSymbols.fIDREFSymbol && type != XMLSymbols.fNOTATIONSymbol) {
                  if ((type == XMLSymbols.fNMTOKENSymbol || type == XMLSymbols.fENUMERATIONSymbol) && !this.isValidNmtoken(value)) {
                     ok = false;
                  }
   ...
   public void endDTD(Augmentations augs) throws XNIException {
      ...
      if (this.fValidation) {
         DTDGrammar grammar = this.fDTDGrammar != null ? this.fDTDGrammar : this.fGrammarBucket.getActiveGrammar();
         Iterator entities = this.fNDataDeclNotations.entrySet().iterator();
         ...
         while(entities.hasNext()) {
            ...
            if (grammar.getNotationDeclIndex(notation) == -1) {
               notation = (String)entry.getKey();
               this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MSG_NOTATION_NOT_DECLARED_FOR_UNPARSED_ENTITYDECL", new Object[]{notation, notation}, (short)1);
            }
         }

         Iterator notationVals = this.fNotationEnumVals.entrySet().iterator();
         ...
         while(notationVals.hasNext()) {
            ...
            notation = (String)entry.getKey();
            if (grammar.getNotationDeclIndex(notation) == -1) {
               elementName = (String)entry.getValue();
               this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MSG_NOTATION_NOT_DECLARED_FOR_NOTATIONTYPE_ATTRIBUTE", new Object[]{elementName, notation}, (short)1);
            }
         }

         Iterator elementsWithNotations = this.fTableOfNOTATIONAttributeNames.entrySet().iterator();
   ...
   private void checkDeclaredElements(DTDGrammar grammar) {
      ...
      for(XMLContentSpec contentSpec = new XMLContentSpec(); elementIndex >= 0; elementIndex = grammar.getNextElementDeclIndex(elementIndex)) {
      ...
      if (contentSpec.type == 0) {
         ...
         if (contentSpec.type != 4 && contentSpec.type != 5) {
            if (contentSpec.type == 2 || contentSpec.type == 1 || contentSpec.type == 3) {
               leftNode = ((int[])((int[])contentSpec.value))[0];
