...
public final class Constants {
   ...
   private static final Enumeration fgEmptyEnumeration = new Constants.ArrayEnumeration(new Object[0]);

   private Constants() {
   }

   public static Enumeration getSAXFeatures() {
      return (Enumeration)(fgSAXFeatures.length > 0 ? new Constants.ArrayEnumeration(fgSAXFeatures) : fgEmptyEnumeration);
   }

   public static Enumeration getSAXProperties() {
      return (Enumeration)(fgSAXProperties.length > 0 ? new Constants.ArrayEnumeration(fgSAXProperties) : fgEmptyEnumeration);
   }

   public static Enumeration getXercesFeatures() {
      return (Enumeration)(fgXercesFeatures.length > 0 ? new Constants.ArrayEnumeration(fgXercesFeatures) : fgEmptyEnumeration);
   }

   public static Enumeration getXercesProperties() {
      return (Enumeration)(fgXercesProperties.length > 0 ? new Constants.ArrayEnumeration(fgXercesProperties) : fgEmptyEnumeration);
   }
