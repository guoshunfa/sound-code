...
class Token implements Serializable {
         ...
         synchronized(categories) {
            ...
            for(int i = 0; i < blockNames.length; ++i) {
               ...
               if (i < 84) {
                  ...
                  int rend = "\u0000\u007f\u0080ÿĀſƀɏɐʯʰ˿̀ͯͰϿЀӿ\u0530֏\u0590\u05ff\u0600ۿ܀ݏހ\u07bfऀॿ\u0980\u09ff\u0a00\u0a7f\u0a80\u0aff\u0b00\u0b7f\u0b80\u0bff\u0c00౿\u0c80\u0cff\u0d00ൿ\u0d80\u0dff\u0e00\u0e7f\u0e80\u0effༀ\u0fffက႟Ⴀჿᄀᇿሀ\u137fᎠ\u13ff᐀ᙿ \u169fᚠ\u16ffក\u17ff᠀\u18afḀỿἀ\u1fff \u206f⁰\u209f₠\u20cf⃐\u20ff℀⅏⅐\u218f←⇿∀⋿⌀\u23ff␀\u243f⑀\u245f①⓿─╿▀▟■◿☀⛿\u2700➿⠀⣿⺀\u2eff⼀\u2fdf⿰\u2fff　〿\u3040ゟ゠ヿ\u3100\u312f\u3130\u318f㆐㆟ㆠ\u31bf㈀㋿㌀㏿㐀䶵一\u9fffꀀ\ua48f꒐\ua4cf가힣\ue000\uf8ff豈\ufaffﬀﭏﭐ\ufdff︠\ufe2f︰﹏﹐\ufe6fﹰ\ufefe\ufeff\ufeff\uff00\uffef".charAt(location + 1);
   ...
   static class UnionToken extends Token implements Serializable {
      ...
      List<Token> children;
      private static final ObjectStreamField[] serialPersistentFields = new ObjectStreamField[]{new ObjectStreamField("children", Vector.class)};
            ...
            if (this.type == 2) {
               ...
               if (tok.type == 1) {
                  ...
                  if (size == 0) {
                     ...
                     Token previous = (Token)this.children.get(size - 1);
                     if ((((Token)previous).type == 0 || ((Token)previous).type == 10) && (tok.type == 0 || tok.type == 10)) {
                        ...
                        if (((Token)previous).type == 0) {
                           ...
                           buffer = new StringBuilder(((Token)previous).getString().length() + nextMaxLength);
      ...
      public String toString(int options) {
         ...
         if (this.type == 1) {
            ...
            if (this.children.size() == 2 && this.getChild(1).type == 7) {
               ...
               sb = new StringBuilder();
               sb.append(((Token)this.children.get(0)).toString(options));
      ...
      private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
         ...
         Vector<Token> vChildren = (Vector)gf.get("children", (Object)null);
         if (vChildren != null) {
