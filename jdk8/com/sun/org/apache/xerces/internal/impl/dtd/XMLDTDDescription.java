...
public class XMLDTDDescription extends XMLResourceIdentifierImpl implements com.sun.org.apache.xerces.internal.xni.grammars.XMLDTDDescription {
   ...
   public XMLDTDDescription(XMLInputSource source) {
      this.setValues(source.getPublicId(), (String)null, source.getBaseSystemId(), source.getSystemId());
      this.fRootName = null;
      this.fPossibleRoots = null;
   }
   ...
   public boolean equals(Object desc) {
      if (!(desc instanceof XMLGrammarDescription)) {
         return false;
      } else if (!this.getGrammarType().equals(((XMLGrammarDescription)desc).getGrammarType())) {
         return false;
      } else {
