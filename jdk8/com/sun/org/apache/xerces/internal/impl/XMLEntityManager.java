...
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
   ...
   private XMLEntityManager.CharacterBufferPool fBufferPool;
   ...
   public XMLEntityManager() {
      this.fBufferPool = new XMLEntityManager.CharacterBufferPool(this.fBufferSize, 1024);
      ...
      if (!this.fEntities.containsKey(name)) {
         if (baseSystemId == null) {
            ...
            for(int i = size - 1; i >= 0; --i) {
               Entity.ScannedEntity externalEntity = (Entity.ScannedEntity)this.fEntityStack.elementAt(i);
         ...
         Entity entity = new Entity.ExternalEntity(name, new XMLEntityDescriptionImpl(name, publicId, literalSystemId, baseSystemId, expandSystemId(literalSystemId, baseSystemId, false)), (String)null, this.fInExternalSubset);
         this.fEntities.put(name, entity);
      } else if (this.fWarnDuplicateEntityDef) {
         this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MSG_DUPLICATE_ENTITY_DEFINITION", new Object[]{name}, (short)0);
      }
   ...
   public void addUnparsedEntity(String name, String publicId, String systemId, String baseSystemId, String notation) {
      if (!this.fEntities.containsKey(name)) {
         Entity.ExternalEntity entity = new Entity.ExternalEntity(name, new XMLEntityDescriptionImpl(name, publicId, systemId, baseSystemId, (String)null), notation, this.fInExternalSubset);
         this.fEntities.put(name, entity);
      } else if (this.fWarnDuplicateEntityDef) {
         this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MSG_DUPLICATE_ENTITY_DEFINITION", new Object[]{name}, (short)0);
      }
   ...
   public String setupCurrentEntity(boolean reference, String name, XMLInputSource xmlInputSource, boolean literal, boolean isExternal) throws IOException, XNIException {
      ...
      if (reader == null) {
         InputStream stream = xmlInputSource.getByteStream();
         if (stream == null) {
            ...
            if (!(connect instanceof HttpURLConnection)) {
               ...
               if (xmlInputSource instanceof HTTPInputSource) {
                  ...
                  while(propIter.hasNext()) {
                     Map.Entry<String, String> entry = (Map.Entry)propIter.next();
         ...
         stream = new XMLEntityManager.RewindableInputStream(stream);
         int count;
         int b0;
         int b1;
         int b2;
         if (encoding == null) {
            ...
            if (count == 4) {
               ...
               encoding = (String)((String)encodingDesc[0]);
               isBigEndian = (Boolean)((Boolean)encodingDesc[1]);
               stream.reset();
            ...
            if (encoding.equals("UTF-8")) {
               ...
               this.createReader(stream, utf16Encoding, isBigEndian);
   ...
   public void startEntity(boolean isGE, String entityName, boolean literal) throws IOException, XNIException {
      ...
      if (entity == null) {
         if (this.fEntityHandler != null) {
            ...
            this.fEntityHandler.startEntity(entityName, this.fResourceIdentifier, (String)encoding, this.fEntityAugs);
            this.fEntityAugs.removeAllItems();
            this.fEntityAugs.putItem("ENTITY_SKIPPED", Boolean.TRUE);
         ...
         if (external) {
            ...
            if (unparsed || general && !this.fExternalGeneralEntities || parameter && !this.fExternalParameterEntities || !this.fSupportDTD || !this.fSupportExternalEntities) {
               if (this.fEntityHandler != null) {
                  ...
                  this.fEntityAugs.removeAllItems();
                  this.fEntityAugs.putItem("ENTITY_SKIPPED", Boolean.TRUE);
                  this.fEntityHandler.startEntity(entityName, this.fResourceIdentifier, accessError, this.fEntityAugs);
                  this.fEntityAugs.removeAllItems();
                  this.fEntityAugs.putItem("ENTITY_SKIPPED", Boolean.TRUE);
                  this.fEntityHandler.endEntity(entityName, this.fEntityAugs);
               }
         ...
         Object activeEntity;
         StringReader encoding;
         for(int i = size; i >= 0; --i) {
            activeEntity = i == size ? this.fCurrentEntity : (Entity)this.fEntityStack.elementAt(i);
            if (((Entity)activeEntity).name == entityName) {
               accessError = entityName;

               for(int j = i + 1; j < size; ++j) {
                  Entity activeEntity = (Entity)this.fEntityStack.elementAt(j);
                  accessError = accessError + " -> " + activeEntity.name;
               }

               accessError = accessError + " -> " + this.fCurrentEntity.name;
               accessError = accessError + " -> " + entityName;
               this.fErrorReporter.reportError(this.getEntityScanner(), "http://www.w3.org/TR/1998/REC-xml-19980210", "RecursiveReference", new Object[]{entityName, accessError}, (short)2);
               if (this.fEntityHandler != null) {
                  this.fResourceIdentifier.clear();
                  encoding = null;
                  if (external) {
         ...
         if (external) {
            ...
            if (!this.fISCreatedByResolver && this.fLoadExternalDTD) {
               accessError = SecuritySupport.checkAccess(expandedSystemId, this.fAccessExternalDTD, "all");
               if (accessError != null) {
            ...
            encoding = new StringReader(internalEntity.text);
            xmlInputSource = new XMLInputSource((String)null, (String)null, (String)null, encoding, (String)null);
         }
   ...
   public void startEntity(boolean isGE, String name, XMLInputSource xmlInputSource, boolean literal, boolean isExternal) throws IOException, XNIException {
      ...
      if (this.fEntityHandler != null) {
         this.fEntityHandler.startEntity(name, this.fResourceIdentifier, encoding, (Augmentations)null);
      }
   ...
   public Entity.ScannedEntity getTopLevelEntity() {
      return (Entity.ScannedEntity)((Entity.ScannedEntity)(this.fEntityStack.empty() ? null : (Entity)this.fEntityStack.elementAt(0)));
   }
   ...
   public void reset(XMLComponentManager componentManager) throws XMLConfigurationException {
      ...
      if (!parser_settings) {
         ...
         this.fEntityResolver = (XMLEntityResolver)componentManager.getProperty("http://apache.org/xml/properties/internal/entity-resolver", (Object)null);
         this.fStaxEntityResolver = (StaxEntityResolverWrapper)componentManager.getProperty("http://apache.org/xml/properties/internal/stax-entity-resolver", (Object)null);
      ...
      if (userDir.length() == 0) {
         ...
         if (i < len) {
            ...
            try {
               ...
               return new URI("file", "", userDir, (String)null, (String)null);
            }
         ...
         gUserDirURI = new URI("file", "", buffer.toString(), (String)null, (String)null);
         return gUserDirURI;
      }
   }
         ...
         if (strict) {
            try {
               ...
               if (baseSystemId != null && baseSystemId.length() != 0) {
                  ...
                  base = new URI("file", "", getUserDir().toString(), (String)null, (String)null);
               }

               base = new URI(base, systemId);
                     ...
                     try {
                        if (baseSystemId != null && baseSystemId.length() != 0 && !baseSystemId.equals(systemId)) {
                           try {
                              ...
                              if (baseSystemId.indexOf(58) != -1) {
                                 base = new URI("file", "", fixURI(baseSystemId).trim(), (String)null, (String)null);
                              } else {
         ...
         if (b0 == 254 && b1 == 255) {
            ...
            if (b0 == 239 && b1 == 187 && b2 == 191) {
               ...
               if (b0 == 0 && b1 == 0 && b2 == 0 && b3 == 60) {
                  ...
                  return b0 == 76 && b1 == 111 && b2 == 167 && b3 == 148 ? new Object[]{"CP037", null} : this.defaultEncoding;
               }
            }
         }
      }
   ...
   public int getLineNumber() {
      if (this.fCurrentEntity != null) {
         ...
         for(int i = size - 1; i > 0; --i) {
            Entity.ScannedEntity firstExternalEntity = (Entity.ScannedEntity)this.fEntityStack.elementAt(i);
   ...
   public void test() {
      this.fEntityStorage.addExternalEntity("entityUsecase1", (String)null, "/space/home/stax/sun/6thJan2004/zephyr/data/test.txt", "/space/home/stax/sun/6thJan2004/zephyr/data/entity.xml");
   ...
   protected final class RewindableInputStream extends InputStream {
      ...
      public int read(byte[] b, int off, int len) throws IOException {
         ...
         if (bytesLeft == 0) {
            if (this.fOffset == this.fEndOffset) {
               return -1;
            } else if (!XMLEntityManager.this.fCurrentEntity.mayReadChunks && XMLEntityManager.this.fCurrentEntity.xmlDeclChunkRead) {
      ...
      public long skip(long n) throws IOException {
         if (n <= 0L) {
            ...
            int bytesLeft = this.fLength - this.fOffset;
            if (bytesLeft == 0) {
               return this.fOffset == this.fEndOffset ? 0L : this.fInputStream.skip(n);
   ...
   private static class CharacterBufferPool {
      ...
      public XMLEntityManager.CharacterBuffer getBuffer(boolean external) {
         if (external) {
            return this.fExternalTop > -1 ? this.fExternalBufferPool[this.fExternalTop--] : new XMLEntityManager.CharacterBuffer(true, this.fExternalBufferSize);
         } else {
            return this.fInternalTop > -1 ? this.fInternalBufferPool[this.fInternalTop--] : new XMLEntityManager.CharacterBuffer(false, this.fInternalBufferSize);
         }
      }
