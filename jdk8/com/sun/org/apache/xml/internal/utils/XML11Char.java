...
public class XML11Char {
   ...
   static {
      Arrays.fill((byte[])XML11CHARS, 1, 9, (byte)17);
      XML11CHARS[9] = 35;
      XML11CHARS[10] = 3;
      Arrays.fill((byte[])XML11CHARS, 11, 13, (byte)17);
      XML11CHARS[13] = 3;
      Arrays.fill((byte[])XML11CHARS, 14, 32, (byte)17);
      XML11CHARS[32] = 35;
      Arrays.fill((byte[])XML11CHARS, 33, 38, (byte)33);
      XML11CHARS[38] = 1;
      Arrays.fill((byte[])XML11CHARS, 39, 45, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 45, 47, (byte)-87);
      XML11CHARS[47] = 33;
      Arrays.fill((byte[])XML11CHARS, 48, 58, (byte)-87);
      XML11CHARS[58] = 45;
      XML11CHARS[59] = 33;
      XML11CHARS[60] = 1;
      Arrays.fill((byte[])XML11CHARS, 61, 65, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 65, 91, (byte)-19);
      Arrays.fill((byte[])XML11CHARS, 91, 93, (byte)33);
      XML11CHARS[93] = 1;
      XML11CHARS[94] = 33;
      XML11CHARS[95] = -19;
      XML11CHARS[96] = 33;
      Arrays.fill((byte[])XML11CHARS, 97, 123, (byte)-19);
      Arrays.fill((byte[])XML11CHARS, 123, 127, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 127, 133, (byte)17);
      XML11CHARS[133] = 35;
      Arrays.fill((byte[])XML11CHARS, 134, 160, (byte)17);
      Arrays.fill((byte[])XML11CHARS, 160, 183, (byte)33);
      XML11CHARS[183] = -87;
      Arrays.fill((byte[])XML11CHARS, 184, 192, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 192, 215, (byte)-19);
      XML11CHARS[215] = 33;
      Arrays.fill((byte[])XML11CHARS, 216, 247, (byte)-19);
      XML11CHARS[247] = 33;
      Arrays.fill((byte[])XML11CHARS, 248, 768, (byte)-19);
      Arrays.fill((byte[])XML11CHARS, 768, 880, (byte)-87);
      Arrays.fill((byte[])XML11CHARS, 880, 894, (byte)-19);
      XML11CHARS[894] = 33;
      Arrays.fill((byte[])XML11CHARS, 895, 8192, (byte)-19);
      Arrays.fill((byte[])XML11CHARS, 8192, 8204, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 8204, 8206, (byte)-19);
      Arrays.fill((byte[])XML11CHARS, 8206, 8232, (byte)33);
      XML11CHARS[8232] = 35;
      Arrays.fill((byte[])XML11CHARS, 8233, 8255, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 8255, 8257, (byte)-87);
      Arrays.fill((byte[])XML11CHARS, 8257, 8304, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 8304, 8592, (byte)-19);
      Arrays.fill((byte[])XML11CHARS, 8592, 11264, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 11264, 12272, (byte)-19);
      Arrays.fill((byte[])XML11CHARS, 12272, 12289, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 12289, 55296, (byte)-19);
      Arrays.fill((byte[])XML11CHARS, 57344, 63744, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 63744, 64976, (byte)-19);
      Arrays.fill((byte[])XML11CHARS, 64976, 65008, (byte)33);
      Arrays.fill((byte[])XML11CHARS, 65008, 65534, (byte)-19);
   }
}
