...
final class ChunkedIntArray {
   ...
   ChunkedIntArray.ChunksVector chunks = new ChunkedIntArray.ChunksVector();
   ...
   ChunkedIntArray(int slotsize) {
      ...
      if (4 < slotsize) {
         ...
         if (4 > slotsize) {
            ...
            StringBuilder var10001 = (new StringBuilder()).append("*****WARNING: ChunkedIntArray(").append(slotsize).append(") wasting ");
            this.getClass();
            var10000.println(var10001.append(4 - slotsize).append(" words per slot").toString());
         }
