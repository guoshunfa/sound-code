...
public class XMLSecurityRuntimeException extends RuntimeException {
   ...
   public XMLSecurityRuntimeException(String var1) {
      super(I18n.getExceptionMessage(var1));
      this.msgID = var1;
   }

   public XMLSecurityRuntimeException(String var1, Object[] var2) {
      super(MessageFormat.format(I18n.getExceptionMessage(var1), var2));
      this.msgID = var1;
   }

   public XMLSecurityRuntimeException(Exception var1) {
   ...
   public XMLSecurityRuntimeException(String var1, Exception var2) {
      super(I18n.getExceptionMessage(var1, var2), var2);
      this.msgID = var1;
   }

   public XMLSecurityRuntimeException(String var1, Object[] var2, Exception var3) {
      super(MessageFormat.format(I18n.getExceptionMessage(var1), var2));
      this.msgID = var1;
   }
