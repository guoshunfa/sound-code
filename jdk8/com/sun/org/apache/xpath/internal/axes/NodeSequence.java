...
public class NodeSequence extends XObject implements DTMIterator, Cloneable, PathComponent {
   ...
   public void setItem(int node, int index) {
      ...
      if (null != vec) {
         ...
         if (oldNode != node && this.m_cache.useCount() > 1) {
            NodeSequence.IteratorCache newCache = new NodeSequence.IteratorCache();
   ...
   public int getLength() {
      NodeSequence.IteratorCache cache = this.getCache();
      if (cache != null) {
         if (cache.isComplete()) {
   ...
   protected void setObject(Object obj) {
      if (obj instanceof NodeVector) {
         ...
         if (this.m_cache != null) {
            ...
            this.m_cache = new NodeSequence.IteratorCache();
            this.m_cache.setVector(v);
         }
      } else if (obj instanceof NodeSequence.IteratorCache) {
         NodeSequence.IteratorCache cache = (NodeSequence.IteratorCache)obj;
         this.m_cache = cache;
         this.m_cache.increaseUseCount();
