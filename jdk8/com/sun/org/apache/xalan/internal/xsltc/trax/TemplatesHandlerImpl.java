...
public class TemplatesHandlerImpl implements ContentHandler, TemplatesHandler, SourceLoader {
   ...
   protected TemplatesHandlerImpl(int indentNumber, TransformerFactoryImpl tfactory) {
      ...
      xsltc.setProperty("http://javax.xml.XMLConstants/property/accessExternalStylesheet", (String)tfactory.getAttribute("http://javax.xml.XMLConstants/property/accessExternalStylesheet"));
      ...
      try {
         ...
         if (!this._parser.errorsFound()) {
            ...
            for(int i = 0; i < count; ++i) {
               ...
               errorMessage.append(((ErrorMsg)errors.get(i)).toString());
            }
