...
public final class Template extends TopLevelElement {
   ...
   public void parseSimplified(Stylesheet stylesheet, Parser parser) {
      ...
      SyntaxTreeNode root = (SyntaxTreeNode)contents.get(0);
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (!this._disabled) {
         ...
         if (this._compiled && this.isNamed()) {
            ...
            il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEVIRTUAL(cpg.addMethodref(className, methodName, "(Lcom/sun/org/apache/xalan/internal/xsltc/DOM;Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;I)V"))));
