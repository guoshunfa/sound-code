   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (!this._ignore) {
         ...
         if (!this._isLiteral) {
            ...
            flags = cpg.addMethodref("com.sun.org.apache.xalan.internal.xsltc.runtime.BasisLibrary", "checkAttribQName", "(Ljava/lang/String;)V");
            il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKESTATIC(flags)));
            il.append(methodGen.loadHandler());
