...
final class RelationalExpr extends Expression {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      if (!this.hasNodeSetArgs() && !this.hasReferenceArgs()) {
         ...
         int index = cpg.addMethodref("com.sun.org.apache.xalan.internal.xsltc.runtime.BasisLibrary", "compare", "(" + this._left.getType().toSignature() + this._right.getType().toSignature() + "I" + "Lcom/sun/org/apache/xalan/internal/xsltc/DOM;" + ")Z");
