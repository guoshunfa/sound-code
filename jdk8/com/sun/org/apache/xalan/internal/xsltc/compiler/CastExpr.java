...
final class CastExpr extends Expression {
   ...
   public void translateDesynthesized(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (this._typeTest) {
         ...
         int idx = cpg.addInterfaceMethodref("com.sun.org.apache.xalan.internal.xsltc.DOM", "getExpandedTypeID", "(I)I");
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new SIPUSH((short)((Step)this._left).getNodeType())));
         il.append(methodGen.loadDOM());
         il.append(methodGen.loadContextNode());
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEINTERFACE(idx, 2)));
