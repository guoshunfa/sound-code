...
public class SimpleResultTreeImpl extends EmptySerializer implements DOM, DTM {
   ...
   public DTMAxisIterator getChildren(int node) {
      return (new SimpleResultTreeImpl.SimpleIterator()).setStartNode(node);
   }

   public DTMAxisIterator getTypedChildren(int type) {
      return new SimpleResultTreeImpl.SimpleIterator(1, type);
   }
   ...
   public DTMAxisIterator getAxisIterator(int axis) {
      ...
      case 0:
      case 10:
         return new SimpleResultTreeImpl.SimpleIterator(0);
      case 1:
         return (new SimpleResultTreeImpl.SimpleIterator(0)).includeSelf();
      case 2:
      case 6:
      case 7:
      case 8:
      ...
      case 3:
      case 4:
         return new SimpleResultTreeImpl.SimpleIterator(1);
      case 5:
         return (new SimpleResultTreeImpl.SimpleIterator(1)).includeSelf();
      case 13:
         return new SimpleResultTreeImpl.SingletonIterator();
      }
   }
   ...
   public DTMAxisIterator getTypedAxisIterator(int axis, int type) {
      ...
      case 0:
      case 10:
         return new SimpleResultTreeImpl.SimpleIterator(0, type);
      case 1:
         return (new SimpleResultTreeImpl.SimpleIterator(0, type)).includeSelf();
      case 2:
      case 6:
      case 7:
      case 8:
      ...
      case 4:
         return new SimpleResultTreeImpl.SimpleIterator(1, type);
      case 5:
         return (new SimpleResultTreeImpl.SimpleIterator(1, type)).includeSelf();
      case 13:
         return new SimpleResultTreeImpl.SingletonIterator(type);
      }
   }
