...
final class DecimalFormatting extends TopLevelElement {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new NEW(cpg.addClass("java.text.DecimalFormatSymbols"))));
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)DUP);
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new GETSTATIC(cpg.addFieldref("java.util.Locale", "US", "Ljava/util/Locale;"))));
      ...
      if (tmp == null || tmp.equals("")) {
         ...
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEVIRTUAL(nAttributes)));
      }
      ...
      for(put = 0; put < nAttributes; ++put) {
         ...
         if (name.equals("decimal-separator")) {
            ...
            il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEVIRTUAL(method)));
            valid = false;
      ...
      put = cpg.addMethodref("com.sun.org.apache.xalan.internal.xsltc.runtime.AbstractTranslet", "addDecimalFormat", "(Ljava/lang/String;Ljava/text/DecimalFormatSymbols;)V");
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEVIRTUAL(put)));
   }
   ...
   public static void translateDefaultDFS(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)DUP);
      il.append((CompoundInstruction)(new PUSH(cpg, "NaN")));
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEVIRTUAL(nan)));
      int inf = cpg.addMethodref("java.text.DecimalFormatSymbols", "setInfinity", "(Ljava/lang/String;)V");
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)DUP);
      il.append((CompoundInstruction)(new PUSH(cpg, "Infinity")));
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEVIRTUAL(inf)));
      int put = cpg.addMethodref("com.sun.org.apache.xalan.internal.xsltc.runtime.AbstractTranslet", "addDecimalFormat", "(Ljava/lang/String;Ljava/text/DecimalFormatSymbols;)V");
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEVIRTUAL(put)));
   }
}
