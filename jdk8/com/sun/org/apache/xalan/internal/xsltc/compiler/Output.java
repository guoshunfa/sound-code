   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      if (!this._disabled) {
         ...
         if (this._version != null && !this._version.equals("1.0")) {
            ...
            il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new PUTFIELD(field)));
         }
         ...
         if (this._cdata != null) {
            int index = cpg.addMethodref("com.sun.org.apache.xalan.internal.xsltc.runtime.AbstractTranslet", "addCdataElement", "(Ljava/lang/String;)V");
