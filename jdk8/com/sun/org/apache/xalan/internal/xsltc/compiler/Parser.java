...
public class Parser implements Constants, ContentHandler {
   ...
   public void createAST(Stylesheet stylesheet) {
      try {
         if (stylesheet != null) {
            ...
            Iterator elements = stylesheet.elements();
      ...
      } catch (TypeCheckError var6) {
         this.reportError(3, new ErrorMsg("JAXP_COMPILE_ERR", var6));
      }
   ...
   public SyntaxTreeNode parse(XMLReader reader, InputSource input) {
      try {
         ...
         this.reportError(3, new ErrorMsg("JAXP_COMPILE_ERR", var5));
         ...
         this.reportError(3, new ErrorMsg("JAXP_COMPILE_ERR", var7));
      } catch (Exception var8) {
         if (this._xsltc.debug()) {
            var8.printStackTrace();
         }

         this.reportError(3, new ErrorMsg("JAXP_COMPILE_ERR", var8));
      }
   ...
   public SyntaxTreeNode parse(InputSource input) {
      ...
      try {
         ...
         XMLSecurityManager.printWarning(reader.getClass().getName(), lastProperty, var9);
      }
   ...
   private SyntaxTreeNode getStylesheet(SyntaxTreeNode root) throws CompilerException {
      if (this._target == null) {
         ...
         try {
            ...
            String accessError = SecuritySupport.checkAccess(path, (String)this._xsltc.getProperty("http://javax.xml.XMLConstants/property/accessExternalStylesheet"), "all");
            if (accessError != null) {
               ErrorMsg msg = new ErrorMsg("ACCESSING_XSLT_TARGET_ERR", SecuritySupport.sanitizePath(this._target), accessError, root);
               throw new CompilerException(msg.toString());
            }
         } catch (IOException var5) {
            throw new CompilerException(var5);
         }
   ...
   public SyntaxTreeNode makeInstance(String uri, String prefix, String local, Attributes attributes) {
      ...
      String className = (String)this._instructionClasses.get(qname.getStringRep());
      ErrorMsg msg;
      if (className != null) {
         try {
   ...
   private void checkForSuperfluousAttributes(SyntaxTreeNode node, Attributes attrs) {
      ...
      String[] legal = (String[])this._instructionAttrs.get(qname.getStringRep());
   ...
   public void printErrors() {
      ...
      if (size > 0) {
         System.err.println((Object)(new ErrorMsg("COMPILER_ERROR_KEY")));
   ...
   public void printWarnings() {
      ...
      if (size > 0) {
         System.err.println((Object)(new ErrorMsg("COMPILER_WARNING_KEY")));
