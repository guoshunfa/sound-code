...
final class Text extends Instruction {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (!this._ignore) {
         int esc = cpg.addInterfaceMethodref("com/sun/org/apache/xml/internal/serializer/SerializationHandler", "setEscaping", "(Z)Z");
         if (!this._escaping) {
            il.append(methodGen.loadHandler());
            il.append((CompoundInstruction)(new PUSH(cpg, false)));
            il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEINTERFACE(esc, 2)));
         }

         il.append(methodGen.loadHandler());
         int characters;
         if (!this.canLoadAsArrayOffsetLength()) {
            characters = cpg.addInterfaceMethodref("com/sun/org/apache/xml/internal/serializer/SerializationHandler", "characters", "(Ljava/lang/String;)V");
            il.append((CompoundInstruction)(new PUSH(cpg, this._text)));
            il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEINTERFACE(characters, 2)));
         } else {
            characters = cpg.addInterfaceMethodref("com/sun/org/apache/xml/internal/serializer/SerializationHandler", "characters", "([CII)V");
            this.loadAsArrayOffsetLength(classGen, methodGen);
            il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEINTERFACE(characters, 4)));
         }
   ...
   public void loadAsArrayOffsetLength(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new GETSTATIC(cpg.addFieldref(xsltc.getClassName(), charDataFieldName, "[C"))));
