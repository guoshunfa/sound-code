...
class StepPattern extends RelativePathPattern {
   ...
   private void translateKernel(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      BranchHandle icmp;
      if (this._nodeType == 1) {
         check = cpg.addInterfaceMethodref("com.sun.org.apache.xalan.internal.xsltc.DOM", "isElement", "(I)Z");
         il.append(methodGen.loadDOM());
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)SWAP);
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEINTERFACE(check, 2)));
         ...
         check = cpg.addInterfaceMethodref("com.sun.org.apache.xalan.internal.xsltc.DOM", "isAttribute", "(I)Z");
         il.append(methodGen.loadDOM());
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)SWAP);
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEINTERFACE(check, 2)));
         icmp = il.append((BranchInstruction)(new IFNE((InstructionHandle)null)));
         ...
         check = cpg.addInterfaceMethodref("com.sun.org.apache.xalan.internal.xsltc.DOM", "getExpandedTypeID", "(I)I");
         il.append(methodGen.loadDOM());
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)SWAP);
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEINTERFACE(check, 2)));
   ...
   private void translateSimpleContext(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      match.setStart(il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ISTORE(match.getIndex()))));
      if (!this._isEpsilon) {
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ILOAD(match.getIndex())));
         this.translateKernel(classGen, methodGen);
      }
      ...
      LocalVariableGen stepIteratorTemp = methodGen.addLocalVariable("step_pattern_tmp2", Util.getJCRefType("Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
      stepIteratorTemp.setStart(il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ASTORE(stepIteratorTemp.getIndex()))));
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new NEW(cpg.addClass("com.sun.org.apache.xalan.internal.xsltc.dom.MatchingIterator"))));
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)DUP);
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ILOAD(match.getIndex())));
      stepIteratorTemp.setEnd(il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ALOAD(stepIteratorTemp.getIndex()))));
      ...
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEINTERFACE(index, 2)));
      il.append(methodGen.setStartNode());
      il.append(methodGen.storeIterator());
      match.setEnd(il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ILOAD(match.getIndex()))));
      il.append(methodGen.storeCurrentNode());
   ...
   private void translateGeneralContext(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      node.setStart(il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ISTORE(node.getIndex()))));
      LocalVariableGen iter = methodGen.addLocalVariable("step_pattern_tmp2", Util.getJCRefType("Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
      if (!classGen.isExternal()) {
         Field iterator = new Field(2, cpg.addUtf8(iteratorName), cpg.addUtf8("Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;"), (com.sun.org.apache.bcel.internal.classfile.Attribute[])null, cpg.getConstantPool());
         ...
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new GETFIELD(iteratorIndex)));
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)DUP);
         iter.setStart(il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ASTORE(iter.getIndex()))));
         ifBlock = il.append((BranchInstruction)(new IFNONNULL((InstructionHandle)null)));
         il.append(classGen.loadTranslet());
      }

      this._step.translate(classGen, methodGen);
      InstructionHandle iterStore = il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ASTORE(iter.getIndex())));
      if (!classGen.isExternal()) {
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ALOAD(iter.getIndex())));
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new PUTFIELD(iteratorIndex)));
      ...
      il.append(methodGen.loadDOM());
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ILOAD(node.getIndex())));
      int index = cpg.addInterfaceMethodref("com.sun.org.apache.xalan.internal.xsltc.DOM", "getParent", "(I)I");
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEINTERFACE(index, 2)));
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ALOAD(iter.getIndex())));
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)SWAP);
      il.append(methodGen.setStartNode());
      ...
      InstructionHandle next = il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ALOAD(iter.getIndex())));
      node2.setStart(next);
      InstructionHandle begin = il.append(methodGen.nextNode());
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)DUP);
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ISTORE(node2.getIndex())));
      this._falseList.add(il.append((BranchInstruction)(new IFLT((InstructionHandle)null))));
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ILOAD(node2.getIndex())));
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ILOAD(node.getIndex())));
      iter.setEnd(il.append((BranchInstruction)(new IF_ICMPLT(next))));
      node2.setEnd(il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ILOAD(node2.getIndex()))));
      node.setEnd(il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new ILOAD(node.getIndex()))));
