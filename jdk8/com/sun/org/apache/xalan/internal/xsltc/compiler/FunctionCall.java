...
class FunctionCall extends Expression {
   ...
   private static final MultiHashtable<Type, FunctionCall.JavaType> _internal2Java = new MultiHashtable();
   ...
   public String getClassNameFromUri(String uri) {
      String className = (String)EXTENSIONNAMESPACE.get(uri);
      if (className != null) {
         return className;
      } else {
         int index;
         ...
         if (this.isExtension()) {
            ...
            try {
               ...
               if (pos > 0) {
                  ...
                  String extFunction = (String)EXTENSIONFUNCTION.get(namespace + ":" + local);
                  if (extFunction != null) {
      ...
      if (constructors == null) {
         ...
         for(int i = 0; i < nConstructors; ++i) {
            ...
            for(j = 0; j < nArgs; ++j) {
               ...
               FunctionCall.JavaType match = (FunctionCall.JavaType)_internal2Java.maps(intType, new FunctionCall.JavaType(extType, 0));
               if (match != null) {
         ...
         if (methods == null) {
            ...
            for(int i = 0; i < nMethods; ++i) {
               ...
               if (j == nArgs) {
                  ...
                  this._type = (Type)JAVA2INTERNAL.get(extType);
                  if (this._type == null) {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (!this.isStandard() && !this.isExtension()) {
         if (this.unresolvedExternal) {
            index = cpg.addMethodref("com.sun.org.apache.xalan.internal.xsltc.runtime.BasisLibrary", "unresolved_externalF", "(Ljava/lang/String;)V");
            ...
            if (this._isExtConstructor) {
               ...
               il.append((com.sun.org.apache.bcel.internal.generic.Instruction)InstructionConstants.DUP);
               ...
               if (this._thisArgument != null && this._clazz.isInterface()) {
                  ...
                  il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKEINTERFACE(index, n + 1)));
               } else {
                  index = cpg.addMethodref(clazz, this._fname.getLocalPart(), buffer.toString());
                  il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(this._thisArgument != null ? new INVOKEVIRTUAL(index) : new INVOKESTATIC(index)));
               }
         ...
         index = cpg.addMethodref("com.sun.org.apache.xalan.internal.xsltc.runtime.BasisLibrary", clazz, this._chosenMethodType.toSignature(args));
         il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKESTATIC(index)));
      }
   ...
   private Vector findMethods() {
      ...
      if (this._className != null && this._className.length() > 0) {
         ...
         try {
            if (this._clazz == null) {
               boolean isSecureProcessing = this.getXSLTC().isSecureProcessing();
               boolean isExtensionFunctionEnabled = this.getXSLTC().getFeature(JdkXmlFeatures.XmlFeature.ENABLE_EXTENSION_FUNCTION);
   ...
   private void translateUnallowedExtension(ConstantPoolGen cpg, InstructionList il) {
      int index = cpg.addMethodref("com.sun.org.apache.xalan.internal.xsltc.runtime.BasisLibrary", "unallowed_extension_functionF", "(Ljava/lang/String;)V");
      il.append((CompoundInstruction)(new PUSH(cpg, this._fname.toString())));
      il.append((com.sun.org.apache.bcel.internal.generic.Instruction)(new INVOKESTATIC(index)));
   }
   ...
   static {
      ...
      try {
         ...
         ErrorMsg err = new ErrorMsg("CLASS_NOT_FOUND_ERR", "org.w3c.dom.Node or NodeList");
      ...
      _internal2Java.put(Type.Boolean, new FunctionCall.JavaType(Boolean.class, 1));
      _internal2Java.put(Type.Boolean, new FunctionCall.JavaType(Object.class, 2));
      _internal2Java.put(Type.Real, new FunctionCall.JavaType(Double.TYPE, 0));
      _internal2Java.put(Type.Real, new FunctionCall.JavaType(Double.class, 1));
      ...
      _internal2Java.put(Type.Real, new FunctionCall.JavaType(Object.class, 8));
      _internal2Java.put(Type.Int, new FunctionCall.JavaType(Double.TYPE, 0));
      _internal2Java.put(Type.Int, new FunctionCall.JavaType(Double.class, 1));
      ...
      _internal2Java.put(Type.Int, new FunctionCall.JavaType(Object.class, 8));
      _internal2Java.put(Type.String, new FunctionCall.JavaType(String.class, 0));
      _internal2Java.put(Type.String, new FunctionCall.JavaType(Object.class, 1));
      ...
      _internal2Java.put(Type.NodeSet, new FunctionCall.JavaType(Object.class, 2));
      _internal2Java.put(Type.NodeSet, new FunctionCall.JavaType(String.class, 3));
      ...
      _internal2Java.put(Type.Node, new FunctionCall.JavaType(Object.class, 2));
      _internal2Java.put(Type.Node, new FunctionCall.JavaType(String.class, 3));
      ...
      _internal2Java.put(Type.ResultTree, new FunctionCall.JavaType(Object.class, 2));
      _internal2Java.put(Type.ResultTree, new FunctionCall.JavaType(String.class, 3));
      _internal2Java.put(Type.Reference, new FunctionCall.JavaType(Object.class, 0));
   ...
   static class JavaType {
      ...
      public boolean equals(Object query) {
         if (query == null) {
            ...
            return query.getClass().isAssignableFrom(FunctionCall.JavaType.class) ? ((FunctionCall.JavaType)query).type.equals(this.type) : query.equals(this.type);
         }
      }
   }
}
