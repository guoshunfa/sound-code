...
public class Process {
   ...
   public static void _main(String[] argv) {
      ...
      ResourceBundle resbundle = SecuritySupport.getResourceBundle("com.sun.org.apache.xalan.internal.res.XSLTErrorResources");
      String flavor = "s2s";
      if (argv.length < 1) {
         ...
         } catch (TransformerFactoryConfigurationError var63) {
            var63.printStackTrace(diagnosticsWriter);
            ...
            if (!"-XSLTC".equalsIgnoreCase(argv[i])) {
               if ("-INDENT".equalsIgnoreCase(argv[i])) {
                  if (i + 1 < argv.length && argv[i + 1].charAt(0) != '-') {
                     ++i;
                     int var70 = Integer.parseInt(argv[i]);
                  } else {
                     boolean var69 = false;
                  }
                  ...
                  if ("-V".equalsIgnoreCase(argv[i])) {
                     ...
                     if (i + 1 < argv.length) {
                        ...
                        } catch (ConfigurationError var62) {
                     ...
                     if (i + 1 < argv.length) {
                        ...
                        } catch (ConfigurationError var61) {
                     ...
                     if (i + 1 < argv.length) {
                        ...
                        } catch (ConfigurationError var60) {
                     ...
                     } catch (TransformerConfigurationException var59) {
                     }
                  } else {
         ...
         try {
               ...
               if (null != inFileName) {
                  if (flavor.equals("d2d")) {
                     ...
                     for(i = 0; i < 1; ++i) {
                        ...
                        } catch (SAXNotRecognizedException var50) {
                        } catch (SAXNotSupportedException var51) {
                        }
                     ...
                     try {
                        ...
                        throw new SAXException(var45);
                     } catch (FactoryConfigurationError var46) {
                        throw new SAXException(var46.toString());
                     } catch (NoSuchMethodError var47) {
                     } catch (AbstractMethodError var48) {
                     }
            ...
            Object throwable;
            for(throwable = var64; throwable instanceof WrappedRuntimeException; throwable = ((WrappedRuntimeException)throwable).getException()) {
            }
