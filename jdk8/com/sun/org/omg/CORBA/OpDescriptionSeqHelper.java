...
public final class OpDescriptionSeqHelper {
   ...
   public static OperationDescription[] read(InputStream var0) {
      OperationDescription[] var1 = null;
      int var2 = var0.read_long();
      var1 = new OperationDescription[var2];

      for(int var3 = 0; var3 < var1.length; ++var3) {
         var1[var3] = OperationDescriptionHelper.read(var0);
      }
   ...
   public static void write(OutputStream var0, OperationDescription[] var1) {
      ...
      for(int var2 = 0; var2 < var1.length; ++var2) {
         OperationDescriptionHelper.write(var0, var1[var2]);
      }
