...
public final class ParDescriptionSeqHelper {
   ...
   public static ParameterDescription[] read(InputStream var0) {
      ParameterDescription[] var1 = null;
      int var2 = var0.read_long();
      var1 = new ParameterDescription[var2];

      for(int var3 = 0; var3 < var1.length; ++var3) {
         var1[var3] = ParameterDescriptionHelper.read(var0);
      }
   ...
   public static void write(OutputStream var0, ParameterDescription[] var1) {
      ...
      for(int var2 = 0; var2 < var1.length; ++var2) {
         ParameterDescriptionHelper.write(var0, var1[var2]);
      }
