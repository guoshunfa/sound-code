...
public class FileChannelImpl extends FileChannel {
   ...
   private long transferToTrustedChannel(long var1, long var3, WritableByteChannel var5) throws IOException {
      ...
      if (!(var5 instanceof FileChannelImpl) && !var6) {
         ...
         while(var7 > 0L) {
            ...
            try {
               MappedByteBuffer var11 = this.map(FileChannel.MapMode.READ_ONLY, var1, var9);
   ...
   public MappedByteBuffer map(FileChannel.MapMode var1, long var2, long var4) throws IOException {
      ...
      if (var1 == null) {
         ...
         byte var6 = -1;
         if (var1 == FileChannel.MapMode.READ_ONLY) {
            var6 = 0;
         } else if (var1 == FileChannel.MapMode.READ_WRITE) {
            var6 = 1;
         } else if (var1 == FileChannel.MapMode.PRIVATE) {
            var6 = 2;
         }

         assert var6 >= 0;

         if (var1 != FileChannel.MapMode.READ_ONLY && !this.writable) {
            throw new NonWritableChannelException();
         } else if (!this.readable) {
            throw new NonReadableChannelException();
         } else {
            ...
            try {
               ...
               int var18 = (int)var4;
               FileChannelImpl.Unmapper var19 = new FileChannelImpl.Unmapper(var7, var15, var18, var17);
               if (!this.writable || var6 == 0) {
   ...
   private static boolean isSharedFileLockTable() {
      if (!propertyChecked) {
         ...
         synchronized(FileChannelImpl.class) {
            if (!propertyChecked) {
               String var1 = (String)AccessController.doPrivileged((PrivilegedAction)(new GetPropertyAction("sun.nio.ch.disableSystemWideOverlappingFileLockCheck")));
      ...
      if (var5 && !this.readable) {
         ...
         try {
            ...
            if (this.isOpen()) {
               int var20;
               do {
                  var20 = this.nd.lock(this.fd, true, var1, var3, var5);
               } while(var20 == 2 && this.isOpen());
   ...
   private static class Unmapper implements Runnable {
      ...
      // $FF: synthetic method
      Unmapper(long var1, long var3, int var5, FileDescriptor var6, Object var7) {
