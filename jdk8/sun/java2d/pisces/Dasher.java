...
final class Dasher implements PathConsumer2D {
   ...
   private Dasher.LengthIterator li = null;
   ...
   public Dasher(PathConsumer2D var1, float[] var2, float var3) {
      if (var3 < 0.0F) {
         ...
         float var5;
         for(this.dashOn = true; var3 >= (var5 = var2[var4]); this.dashOn = !this.dashOn) {
            var3 -= var5;
            var4 = (var4 + 1) % var2.length;
         }

         this.dash = var2;
         this.startPhase = this.phase = var3;
   ...
   private void goTo(float[] var1, int var2, int var3) {
      ...
      if (this.dashOn) {
         if (this.starting) {
            this.firstSegmentsBuffer = Helpers.widenArray(this.firstSegmentsBuffer, this.firstSegidx, var3 - 2);
   ...
   private void somethingTo(int var1) {
      if (!pointCurve(this.curCurvepts, var1)) {
         if (this.li == null) {
            this.li = new Dasher.LengthIterator(4, 0.01F);
         }
   ...
   private static class LengthIterator {
      ...
      public LengthIterator(int var1, float var2) {
         ...
         this.sides = new Dasher.LengthIterator.Side[var1];
