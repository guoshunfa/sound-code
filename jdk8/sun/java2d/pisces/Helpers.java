...
final class Helpers {
   ...
   static int cubicRootsInAB(float var0, float var1, float var2, float var3, float[] var4, int var5, float var6, float var7) {
      if (var0 == 0.0F) {
         ...
         double var10 = 0.3333333333333333D * (-0.3333333333333333D * var8 + (double)var2);
         double var12 = 0.5D * (0.07407407407407407D * (double)var1 * var8 - 0.3333333333333333D * (double)var1 * (double)var2 + (double)var3);
         ...
         double var21;
         if (var16 < 0.0D) {
            var19 = 0.3333333333333333D * Math.acos(-var12 / Math.sqrt(-var14));
            var21 = 2.0D * Math.sqrt(-var10);
            var4[var5 + 0] = (float)(var21 * Math.cos(var19));
            var4[var5 + 1] = (float)(-var21 * Math.cos(var19 + 1.0471975511965976D));
            var4[var5 + 2] = (float)(-var21 * Math.cos(var19 - 1.0471975511965976D));
            var18 = 3;
         } else {
