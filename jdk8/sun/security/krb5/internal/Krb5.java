...
public class Krb5 {
   ...
   public static final boolean DEBUG = (Boolean)AccessController.doPrivileged((PrivilegedAction)(new GetBooleanAction("sun.security.krb5.debug")));
   public static final HexDumpEncoder hexDumper = new HexDumpEncoder();

   public static String getErrorMessage(int var0) {
      return (String)errMsgList.get(var0);
   }
   ...
   static {
      ...
      errMsgList.put(901, "Structure is missing a required field");
      errMsgList.put(902, "Unexpected field number");
      errMsgList.put(903, "Type numbers are inconsistent");
      errMsgList.put(904, "Value too large");
      errMsgList.put(905, "Encoding ended unexpectedly");
      errMsgList.put(906, "Identifier doesn't match expected value");
      errMsgList.put(907, "Length doesn't match expected value");
      errMsgList.put(908, "Badly-formatted encoding");
      errMsgList.put(909, "Parse error");
      errMsgList.put(910, "Bad class number");
      errMsgList.put(911, "Bad type number");
      errMsgList.put(912, "Bad tag number");
      errMsgList.put(913, "Unsupported ASN.1 type encountered");
      errMsgList.put(914, "Encoding failed due to invalid parameter(s)");
