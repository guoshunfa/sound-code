...
public class DisabledAlgorithmConstraints extends AbstractAlgorithmConstraints {
   ...
   private final DisabledAlgorithmConstraints.Constraints algorithmConstraints;
   ...
   public DisabledAlgorithmConstraints(String var1, AlgorithmDecomposer var2) {
      ...
      this.algorithmConstraints = new DisabledAlgorithmConstraints.Constraints(this.disabledAlgorithms);
   }
   ...
   private static class DisabledConstraint extends DisabledAlgorithmConstraints.Constraint {
   ...
   private static class KeySizeConstraint extends DisabledAlgorithmConstraints.Constraint {
      private int minSize;
      private int maxSize;
      private int prohibitedSize = -1;
      private int size;

      public KeySizeConstraint(String var1, DisabledAlgorithmConstraints.Constraint.Operator var2, int var3) {
         super(null);
         this.algorithm = var1;
         switch(var2) {
         case EQ:
   ...
   private static class UsageConstraint extends DisabledAlgorithmConstraints.Constraint {
      String[] usages;
   ...
   private static class DenyAfterConstraint extends DisabledAlgorithmConstraints.Constraint {
   ...
   private static class jdkCAConstraint extends DisabledAlgorithmConstraints.Constraint {
   ...
   private abstract static class Constraint {
      String algorithm;
      DisabledAlgorithmConstraints.Constraint nextConstraint;
      ...
      static enum Operator {
         ...
         static DisabledAlgorithmConstraints.Constraint.Operator of(String var0) {
            byte var2 = -1;
   ...
   private static class Constraints {
      ...
      public Constraints(String[] var1) {
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            ...
            if (var5 != null && !var5.isEmpty()) {
               ...
               if (var6 <= 0) {
                  var8.add(new DisabledAlgorithmConstraints.DisabledConstraint(var7));
               } else {
                  ...
                  for(int var16 = 0; var16 < var15; ++var16) {
                     ...
                     if (var17.startsWith("keySize")) {
                        ...
                        var23 = new DisabledAlgorithmConstraints.KeySizeConstraint(var7, DisabledAlgorithmConstraints.Constraint.Operator.of(var25.nextToken()), Integer.parseInt(var25.nextToken()));
                        ...
                        var23 = new DisabledAlgorithmConstraints.jdkCAConstraint(var7);
                        var12 = true;
                     } else {
                        Matcher var18;
                        if (var17.startsWith("denyAfter") && (var18 = DisabledAlgorithmConstraints.Constraints.Holder.DENY_AFTER_PATTERN.matcher(var17)).matches()) {
                           if (DisabledAlgorithmConstraints.debug != null) {
                           ...
                           var23 = new DisabledAlgorithmConstraints.DenyAfterConstraint(var7, var24, var20, var21);
                           var13 = true;
                        } else {
                           ...
                           var23 = new DisabledAlgorithmConstraints.UsageConstraint(var7, var19);
                           if (DisabledAlgorithmConstraints.debug != null) {
                     ...
                     if (var11 == null) {
                        ...
                        ((DisabledAlgorithmConstraints.Constraint)var11).nextConstraint = (DisabledAlgorithmConstraints.Constraint)var23;
                     }
      ...
      private List<DisabledAlgorithmConstraints.Constraint> getConstraints(String var1) {
      ...
      public boolean permits(Key var1) {
         ...
         if (var2 == null) {
            ...
            DisabledAlgorithmConstraints.Constraint var4;
            do {
               if (!var3.hasNext()) {
                  return true;
               }

               var4 = (DisabledAlgorithmConstraints.Constraint)var3.next();
      ...
      public boolean permits(String var1, AlgorithmParameters var2) {
         ...
         if (var3 == null) {
            ...
            DisabledAlgorithmConstraints.Constraint var5;
            do {
               if (!var4.hasNext()) {
                  return true;
               }

               var5 = (DisabledAlgorithmConstraints.Constraint)var4.next();
      ...
      public void permits(String var1, ConstraintsParameters var2) throws CertPathValidatorException {
         ...
         while(true) {
            ...
            while(var8.hasNext()) {
               DisabledAlgorithmConstraints.Constraint var9 = (DisabledAlgorithmConstraints.Constraint)var8.next();
               var9.permits(var2);
            }
         }
      }
