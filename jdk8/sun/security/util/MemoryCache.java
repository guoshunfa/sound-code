...
class MemoryCache<K, V> extends Cache<K, V> {
   ...
   public synchronized void clear() {
      if (this.queue != null) {
         ...
         while(var1.hasNext()) {
            MemoryCache.CacheEntry var2 = (MemoryCache.CacheEntry)var1.next();
            var2.invalidate();
         }
   ...
   public synchronized void accept(Cache.CacheVisitor<K, V> var1) {
      this.expungeExpiredEntries();
   ...
   private Map<K, V> getCachedEntries() {
      ...
      while(var2.hasNext()) {
         MemoryCache.CacheEntry var3 = (MemoryCache.CacheEntry)var2.next();
   ...
   private static class HardCacheEntry<K, V> implements MemoryCache.CacheEntry<K, V> {
      private K key;
      private V value;
      private long expirationTime;
