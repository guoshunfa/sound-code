...
public class PKCS7 {
   ...
   public static byte[] generateSignedData(byte[] var0, X509Certificate[] var1, byte[] var2, String var3, URI var4, String var5, String var6) throws CertificateException, IOException, NoSuchAlgorithmException {
      PKCS9Attributes var7 = null;
      if (var4 != null) {
         HttpTimestamper var8 = new HttpTimestamper(var4);
         byte[] var9 = generateTimestampToken(var8, var5, var6, var0);
         var7 = new PKCS9Attributes(new PKCS9Attribute[]{new PKCS9Attribute("SignatureTimestampToken", var9)});
      }

      X500Name var18 = X500Name.asX500Name(var1[0].getIssuerX500Principal());
      BigInteger var19 = var1[0].getSerialNumber();
      String var10 = AlgorithmId.getEncAlgFromSigAlg(var3);
      String var11 = AlgorithmId.getDigAlgFromSigAlg(var3);
      SignerInfo var12 = new SignerInfo(var18, var19, AlgorithmId.get(var11), (PKCS9Attributes)null, AlgorithmId.get(var10), var0, var7);
      SignerInfo[] var13 = new SignerInfo[]{var12};
      AlgorithmId[] var14 = new AlgorithmId[]{var12.getDigestAlgorithmId()};
      ContentInfo var15 = var2 == null ? new ContentInfo(ContentInfo.DATA_OID, (DerValue)null) : new ContentInfo(var2);
      PKCS7 var16 = new PKCS7(var14, var15, var1, var13);
      ByteArrayOutputStream var17 = new ByteArrayOutputStream();
      var16.encodeSignedData((OutputStream)var17);
      return var17.toByteArray();
   }

   private static byte[] generateTimestampToken(Timestamper var0, String var1, String var2, byte[] var3) throws IOException, CertificateException {
      MessageDigest var4 = null;
      TSRequest var5 = null;

      try {
         var4 = MessageDigest.getInstance(var2);
         var5 = new TSRequest(var1, var3, var4);
      } catch (NoSuchAlgorithmException var18) {
         throw new IllegalArgumentException(var18);
      }

      BigInteger var6 = null;
      if (PKCS7.SecureRandomHolder.RANDOM != null) {
         var6 = new BigInteger(64, PKCS7.SecureRandomHolder.RANDOM);
         var5.setNonce(var6);
      }

      var5.requestCertificate(true);
      TSResponse var7 = var0.generateTimestamp(var5);
      int var8 = var7.getStatusCode();
      if (var8 != 0 && var8 != 1) {
         throw new IOException("Error generating timestamp: " + var7.getStatusCodeAsText() + " " + var7.getFailureCodeAsText());
      } else if (var1 != null && !var1.equals(var7.getTimestampToken().getPolicyID())) {
         throw new IOException("TSAPolicyID changed in timestamp token");
      } else {
         PKCS7 var9 = var7.getToken();
         TimestampToken var10 = var7.getTimestampToken();

         try {
            if (!var10.getHashAlgorithm().equals(AlgorithmId.get(var2))) {
               throw new IOException("Digest algorithm not " + var2 + " in timestamp token");
            }
         } catch (NoSuchAlgorithmException var19) {
            throw new IllegalArgumentException();
         }

         if (!MessageDigest.isEqual(var10.getHashedMessage(), var5.getHashedMessage())) {
            throw new IOException("Digest octets changed in timestamp token");
         } else {
            BigInteger var11 = var10.getNonce();
            if (var11 == null && var6 != null) {
               throw new IOException("Nonce missing in timestamp token");
            } else if (var11 != null && !var11.equals(var6)) {
               throw new IOException("Nonce changed in timestamp token");
            } else {
               SignerInfo[] var12 = var9.getSignerInfos();
               int var13 = var12.length;

               for(int var14 = 0; var14 < var13; ++var14) {
                  SignerInfo var15 = var12[var14];
                  X509Certificate var16 = var15.getCertificate(var9);
                  if (var16 == null) {
                     throw new CertificateException("Certificate not included in timestamp token");
                  }

                  if (!var16.getCriticalExtensionOIDs().contains("2.5.29.37")) {
                     throw new CertificateException("Certificate is not valid for timestamping");
                  }

                  List var17 = var16.getExtendedKeyUsage();
                  if (var17 == null || !var17.contains("1.3.6.1.5.5.7.3.8")) {
                     throw new CertificateException("Certificate is not valid for timestamping");
                  }
               }

               return var7.getEncodedToken();
            }
         }
      }
   }
