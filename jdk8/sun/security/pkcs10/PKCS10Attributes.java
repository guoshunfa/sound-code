...
public class PKCS10Attributes implements DerEncoder {
   ...
   public void derEncode(OutputStream var1) throws IOException {
      ...
      PKCS10Attribute[] var3 = (PKCS10Attribute[])var2.toArray(new PKCS10Attribute[this.map.size()]);
   ...
   public void setAttribute(String var1, Object var2) {
      if (var2 instanceof PKCS10Attribute) {
         this.map.put(var1, (PKCS10Attribute)var2);
      }
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         PKCS10Attribute[] var3 = (PKCS10Attribute[])var2.toArray(new PKCS10Attribute[var2.size()]);
         ...
         if (var4 != this.map.size()) {
            ...
            for(int var8 = 0; var8 < var4; ++var8) {
               PKCS10Attribute var6 = var3[var8];
