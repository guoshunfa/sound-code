...
class MicToken extends MessageToken {
   public MicToken(Krb5Context var1, byte[] var2, int var3, int var4, MessageProp var5) throws GSSException {
      super(257, var1, var2, var3, var4, var5);
   }

   public MicToken(Krb5Context var1, InputStream var2, MessageProp var3) throws GSSException {
   ...
   public MicToken(Krb5Context var1, MessageProp var2, byte[] var3, int var4, int var5) throws GSSException {
      super(257, var1);
      if (var2 == null) {
   ...
   public MicToken(Krb5Context var1, MessageProp var2, InputStream var3) throws GSSException, IOException {
      super(257, var1);
