...
public class X509CRLImpl extends X509CRL implements DerEncoder {
   ...
   private Map<X509CRLImpl.X509IssuerSerial, X509CRLEntry> revokedMap;
   ...
   public X509CRLImpl(X500Name var1, Date var2, Date var3, X509CRLEntry[] var4) throws CRLException {
      ...
      if (var4 != null) {
         ...
         for(int var7 = 0; var7 < var4.length; ++var7) {
            ...
            X509CRLImpl.X509IssuerSerial var9 = new X509CRLImpl.X509IssuerSerial(var6, var8.getSerialNumber());
   ...
   public boolean isRevoked(Certificate var1) {
      if (!this.revokedMap.isEmpty() && var1 instanceof X509Certificate) {
         ...
         X509CRLImpl.X509IssuerSerial var3 = new X509CRLImpl.X509IssuerSerial(var2);
   ...
   public X509CRLEntry getRevokedCertificate(BigInteger var1) {
      if (this.revokedMap.isEmpty()) {
         ...
         X509CRLImpl.X509IssuerSerial var2 = new X509CRLImpl.X509IssuerSerial(this.getIssuerX500Principal(), var1);
   ...
   public X509CRLEntry getRevokedCertificate(X509Certificate var1) {
      if (this.revokedMap.isEmpty()) {
         ...
         X509CRLImpl.X509IssuerSerial var2 = new X509CRLImpl.X509IssuerSerial(var1);
         return (X509CRLEntry)this.revokedMap.get(var2);
      }
   }
                        ...
                        if (var3.available() != 0) {
                           ...
                           if (var5 == 48 && (var5 & 192) != 128) {
                              ...
                              for(int var10 = 0; var10 < var7.length; ++var10) {
                                 ...
                                 X509CRLImpl.X509IssuerSerial var12 = new X509CRLImpl.X509IssuerSerial(var9, var11.getSerialNumber());
   ...
   private static final class X509IssuerSerial implements Comparable<X509CRLImpl.X509IssuerSerial> {
      ...
      public int compareTo(X509CRLImpl.X509IssuerSerial var1) {
