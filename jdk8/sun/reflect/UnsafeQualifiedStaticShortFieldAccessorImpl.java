...
class UnsafeQualifiedStaticShortFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
   UnsafeQualifiedStaticShortFieldAccessorImpl(Field var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Byte) {
         unsafe.putShortVolatile(this.base, this.fieldOffset, (short)(Byte)var2);
      } else if (var2 instanceof Short) {
         unsafe.putShortVolatile(this.base, this.fieldOffset, (Short)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setShort(Object var1, short var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putShortVolatile(this.base, this.fieldOffset, var2);
   }
