...
class UnsafeQualifiedCharacterFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
   UnsafeQualifiedCharacterFieldAccessorImpl(Field var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public char getChar(Object var1) throws IllegalArgumentException {
      this.ensureObj(var1);
      return unsafe.getCharVolatile(var1, this.fieldOffset);
   }
   ...
   public void setChar(Object var1, char var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putCharVolatile(var1, this.fieldOffset, var2);
   }
