...
class UnsafeFloatFieldAccessorImpl extends UnsafeFieldAccessorImpl {
   UnsafeFloatFieldAccessorImpl(Field var1) {
      super(var1);
   }
   ...
   public float getFloat(Object var1) throws IllegalArgumentException {
      this.ensureObj(var1);
      return unsafe.getFloat(var1, this.fieldOffset);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Byte) {
         unsafe.putFloat(var1, this.fieldOffset, (float)(Byte)var2);
      } else if (var2 instanceof Short) {
         unsafe.putFloat(var1, this.fieldOffset, (float)(Short)var2);
      } else if (var2 instanceof Character) {
         unsafe.putFloat(var1, this.fieldOffset, (float)(Character)var2);
      } else if (var2 instanceof Integer) {
         unsafe.putFloat(var1, this.fieldOffset, (float)(Integer)var2);
      } else if (var2 instanceof Long) {
         unsafe.putFloat(var1, this.fieldOffset, (float)(Long)var2);
      } else if (var2 instanceof Float) {
         unsafe.putFloat(var1, this.fieldOffset, (Float)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setFloat(Object var1, float var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putFloat(var1, this.fieldOffset, var2);
   }
