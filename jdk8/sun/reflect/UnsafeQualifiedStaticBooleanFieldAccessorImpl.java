...
class UnsafeQualifiedStaticBooleanFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
   UnsafeQualifiedStaticBooleanFieldAccessorImpl(Field var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Boolean) {
         unsafe.putBooleanVolatile(this.base, this.fieldOffset, (Boolean)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setBoolean(Object var1, boolean var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putBooleanVolatile(this.base, this.fieldOffset, var2);
   }
