...
class UnsafeQualifiedIntegerFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
   UnsafeQualifiedIntegerFieldAccessorImpl(Field var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public int getInt(Object var1) throws IllegalArgumentException {
      this.ensureObj(var1);
      return unsafe.getIntVolatile(var1, this.fieldOffset);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Byte) {
         unsafe.putIntVolatile(var1, this.fieldOffset, (Byte)var2);
      } else if (var2 instanceof Short) {
         unsafe.putIntVolatile(var1, this.fieldOffset, (Short)var2);
      } else if (var2 instanceof Character) {
         unsafe.putIntVolatile(var1, this.fieldOffset, (Character)var2);
      } else if (var2 instanceof Integer) {
         unsafe.putIntVolatile(var1, this.fieldOffset, (Integer)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setInt(Object var1, int var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putIntVolatile(var1, this.fieldOffset, var2);
   }
