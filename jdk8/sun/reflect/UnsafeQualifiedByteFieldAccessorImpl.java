...
class UnsafeQualifiedByteFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
   UnsafeQualifiedByteFieldAccessorImpl(Field var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public byte getByte(Object var1) throws IllegalArgumentException {
      this.ensureObj(var1);
      return unsafe.getByteVolatile(var1, this.fieldOffset);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Byte) {
         unsafe.putByteVolatile(var1, this.fieldOffset, (Byte)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setByte(Object var1, byte var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putByteVolatile(var1, this.fieldOffset, var2);
   }
