...
class UnsafeStaticLongFieldAccessorImpl extends UnsafeStaticFieldAccessorImpl {
   UnsafeStaticLongFieldAccessorImpl(Field var1) {
      super(var1);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Byte) {
         unsafe.putLong(this.base, this.fieldOffset, (long)(Byte)var2);
      } else if (var2 instanceof Short) {
         unsafe.putLong(this.base, this.fieldOffset, (long)(Short)var2);
      } else if (var2 instanceof Character) {
         unsafe.putLong(this.base, this.fieldOffset, (long)(Character)var2);
      } else if (var2 instanceof Integer) {
         unsafe.putLong(this.base, this.fieldOffset, (long)(Integer)var2);
      } else if (var2 instanceof Long) {
         unsafe.putLong(this.base, this.fieldOffset, (Long)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setLong(Object var1, long var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putLong(this.base, this.fieldOffset, var2);
   }
