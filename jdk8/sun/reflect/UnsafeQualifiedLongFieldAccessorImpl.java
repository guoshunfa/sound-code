...
class UnsafeQualifiedLongFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
   UnsafeQualifiedLongFieldAccessorImpl(Field var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public long getLong(Object var1) throws IllegalArgumentException {
      this.ensureObj(var1);
      return unsafe.getLongVolatile(var1, this.fieldOffset);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Byte) {
         unsafe.putLongVolatile(var1, this.fieldOffset, (long)(Byte)var2);
      } else if (var2 instanceof Short) {
         unsafe.putLongVolatile(var1, this.fieldOffset, (long)(Short)var2);
      } else if (var2 instanceof Character) {
         unsafe.putLongVolatile(var1, this.fieldOffset, (long)(Character)var2);
      } else if (var2 instanceof Integer) {
         unsafe.putLongVolatile(var1, this.fieldOffset, (long)(Integer)var2);
      } else if (var2 instanceof Long) {
         unsafe.putLongVolatile(var1, this.fieldOffset, (Long)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setLong(Object var1, long var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putLongVolatile(var1, this.fieldOffset, var2);
   }
