...
class UnsafeQualifiedStaticLongFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
   UnsafeQualifiedStaticLongFieldAccessorImpl(Field var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Byte) {
         unsafe.putLongVolatile(this.base, this.fieldOffset, (long)(Byte)var2);
      } else if (var2 instanceof Short) {
         unsafe.putLongVolatile(this.base, this.fieldOffset, (long)(Short)var2);
      } else if (var2 instanceof Character) {
         unsafe.putLongVolatile(this.base, this.fieldOffset, (long)(Character)var2);
      } else if (var2 instanceof Integer) {
         unsafe.putLongVolatile(this.base, this.fieldOffset, (long)(Integer)var2);
      } else if (var2 instanceof Long) {
         unsafe.putLongVolatile(this.base, this.fieldOffset, (Long)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setLong(Object var1, long var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putLongVolatile(this.base, this.fieldOffset, var2);
   }
