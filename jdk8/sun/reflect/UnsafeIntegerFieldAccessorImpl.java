...
class UnsafeIntegerFieldAccessorImpl extends UnsafeFieldAccessorImpl {
   UnsafeIntegerFieldAccessorImpl(Field var1) {
      super(var1);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Byte) {
         unsafe.putInt(var1, this.fieldOffset, (Byte)var2);
      } else if (var2 instanceof Short) {
         unsafe.putInt(var1, this.fieldOffset, (Short)var2);
      } else if (var2 instanceof Character) {
         unsafe.putInt(var1, this.fieldOffset, (Character)var2);
      } else if (var2 instanceof Integer) {
         unsafe.putInt(var1, this.fieldOffset, (Integer)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setInt(Object var1, int var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putInt(var1, this.fieldOffset, var2);
   }
