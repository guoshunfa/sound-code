...
class UnsafeQualifiedShortFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
   UnsafeQualifiedShortFieldAccessorImpl(Field var1, boolean var2) {
      super(var1, var2);
   }
   ...
   public short getShort(Object var1) throws IllegalArgumentException {
      this.ensureObj(var1);
      return unsafe.getShortVolatile(var1, this.fieldOffset);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Byte) {
         unsafe.putShortVolatile(var1, this.fieldOffset, (short)(Byte)var2);
      } else if (var2 instanceof Short) {
         unsafe.putShortVolatile(var1, this.fieldOffset, (Short)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setShort(Object var1, short var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putShortVolatile(var1, this.fieldOffset, var2);
   }
