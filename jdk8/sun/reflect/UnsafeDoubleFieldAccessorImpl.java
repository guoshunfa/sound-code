...
class UnsafeDoubleFieldAccessorImpl extends UnsafeFieldAccessorImpl {
   UnsafeDoubleFieldAccessorImpl(Field var1) {
      super(var1);
   }
   ...
   public double getDouble(Object var1) throws IllegalArgumentException {
      this.ensureObj(var1);
      return unsafe.getDouble(var1, this.fieldOffset);
   }
   ...
   public void set(Object var1, Object var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      if (var2 instanceof Byte) {
         unsafe.putDouble(var1, this.fieldOffset, (double)(Byte)var2);
      } else if (var2 instanceof Short) {
         unsafe.putDouble(var1, this.fieldOffset, (double)(Short)var2);
      } else if (var2 instanceof Character) {
         unsafe.putDouble(var1, this.fieldOffset, (double)(Character)var2);
      } else if (var2 instanceof Integer) {
         unsafe.putDouble(var1, this.fieldOffset, (double)(Integer)var2);
      } else if (var2 instanceof Long) {
         unsafe.putDouble(var1, this.fieldOffset, (double)(Long)var2);
      } else if (var2 instanceof Float) {
         unsafe.putDouble(var1, this.fieldOffset, (double)(Float)var2);
      } else if (var2 instanceof Double) {
         unsafe.putDouble(var1, this.fieldOffset, (Double)var2);
      } else {
         this.throwSetIllegalArgumentException(var2);
      }
   }
   ...
   public void setDouble(Object var1, double var2) throws IllegalArgumentException, IllegalAccessException {
      ...
      unsafe.putDouble(var1, this.fieldOffset, var2);
   }
}
