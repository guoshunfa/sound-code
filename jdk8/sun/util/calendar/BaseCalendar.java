...
public abstract class BaseCalendar extends AbstractCalendar {
   ...
   public int getYearLength(CalendarDate var1) {
      return this.isLeapYear(((BaseCalendar.Date)var1).getNormalizedYear()) ? 366 : 365;
   }
   ...
   public long getDayOfYear(CalendarDate var1) {
      return this.getDayOfYear(((BaseCalendar.Date)var1).getNormalizedYear(), var1.getMonth(), var1.getDayOfMonth());
   }
   ...
   public long getFixedDate(CalendarDate var1) {
      ...
      return this.getFixedDate(((BaseCalendar.Date)var1).getNormalizedYear(), var1.getMonth(), var1.getDayOfMonth(), (BaseCalendar.Date)var1);
   }
   ...
   public void getCalendarDateFromFixedDate(CalendarDate var1, long var2) {
      BaseCalendar.Date var4 = (BaseCalendar.Date)var1;
      int var5;
      long var6;
      boolean var8;
      if (var4.hit(var2)) {
         ...
         var6 = this.getFixedDate(var5, 1, 1, (BaseCalendar.Date)null);
         var8 = this.isLeapYear(var5);
   ...
   protected boolean isLeapYear(CalendarDate var1) {
      return this.isLeapYear(((BaseCalendar.Date)var1).getNormalizedYear());
   }
   ...
   public abstract static class Date extends CalendarDate {
      ...
      public BaseCalendar.Date setNormalizedDate(int var1, int var2, int var3) {
