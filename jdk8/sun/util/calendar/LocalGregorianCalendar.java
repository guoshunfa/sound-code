...
public class LocalGregorianCalendar extends BaseCalendar {
   ...
   public LocalGregorianCalendar.Date getCalendarDate(long var1) {
      return this.getCalendarDate(var1, (CalendarDate)this.newCalendarDate());
   }

   public LocalGregorianCalendar.Date getCalendarDate(long var1, TimeZone var3) {
      return this.getCalendarDate(var1, (CalendarDate)this.newCalendarDate(var3));
   }

   public LocalGregorianCalendar.Date getCalendarDate(long var1, CalendarDate var3) {
      LocalGregorianCalendar.Date var4 = (LocalGregorianCalendar.Date)super.getCalendarDate(var1, var3);
      return this.adjustYear(var4, var1, var4.getZoneOffset());
   }

   private LocalGregorianCalendar.Date adjustYear(LocalGregorianCalendar.Date var1, long var2, int var4) {
      int var5;
   ...
   public LocalGregorianCalendar.Date newCalendarDate(TimeZone var1) {
      return new LocalGregorianCalendar.Date(var1);
   }

   public boolean validate(CalendarDate var1) {
      LocalGregorianCalendar.Date var2 = (LocalGregorianCalendar.Date)var1;
      ...
      if (var3 != null) {
         ...
         LocalGregorianCalendar.Date var4 = this.newCalendarDate(var1.getZone());
   ...
   public void getCalendarDateFromFixedDate(CalendarDate var1, long var2) {
      LocalGregorianCalendar.Date var4 = (LocalGregorianCalendar.Date)var1;
   ...
   public static class Date extends BaseCalendar.Date {
      ...
      public LocalGregorianCalendar.Date setEra(Era var1) {
         if (this.getEra() != var1) {
            super.setEra(var1);
      ...
      public LocalGregorianCalendar.Date addYear(int var1) {
         super.addYear(var1);
         this.gregorianYear += var1;
         return this;
      }

      public LocalGregorianCalendar.Date setYear(int var1) {
