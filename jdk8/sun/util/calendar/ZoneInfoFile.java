...
public final class ZoneInfoFile {
   ...
   public static ZoneInfo getZoneInfo(DataInput var0, String var1) throws Exception {
      ...
      ZoneInfoFile.ZoneOffsetTransitionRule[] var10 = new ZoneInfoFile.ZoneOffsetTransitionRule[var14];

      for(int var11 = 0; var11 < var14; ++var11) {
         var10[var11] = new ZoneInfoFile.ZoneOffsetTransitionRule(var0);
      }
   ...
   private static ZoneInfo getZoneInfo(String var0, long[] var1, int[] var2, long[] var3, int[] var4, ZoneInfoFile.ZoneOffsetTransitionRule[] var5) {
      boolean var6 = false;
      int var7 = 0;
      int var8 = 0;
      int[] var9 = null;
      ...
      if (var3.length != 0) {
         ...
         if (var5.length <= 1) {
            ...
            while(true) {
               if (var15++ >= 2037) {
                  ZoneInfoFile.ZoneOffsetTransitionRule var34 = var5[var5.length - 2];
                  ZoneInfoFile.ZoneOffsetTransitionRule var35 = var5[var5.length - 1];
                  var9 = new int[10];
                  if (var34.offsetAfter - var34.offsetBefore < 0 && var35.offsetAfter - var35.offsetBefore > 0) {
                     ZoneInfoFile.ZoneOffsetTransitionRule var39 = var34;
                     var34 = var35;
                     var35 = var39;
                  }
               ...
               ZoneInfoFile.ZoneOffsetTransitionRule[] var33 = var5;
               int var19 = var5.length;

               for(var36 = 0; var36 < var19; ++var36) {
                  ZoneInfoFile.ZoneOffsetTransitionRule var40 = var33[var36];
         ...
         if (var11 != null) {
            ZoneInfoFile.Checksum var41 = new ZoneInfoFile.Checksum();
