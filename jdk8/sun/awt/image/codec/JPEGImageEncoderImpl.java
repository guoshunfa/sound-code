...
public class JPEGImageEncoderImpl implements JPEGImageEncoder {
   ...
   private void verify(int var1, int var2, int var3) throws ImageFormatException {
      ...
      if (var4 > 0 && var5 > 0 && var5 <= Integer.MAX_VALUE / var4) {
         if (var2 >= 0 && var2 <= Integer.MAX_VALUE / var5 && var2 <= var3) {
            int var7 = (var5 - 1) * var2;
            if (var6 >= 0 && var6 <= Integer.MAX_VALUE / var4 && var6 <= var3 && var6 * var4 <= var2) {
               int var8 = var4 * var6;
               if (var8 > Integer.MAX_VALUE - var7) {
                  throw new ImageFormatException("Invalid raster attributes");
               } else {
                  int var9 = var7 + var8;
                  if (var1 >= 0 && var1 <= Integer.MAX_VALUE - var9) {
                     int var10 = var1 + var9;
                     if (var10 > var3) {
