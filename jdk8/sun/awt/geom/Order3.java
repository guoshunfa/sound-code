...
final class Order3 extends Curve {
   ...
   public static int getHorizontalParams(double var0, double var2, double var4, double var6, double[] var8) {
      if (var0 <= var2 && var2 <= var4 && var4 <= var6) {
         ...
         var2 -= var0;
         var8[0] = var2;
         var8[1] = (var4 - var2) * 2.0D;
         var8[2] = var6 - var4 - var4 + var2;
         int var9 = QuadCurve2D.solveQuadratic(var8, var8);
         int var10 = 0;
   ...
   public Order3(double var1, double var3, double var5, double var7, double var9, double var11, double var13, double var15, int var17) {
      ...
      this.xcoeff0 = var1;
      this.xcoeff1 = (var5 - var1) * 3.0D;
      this.xcoeff2 = (var9 - var5 - var5 + var1) * 3.0D;
      this.xcoeff3 = var13 - (var9 - var5) * 3.0D - var1;
      this.ycoeff0 = var3;
      this.ycoeff1 = (var7 - var3) * 3.0D;
      this.ycoeff2 = (var11 - var7 - var7 + var3) * 3.0D;
      this.ycoeff3 = var15 - (var11 - var7) * 3.0D - var3;
   ...
   public double TforY(double var1) {
      if (var1 <= this.y0) {
         ...
         boolean var9 = false;
         double var10 = (var3 * var3 - 3.0D * var5) / 9.0D;
         double var12 = (2.0D * var3 * var3 * var3 - 9.0D * var3 * var5 + 27.0D * var7) / 54.0D;
         double var14 = var12 * var12;
         double var16 = var10 * var10 * var10;
         double var18 = var3 / 3.0D;
         double var20;
         double var22;
         if (var14 < var16) {
            var22 = Math.acos(var12 / Math.sqrt(var16));
            var10 = -2.0D * Math.sqrt(var10);
            var20 = this.refine(var3, var5, var7, var1, var10 * Math.cos(var22 / 3.0D) - var18);
            if (var20 < 0.0D) {
               var20 = this.refine(var3, var5, var7, var1, var10 * Math.cos((var22 + 6.283185307179586D) / 3.0D) - var18);
            }
            ...
            boolean var29 = var12 < 0.0D;
            double var23 = Math.sqrt(var14 - var16);
            if (var29) {
               var12 = -var12;
            }

            double var25 = Math.pow(var12 + var23, 0.3333333333333333D);
            if (!var29) {
               var25 = -var25;
            }

            double var27 = var25 == 0.0D ? 0.0D : var10 / var25;
   ...
   public double dXforT(double var1, int var3) {
      ...
      case 0:
         return ((this.xcoeff3 * var1 + this.xcoeff2) * var1 + this.xcoeff1) * var1 + this.xcoeff0;
      case 1:
         return (3.0D * this.xcoeff3 * var1 + 2.0D * this.xcoeff2) * var1 + this.xcoeff1;
      case 2:
         return 6.0D * this.xcoeff3 * var1 + 2.0D * this.xcoeff2;
      case 3:
   ...
   public double dYforT(double var1, int var3) {
      ...
      case 0:
         return ((this.ycoeff3 * var1 + this.ycoeff2) * var1 + this.ycoeff1) * var1 + this.ycoeff0;
      case 1:
         return (3.0D * this.ycoeff3 * var1 + 2.0D * this.ycoeff2) * var1 + this.ycoeff1;
      case 2:
         return 6.0D * this.ycoeff3 * var1 + 2.0D * this.ycoeff2;
      case 3:
   ...
   public double nextVertical(double var1, double var3) {
      double[] var5 = new double[]{this.xcoeff1, 2.0D * this.xcoeff2, 3.0D * this.xcoeff3};
      int var6 = QuadCurve2D.solveQuadratic(var5, var5);
   ...
   public void enlarge(Rectangle2D var1) {
      var1.add(this.x0, this.y0);
      double[] var2 = new double[]{this.xcoeff1, 2.0D * this.xcoeff2, 3.0D * this.xcoeff3};
      int var3 = QuadCurve2D.solveQuadratic(var2, var2);

      for(int var4 = 0; var4 < var3; ++var4) {
         double var5 = var2[var4];
         if (var5 > 0.0D && var5 < 1.0D) {
            var1.add(this.XforT(var5), this.YforT(var5));
         }
      }

      var1.add(this.x1, this.y1);
   }
