...
final class Order2 extends Curve {
   ...
   public double TforY(double var1) {
      if (var1 <= this.y0) {
         ...
         return var1 >= this.y1 ? 1.0D : TforY(var1, this.ycoeff0, this.ycoeff1, this.ycoeff2);
      }
   }
   ...
   public static double TforY(double var0, double var2, double var4, double var6) {
      ...
      if (var6 == 0.0D) {
         var8 = -var2 / var4;
         if (var8 >= 0.0D && var8 <= 1.0D) {
            return var8;
         }
      } else {
         var8 = var4 * var4 - 4.0D * var6 * var2;
         if (var8 >= 0.0D) {
            var8 = Math.sqrt(var8);
            if (var4 < 0.0D) {
               var8 = -var8;
      ...
      return 0.0D < (var2 + var10) / 2.0D ? 0.0D : 1.0D;
   }
   ...
   public double dXforT(double var1, int var3) {
      ...
      case 0:
         return (this.xcoeff2 * var1 + this.xcoeff1) * var1 + this.xcoeff0;
      case 1:
         return 2.0D * this.xcoeff2 * var1 + this.xcoeff1;
      case 2:
   ...
   public double dYforT(double var1, int var3) {
      ...
      case 0:
         return (this.ycoeff2 * var1 + this.ycoeff1) * var1 + this.ycoeff0;
      case 1:
         return 2.0D * this.ycoeff2 * var1 + this.ycoeff1;
      case 2:
