...
public class JvmRTBootClassPathTableMetaImpl extends JvmRTBootClassPathTableMeta {
   ...
   private SnmpTableCache cache = new JvmRTBootClassPathTableMetaImpl.JvmRTBootClassPathTableCache(this, -1L);
   static final MibLogger log = new MibLogger(JvmRTBootClassPathTableMetaImpl.class);

   public JvmRTBootClassPathTableMetaImpl(SnmpMib var1, SnmpStandardObjectServer var2) {
      super(var1, var2);
   }
   ...
   public Object getEntry(SnmpOid var1) throws SnmpStatusException {
      ...
      if (var1 != null && var1.getLength() == 1) {
         ...
         String var4 = var3 == null ? null : "JvmRTBootClassPathTable.entry." + var1.toString();
         if (var3 != null) {
         ...
         if (var8 == null) {
            ...
            if (var6 == null) {
               ...
               JvmRTBootClassPathEntryImpl var7 = new JvmRTBootClassPathEntryImpl((String)var6, (int)var1.getOidArc(0));
   ...
   protected SnmpTableHandler getHandler(Object var1) {
      ...
      if (var2 != null) {
         var3 = (SnmpTableHandler)var2.get("JvmRTBootClassPathTable.handler");
         if (var3 != null) {
            return var3;
         }
      }
      ...
      if (var2 != null && var3 != null) {
         var2.put("JvmRTBootClassPathTable.handler", var3);
      }
   ...
   private static class JvmRTBootClassPathTableCache extends SnmpTableCache {
      ...
      JvmRTBootClassPathTableCache(JvmRTBootClassPathTableMetaImpl var1, long var2) {
         this.meta = var1;
         this.validity = var2;
      }
      ...
      protected SnmpCachedData updateCachedDatas(Object var1) {
         String[] var2 = JvmRuntimeImpl.getBootClassPath(var1);
