...
public class JvmRTClassPathTableMetaImpl extends JvmRTClassPathTableMeta {
   ...
   private SnmpTableCache cache = new JvmRTClassPathTableMetaImpl.JvmRTClassPathTableCache(this, -1L);
   static final MibLogger log = new MibLogger(JvmRTClassPathTableMetaImpl.class);

   public JvmRTClassPathTableMetaImpl(SnmpMib var1, SnmpStandardObjectServer var2) {
      super(var1, var2);
   }
   ...
   public Object getEntry(SnmpOid var1) throws SnmpStatusException {
      ...
      if (var1 != null && var1.getLength() == 1) {
         ...
         String var4 = var3 == null ? null : "JvmRTClassPathTable.entry." + var1.toString();
         if (var3 != null) {
         ...
         if (var8 == null) {
            ...
            if (var6 == null) {
               ...
               JvmRTClassPathEntryImpl var7 = new JvmRTClassPathEntryImpl((String)var6, (int)var1.getOidArc(0));
   ...
   protected SnmpTableHandler getHandler(Object var1) {
      ...
      if (var2 != null) {
         var3 = (SnmpTableHandler)var2.get("JvmRTClassPathTable.handler");
         if (var3 != null) {
            return var3;
         }
      }
      ...
      if (var2 != null && var3 != null) {
         var2.put("JvmRTClassPathTable.handler", var3);
      }
   ...
   private static class JvmRTClassPathTableCache extends SnmpTableCache {
      ...
      JvmRTClassPathTableCache(JvmRTClassPathTableMetaImpl var1, long var2) {
         this.meta = var1;
         this.validity = var2;
      }
      ...
      protected SnmpCachedData updateCachedDatas(Object var1) {
         String[] var2 = JvmRuntimeImpl.getClassPath(var1);
