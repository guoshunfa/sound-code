...
public class JvmRTBootClassPathTableMeta extends SnmpMibTable implements Serializable {
   ...
   public JvmRTBootClassPathTableMeta(SnmpMib var1, SnmpStandardObjectServer var2) {
      super(var1);
      this.objectserver = var2;
   }

   protected JvmRTBootClassPathEntryMeta createJvmRTBootClassPathEntryMetaNode(String var1, String var2, SnmpMib var3, MBeanServer var4) {
      return new JvmRTBootClassPathEntryMeta(var3, this.objectserver);
   }
   ...
   public void registerEntryNode(SnmpMib var1, MBeanServer var2) {
      this.node = this.createJvmRTBootClassPathEntryMetaNode("JvmRTBootClassPathEntry", "JvmRTBootClassPathTable", var1, var2);
   }

   public synchronized void addEntry(SnmpOid var1, ObjectName var2, Object var3) throws SnmpStatusException {
      if (!(var3 instanceof JvmRTBootClassPathEntryMBean)) {
   ...
   public void get(SnmpMibSubRequest var1, SnmpOid var2, int var3) throws SnmpStatusException {
      JvmRTBootClassPathEntryMBean var4 = (JvmRTBootClassPathEntryMBean)this.getEntry(var2);
      synchronized(this) {
   ...
   public boolean skipEntryVariable(SnmpOid var1, long var2, Object var4, int var5) {
      try {
         JvmRTBootClassPathEntryMBean var6 = (JvmRTBootClassPathEntryMBean)this.getEntry(var1);
         synchronized(this) {
