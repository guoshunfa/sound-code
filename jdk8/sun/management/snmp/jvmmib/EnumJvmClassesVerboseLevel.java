...
public class EnumJvmClassesVerboseLevel extends Enumerated implements Serializable {
   ...
   public EnumJvmClassesVerboseLevel(int var1) throws IllegalArgumentException {
      super(var1);
   }

   public EnumJvmClassesVerboseLevel(Integer var1) throws IllegalArgumentException {
      super(var1);
   }
   ...
   public EnumJvmClassesVerboseLevel(String var1) throws IllegalArgumentException {
      super(var1);
   }
