...
public class AgentConfigurationError extends Error {
   ...
   public AgentConfigurationError(String var1) {
      this.error = var1;
      this.params = null;
   }

   public AgentConfigurationError(String var1, Throwable var2) {
      super(var2);
      this.error = var1;
      this.params = null;
   }

   public AgentConfigurationError(String var1, String... var2) {
      this.error = var1;
      this.params = (String[])var2.clone();
   }

   public AgentConfigurationError(String var1, Throwable var2, String... var3) {
      super(var2);
      this.error = var1;
      this.params = (String[])var3.clone();
   }
