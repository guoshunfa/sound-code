...
public class RoleList extends ArrayList<Object> {
   ...
   public RoleList(int var1) {
      super(var1);
   }

   public RoleList(List<Role> var1) throws IllegalArgumentException {
      if (var1 == null) {
   ...
   public void add(Role var1) throws IllegalArgumentException {
      if (var1 == null) {
   ...
   public void add(int var1, Role var2) throws IllegalArgumentException, IndexOutOfBoundsException {
      if (var2 == null) {
   ...
   public void set(int var1, Role var2) throws IllegalArgumentException, IndexOutOfBoundsException {
      if (var2 == null) {
         String var3 = "Invalid parameter.";
         throw new IllegalArgumentException(var3);
      } else {
   ...
   public boolean addAll(RoleList var1) throws IndexOutOfBoundsException {
      return var1 == null ? true : super.addAll(var1);
   }

   public boolean addAll(int var1, RoleList var2) throws IllegalArgumentException, IndexOutOfBoundsException {
      if (var2 == null) {
         String var3 = "Invalid parameter.";
         throw new IllegalArgumentException(var3);
      } else {
   ...
   private static void checkTypeSafe(Collection<?> var0) {
      try {
         Role var1;
         Object var3;
         for(Iterator var2 = var0.iterator(); var2.hasNext(); var1 = (Role)var3) {
            var3 = var2.next();
         }
