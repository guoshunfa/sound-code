...
public class BasicTabbedPaneUI extends TabbedPaneUI implements SwingConstants {
   ...
   private BasicTabbedPaneUI.TabContainer tabContainer;
   protected transient Rectangle calcRect = new Rectangle(0, 0, 0, 0);
   private int focusIndex;
   private BasicTabbedPaneUI.Handler handler;
   ...
   static void loadActionMap(LazyActionMap var0) {
      var0.put(new BasicTabbedPaneUI.Actions("navigateNext"));
      var0.put(new BasicTabbedPaneUI.Actions("navigatePrevious"));
      var0.put(new BasicTabbedPaneUI.Actions("navigateRight"));
      var0.put(new BasicTabbedPaneUI.Actions("navigateLeft"));
      var0.put(new BasicTabbedPaneUI.Actions("navigateUp"));
      var0.put(new BasicTabbedPaneUI.Actions("navigateDown"));
      var0.put(new BasicTabbedPaneUI.Actions("navigatePageUp"));
      var0.put(new BasicTabbedPaneUI.Actions("navigatePageDown"));
      var0.put(new BasicTabbedPaneUI.Actions("requestFocus"));
      var0.put(new BasicTabbedPaneUI.Actions("requestFocusForVisibleComponent"));
      var0.put(new BasicTabbedPaneUI.Actions("setSelectedIndex"));
      var0.put(new BasicTabbedPaneUI.Actions("selectTabWithFocus"));
      var0.put(new BasicTabbedPaneUI.Actions("scrollTabsForwardAction"));
      var0.put(new BasicTabbedPaneUI.Actions("scrollTabsBackwardAction"));
   }
   ...
   protected LayoutManager createLayoutManager() {
      return (LayoutManager)(this.tabPane.getTabLayoutPolicy() == 1 ? new BasicTabbedPaneUI.TabbedPaneScrollLayout() : new BasicTabbedPaneUI.TabbedPaneLayout());
   }

   private boolean scrollableTabLayoutEnabled() {
      return this.tabPane.getLayout() instanceof BasicTabbedPaneUI.TabbedPaneScrollLayout;
   }

   protected void installComponents() {
      if (this.scrollableTabLayoutEnabled() && this.tabScroller == null) {
         this.tabScroller = new BasicTabbedPaneUI.ScrollableTabSupport(this.tabPane.getTabPlacement());
      ...
      for(int var1 = 0; var1 < this.tabPane.getTabCount(); ++var1) {
         ...
         if (var2 != null) {
            if (this.tabContainer == null) {
               this.tabContainer = new BasicTabbedPaneUI.TabContainer();
            }
   ...
   protected JButton createScrollButton(int var1) {
      if (var1 != 5 && var1 != 1 && var1 != 3 && var1 != 7) {
         ...
         return new BasicTabbedPaneUI.ScrollableTabButton(var1);
      }
   }
   ...
   private BasicTabbedPaneUI.Handler getHandler() {
      if (this.handler == null) {
         this.handler = new BasicTabbedPaneUI.Handler();
      }
   ...
   private void addMnemonic(int var1, int var2) {
      ...
      this.mnemonicInputMap.put(KeyStroke.getKeyStroke(var2, BasicLookAndFeel.getFocusAcceleratorKeyMask()), "setSelectedIndex");
      this.mnemonicToIndexMap.put(var2, var1);
   }
   ...
   protected void paintTab(Graphics var1, int var2, Rectangle[] var3, int var4, Rectangle var5, Rectangle var6) {
      ...
      if (this.tabPane.getTabComponentAt(var4) == null) {
         ...
         if (this.scrollableTabLayoutEnabled() && this.tabScroller.croppedEdge.isParamsSet() && this.tabScroller.croppedEdge.getTabIndex() == var4 && this.isHorizontalTabPlacement()) {
            ...
            var14 = SwingUtilities2.clipStringIfNecessary((JComponent)null, var12, var10, var6.width);
         }
   ...
   private static Polygon createCroppedTabShape(int var0, Rectangle var1, int var2) {
      ...
      for(int var12 = 0; var12 < var7; ++var12) {
         for(int var13 = 0; var13 < xCropLen.length; ++var13) {
            var9[var14] = var2 - xCropLen[var13];
            var10[var14] = var4 + var12 * 12 + yCropLen[var13];
            if (var10[var14] >= var5) {
               var10[var14] = var5;
               ++var14;
               break;
      ...
      if (var0 != 1 && var0 != 3) {
         return new Polygon(var10, var9, var14);
      } else {
         return new Polygon(var9, var10, var14);
      }
   }
   ...
   protected int getTabLabelShiftX(int var1, int var2, boolean var3) {
      ...
      String var5 = var3 ? "selectedLabelShift" : "labelShift";
      int var6 = DefaultLookup.getInt(this.tabPane, this, "TabbedPane." + var5, 1);
      switch(var1) {
      case 1:
      case 3:
      default:
   ...
   protected int getTabLabelShiftY(int var1, int var2, boolean var3) {
      Rectangle var4 = this.rects[var2];
      int var5 = var3 ? DefaultLookup.getInt(this.tabPane, this, "TabbedPane.selectedLabelShift", -1) : DefaultLookup.getInt(this.tabPane, this, "TabbedPane.labelShift", 1);
      switch(var1) {
      case 1:
      default:
         return var5;
   ...
   protected void navigateSelectedTab(int var1) {
      ...
      int var4 = this.tabPane.getTabCount();
      boolean var5 = BasicGraphicsUtils.isLeftToRight(this.tabPane);
      if (var4 > 0) {
         int var6;
         switch(var2) {
         case 1:
   ...
   private void repaintTab(int var1) {
      if (!this.isRunsDirty && var1 >= 0 && var1 < this.tabPane.getTabCount()) {
         this.tabPane.repaint(this.getTabBounds(this.tabPane, var1));
      }
   ...
   private class CroppedEdge extends JPanel implements UIResource {
      ...
      public void setParams(int var1, int var2, int var3, int var4) {
         ...
         this.cropx = var3;
         this.cropy = var4;
         Rectangle var5 = BasicTabbedPaneUI.this.rects[var1];
         this.setBounds(var5);
         this.shape = BasicTabbedPaneUI.createCroppedTabShape(BasicTabbedPaneUI.this.tabPane.getTabPlacement(), var5, var2);
      ...
      private Color getBgColor() {
         Container var1 = BasicTabbedPaneUI.this.tabPane.getParent();
         if (var1 != null) {
      ...
      protected void paintComponent(Graphics var1) {
         ...
         if (this.isParamsSet() && var1 instanceof Graphics2D) {
            ...
            BasicTabbedPaneUI.this.paintCroppedTabEdge(var1);
            var2.translate(-this.cropx, -this.cropy);
         }
   ...
   private class TabContainer extends JPanel implements UIResource {
      ...
      public void remove(Component var1) {
         int var2 = BasicTabbedPaneUI.this.tabPane.indexOfTabComponent(var1);
         super.remove(var1);
         if (this.notifyTabbedPane && var2 != -1) {
            BasicTabbedPaneUI.this.tabPane.setTabComponentAt(var2, (Component)null);
         }
      ...
      private void removeUnusedTabComponents() {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            ...
            if (!(var4 instanceof UIResource)) {
               int var5 = BasicTabbedPaneUI.this.tabPane.indexOfTabComponent(var4);
               if (var5 == -1) {
                  super.remove(var4);
               }
            }
   ...
   public class FocusHandler extends FocusAdapter {
      public void focusGained(FocusEvent var1) {
         BasicTabbedPaneUI.this.getHandler().focusGained(var1);
      }

      public void focusLost(FocusEvent var1) {
         BasicTabbedPaneUI.this.getHandler().focusLost(var1);
      }
   }

   public class MouseHandler extends MouseAdapter {
      public void mousePressed(MouseEvent var1) {
         BasicTabbedPaneUI.this.getHandler().mousePressed(var1);
      }
   }

   public class TabSelectionHandler implements ChangeListener {
      public void stateChanged(ChangeEvent var1) {
         BasicTabbedPaneUI.this.getHandler().stateChanged(var1);
      }
   }

   public class PropertyChangeHandler implements PropertyChangeListener {
      public void propertyChange(PropertyChangeEvent var1) {
         BasicTabbedPaneUI.this.getHandler().propertyChange(var1);
      }
   }
   ...
   private class Handler implements ChangeListener, ContainerListener, FocusListener, MouseListener, MouseMotionListener, PropertyChangeListener {
      ...
      public void propertyChange(PropertyChangeEvent var1) {
         ...
         boolean var4 = BasicTabbedPaneUI.this.scrollableTabLayoutEnabled();
         if (var3 == "mnemonicAt") {
            ...
            if (BasicTabbedPaneUI.this.htmlViews != null) {
               BasicTabbedPaneUI.this.htmlViews.removeElementAt(var5);
            }

            this.updateHtmlViews(var5);
         } else if (var3 == "tabLayoutPolicy") {
            BasicTabbedPaneUI.this.uninstallUI(var2);
            BasicTabbedPaneUI.this.installUI(var2);
            BasicTabbedPaneUI.this.calculatedBaseline = false;
            ...
            boolean var9 = (Boolean)var1.getNewValue();
            BasicTabbedPaneUI.this.tabScroller.tabPanel.setOpaque(var9);
            BasicTabbedPaneUI.this.tabScroller.viewport.setOpaque(var9);
         } else if (var3 == "background" && var4) {
            Color var8 = (Color)var1.getNewValue();
            BasicTabbedPaneUI.this.tabScroller.tabPanel.setBackground(var8);
            BasicTabbedPaneUI.this.tabScroller.viewport.setBackground(var8);
            Color var6 = BasicTabbedPaneUI.this.selectedColor == null ? var8 : BasicTabbedPaneUI.this.selectedColor;
            BasicTabbedPaneUI.this.tabScroller.scrollForwardButton.setBackground(var6);
            BasicTabbedPaneUI.this.tabScroller.scrollBackwardButton.setBackground(var6);
            ...
            Component var7 = BasicTabbedPaneUI.this.tabPane.getTabComponentAt((Integer)var1.getNewValue());
            if (var7 != null) {
               if (BasicTabbedPaneUI.this.tabContainer == null) {
                  BasicTabbedPaneUI.this.installTabContainer();
               } else {
                  BasicTabbedPaneUI.this.tabContainer.add(var7);
               }
            }
      ...
      private void updateHtmlViews(int var1) {
         String var2 = BasicTabbedPaneUI.this.tabPane.getTitleAt(var1);
         boolean var3 = BasicHTML.isHTMLString(var2);
         if (var3) {
            if (BasicTabbedPaneUI.this.htmlViews == null) {
               BasicTabbedPaneUI.this.htmlViews = BasicTabbedPaneUI.this.createHTMLVector();
            } else {
               View var4 = BasicHTML.createHTMLView(BasicTabbedPaneUI.this.tabPane, var2);
               BasicTabbedPaneUI.this.htmlViews.insertElementAt(var4, var1);
            }
         } else if (BasicTabbedPaneUI.this.htmlViews != null) {
            BasicTabbedPaneUI.this.htmlViews.insertElementAt((Object)null, var1);
         }
      ...
      public void stateChanged(ChangeEvent var1) {
         ...
         var2.revalidate();
         var2.repaint();
         BasicTabbedPaneUI.this.setFocusIndex(var2.getSelectedIndex(), false);
         if (BasicTabbedPaneUI.this.scrollableTabLayoutEnabled()) {
            BasicTabbedPaneUI.this.ensureCurrentLayout();
            int var3 = var2.getSelectedIndex();
            if (var3 < BasicTabbedPaneUI.this.rects.length && var3 != -1) {
               BasicTabbedPaneUI.this.tabScroller.tabPanel.scrollRectToVisible((Rectangle)BasicTabbedPaneUI.this.rects[var3].clone());
            }
         }
      ...
      public void mouseEntered(MouseEvent var1) {
         BasicTabbedPaneUI.this.setRolloverTab(var1.getX(), var1.getY());
      }
      ...
      public void mousePressed(MouseEvent var1) {
         if (BasicTabbedPaneUI.this.tabPane.isEnabled()) {
            int var2 = BasicTabbedPaneUI.this.tabForCoordinate(BasicTabbedPaneUI.this.tabPane, var1.getX(), var1.getY());
            if (var2 >= 0 && BasicTabbedPaneUI.this.tabPane.isEnabledAt(var2)) {
               if (var2 != BasicTabbedPaneUI.this.tabPane.getSelectedIndex()) {
                  BasicTabbedPaneUI.this.tabPane.setSelectedIndex(var2);
      ...
      public void componentRemoved(ContainerEvent var1) {
         ...
         if (!(var3 instanceof UIResource)) {
            ...
            if (var4 != null) {
               int var5 = var4;
               if (BasicTabbedPaneUI.this.htmlViews != null && BasicTabbedPaneUI.this.htmlViews.size() > var5) {
                  BasicTabbedPaneUI.this.htmlViews.removeElementAt(var5);
               }
   ...
   private class ScrollableTabPanel extends JPanel implements UIResource {
      public ScrollableTabPanel() {
         ...
         if (var2 == null) {
            var2 = BasicTabbedPaneUI.this.tabPane.getBackground();
         }
      ...
      public void paintComponent(Graphics var1) {
         super.paintComponent(var1);
         BasicTabbedPaneUI.this.paintTabArea(var1, BasicTabbedPaneUI.this.tabPane.getTabPlacement(), BasicTabbedPaneUI.this.tabPane.getSelectedIndex());
         if (BasicTabbedPaneUI.this.tabScroller.croppedEdge.isParamsSet() && BasicTabbedPaneUI.this.tabContainer == null) {
            Rectangle var2 = BasicTabbedPaneUI.this.rects[BasicTabbedPaneUI.this.tabScroller.croppedEdge.getTabIndex()];
            var1.translate(var2.x, var2.y);
            BasicTabbedPaneUI.this.tabScroller.croppedEdge.paintComponent(var1);
            var1.translate(-var2.x, -var2.y);
         }
   ...
   private class ScrollableTabSupport implements ActionListener, ChangeListener {
      public BasicTabbedPaneUI.ScrollableTabViewport viewport = BasicTabbedPaneUI.this.new ScrollableTabViewport();
      public BasicTabbedPaneUI.ScrollableTabPanel tabPanel = BasicTabbedPaneUI.this.new ScrollableTabPanel();
      ...
      void createButtons() {
         ...
         int var1 = BasicTabbedPaneUI.this.tabPane.getTabPlacement();
         if (var1 != 1 && var1 != 3) {
      ...
      private void updateView() {
         int var1 = BasicTabbedPaneUI.this.tabPane.getTabPlacement();
         int var2 = BasicTabbedPaneUI.this.tabPane.getTabCount();
         BasicTabbedPaneUI.this.assureRectsCreated(var2);
         Rectangle var3 = this.viewport.getBounds();
         Dimension var4 = this.viewport.getViewSize();
         Rectangle var5 = this.viewport.getViewRect();
         this.leadingTabIndex = BasicTabbedPaneUI.this.getClosestTab(var5.x, var5.y);
         if (this.leadingTabIndex + 1 < var2) {
            switch(var1) {
            case 1:
            case 3:
               if (BasicTabbedPaneUI.this.rects[this.leadingTabIndex].x < var5.x) {
                  ++this.leadingTabIndex;
               }
               break;
            case 2:
            case 4:
               if (BasicTabbedPaneUI.this.rects[this.leadingTabIndex].y < var5.y) {
                  ++this.leadingTabIndex;
               }
            }
         }

         Insets var6 = BasicTabbedPaneUI.this.getContentBorderInsets(var1);
         switch(var1) {
         case 1:
         default:
            BasicTabbedPaneUI.this.tabPane.repaint(var3.x, var3.y + var3.height, var3.width, var6.top);
            ...
            break;
         case 2:
            BasicTabbedPaneUI.this.tabPane.repaint(var3.x + var3.width, var3.y, var6.left, var3.height);
            ...
            break;
         case 3:
            BasicTabbedPaneUI.this.tabPane.repaint(var3.x, var3.y - var6.bottom, var3.width, var6.bottom);
            this.scrollBackwardButton.setEnabled(var5.x > 0 && this.leadingTabIndex > 0);
            this.scrollForwardButton.setEnabled(this.leadingTabIndex < var2 - 1 && var4.width - var5.x > var5.width);
            break;
         case 4:
            BasicTabbedPaneUI.this.tabPane.repaint(var3.x - var6.right, var3.y, var6.right, var3.height);
            this.scrollBackwardButton.setEnabled(var5.y > 0 && this.leadingTabIndex > 0);
            this.scrollForwardButton.setEnabled(this.leadingTabIndex < var2 - 1 && var4.height - var5.y > var5.height);
         }
      ...
      public void actionPerformed(ActionEvent var1) {
         ActionMap var2 = BasicTabbedPaneUI.this.tabPane.getActionMap();
         if (var2 != null) {
            String var3;
            ...
            if (var4 != null && var4.isEnabled()) {
               var4.actionPerformed(new ActionEvent(BasicTabbedPaneUI.this.tabPane, 1001, (String)null, var1.getWhen(), var1.getModifiers()));
            }
         }
   ...
   private class TabbedPaneScrollLayout extends BasicTabbedPaneUI.TabbedPaneLayout {
      ...
      protected int preferredTabAreaHeight(int var1, int var2) {
         return BasicTabbedPaneUI.this.calculateMaxTabHeight(var1);
      }

      protected int preferredTabAreaWidth(int var1, int var2) {
         return BasicTabbedPaneUI.this.calculateMaxTabWidth(var1);
      }

      public void layoutContainer(Container var1) {
         BasicTabbedPaneUI.this.setRolloverTab(-1);
         int var2 = BasicTabbedPaneUI.this.tabPane.getTabPlacement();
         int var3 = BasicTabbedPaneUI.this.tabPane.getTabCount();
         Insets var4 = BasicTabbedPaneUI.this.tabPane.getInsets();
         int var5 = BasicTabbedPaneUI.this.tabPane.getSelectedIndex();
         Component var6 = BasicTabbedPaneUI.this.getVisibleComponent();
         this.calculateLayoutInfo();
         Component var7 = null;
         if (var5 < 0) {
            if (var6 != null) {
               BasicTabbedPaneUI.this.setVisibleComponent((Component)null);
            }
         } else {
            var7 = BasicTabbedPaneUI.this.tabPane.getComponentAt(var5);
         }
         ...
         if (BasicTabbedPaneUI.this.tabPane.getTabCount() == 0) {
            ...
            if (var7 != null) {
               ...
               BasicTabbedPaneUI.this.setVisibleComponent(var7);
            }

            Insets var17 = BasicTabbedPaneUI.this.getContentBorderInsets(var2);
            Rectangle var18 = BasicTabbedPaneUI.this.tabPane.getBounds();
            int var19 = BasicTabbedPaneUI.this.tabPane.getComponentCount();
            if (var19 > 0) {
               int var9;
               int var10;
               int var11;
               ...
               default:
                  ...
                  var12 = BasicTabbedPaneUI.this.calculateTabAreaHeight(var2, BasicTabbedPaneUI.this.runCount, BasicTabbedPaneUI.this.maxTabHeight);
                  var9 = var4.left;
                  var10 = var4.top;
                  ...
                  break;
               case 2:
                  var11 = BasicTabbedPaneUI.this.calculateTabAreaWidth(var2, BasicTabbedPaneUI.this.runCount, BasicTabbedPaneUI.this.maxTabWidth);
               ...
               for(int var20 = 0; var20 < var19; ++var20) {
                  Component var21 = BasicTabbedPaneUI.this.tabPane.getComponent(var20);
                  int var24;
                  int var25;
                  int var27;
                  if (BasicTabbedPaneUI.this.tabScroller != null && var21 == BasicTabbedPaneUI.this.tabScroller.viewport) {
                     JViewport var22 = (JViewport)var21;
                     Rectangle var31 = var22.getViewRect();
                     var24 = var11;
                     var25 = var12;
                     Dimension var32 = BasicTabbedPaneUI.this.tabScroller.scrollForwardButton.getPreferredSize();
                     switch(var2) {
                     case 1:
                     case 3:
                     default:
                        int var33 = BasicTabbedPaneUI.this.rects[var3 - 1].x + BasicTabbedPaneUI.this.rects[var3 - 1].width;
                        if (var33 > var11) {
                     ...
                     case 2:
                     case 4:
                        var27 = BasicTabbedPaneUI.this.rects[var3 - 1].y + BasicTabbedPaneUI.this.rects[var3 - 1].height;
                        if (var27 > var12) {
                  ...
                  } else if (BasicTabbedPaneUI.this.tabScroller == null || var21 != BasicTabbedPaneUI.this.tabScroller.scrollForwardButton && var21 != BasicTabbedPaneUI.this.tabScroller.scrollBackwardButton) {
                     ...
                     case 3:
                     default:
                        int var30 = BasicTabbedPaneUI.this.rects[var3 - 1].x + BasicTabbedPaneUI.this.rects[var3 - 1].width;
                        if (var30 > var11) {
                           var28 = true;
                           var24 = var21 == BasicTabbedPaneUI.this.tabScroller.scrollForwardButton ? var18.width - var4.left - var23.width : var18.width - var4.left - 2 * var23.width;
                           var25 = var2 == 1 ? var10 + var12 - var23.height : var10;
                        }
                        break;
                     case 2:
                     case 4:
                        int var29 = BasicTabbedPaneUI.this.rects[var3 - 1].y + BasicTabbedPaneUI.this.rects[var3 - 1].height;
                        if (var29 > var12) {
                           var28 = true;
                           var24 = var2 == 2 ? var9 + var11 - var23.width : var9;
                           var25 = var21 == BasicTabbedPaneUI.this.tabScroller.scrollForwardButton ? var18.height - var4.bottom - var23.height : var18.height - var4.bottom - 2 * var23.height;
                        }
                     }
               ...
               if (var8 && !BasicTabbedPaneUI.this.requestFocusForVisibleComponent()) {
                  BasicTabbedPaneUI.this.tabPane.requestFocus();
               }
            }
      ...
      private void layoutCroppedEdge() {
         BasicTabbedPaneUI.this.tabScroller.croppedEdge.resetParams();
         Rectangle var1 = BasicTabbedPaneUI.this.tabScroller.viewport.getViewRect();

         for(int var3 = 0; var3 < BasicTabbedPaneUI.this.rects.length; ++var3) {
            Rectangle var4 = BasicTabbedPaneUI.this.rects[var3];
            int var2;
            ...
            default:
               ...
               if (var4.x < var2 - 1 && var4.x + var4.width > var2) {
                  ...
                  BasicTabbedPaneUI.this.tabScroller.croppedEdge.setParams(var3, var10002, 0, -BasicTabbedPaneUI.this.currentTabAreaInsets.top);
               }
               break;
            case 2:
            case 4:
               ...
               if (var4.y < var2 && var4.y + var4.height > var2) {
                  BasicTabbedPaneUI.this.tabScroller.croppedEdge.setParams(var3, var2 - var4.y - 1, -BasicTabbedPaneUI.this.currentTabAreaInsets.left, 0);
               }
            }
         }
      ...
      protected void calculateTabRects(int var1, int var2) {
         FontMetrics var3 = BasicTabbedPaneUI.this.getFontMetrics();
         Dimension var4 = BasicTabbedPaneUI.this.tabPane.getSize();
         Insets var5 = BasicTabbedPaneUI.this.tabPane.getInsets();
         Insets var6 = BasicTabbedPaneUI.this.getTabAreaInsets(var1);
         int var7 = var3.getHeight();
         int var8 = BasicTabbedPaneUI.this.tabPane.getSelectedIndex();
         boolean var10 = var1 == 2 || var1 == 4;
         boolean var11 = BasicGraphicsUtils.isLeftToRight(BasicTabbedPaneUI.this.tabPane);
         int var12 = var6.left;
         int var13 = var6.top;
         int var14 = 0;
         int var15 = 0;
         ...
         case 3:
         default:
            BasicTabbedPaneUI.this.maxTabHeight = BasicTabbedPaneUI.this.calculateMaxTabHeight(var1);
            break;
         case 2:
         case 4:
            BasicTabbedPaneUI.this.maxTabWidth = BasicTabbedPaneUI.this.calculateMaxTabWidth(var1);
         }
         ...
         if (var2 != 0) {
            ...
            for(var9 = 0; var9 < var2; ++var9) {
               Rectangle var16 = BasicTabbedPaneUI.this.rects[var9];
               if (!var10) {
                  if (var9 > 0) {
                     var16.x = BasicTabbedPaneUI.this.rects[var9 - 1].x + BasicTabbedPaneUI.this.rects[var9 - 1].width;
                  } else {
                     BasicTabbedPaneUI.this.tabRuns[0] = 0;
                     BasicTabbedPaneUI.this.maxTabWidth = 0;
                     var15 += BasicTabbedPaneUI.this.maxTabHeight;
                     var16.x = var12;
                  }

                  var16.width = BasicTabbedPaneUI.this.calculateTabWidth(var1, var9, var3);
                  var14 = var16.x + var16.width;
                  BasicTabbedPaneUI.this.maxTabWidth = Math.max(BasicTabbedPaneUI.this.maxTabWidth, var16.width);
                  var16.y = var13;
                  var16.height = BasicTabbedPaneUI.this.maxTabHeight;
               } else {
                  if (var9 > 0) {
                     var16.y = BasicTabbedPaneUI.this.rects[var9 - 1].y + BasicTabbedPaneUI.this.rects[var9 - 1].height;
                  } else {
                     BasicTabbedPaneUI.this.tabRuns[0] = 0;
                     BasicTabbedPaneUI.this.maxTabHeight = 0;
                     var14 = BasicTabbedPaneUI.this.maxTabWidth;
                     var16.y = var13;
                  }

                  var16.height = BasicTabbedPaneUI.this.calculateTabHeight(var1, var9, var7);
                  var15 = var16.y + var16.height;
                  BasicTabbedPaneUI.this.maxTabHeight = Math.max(BasicTabbedPaneUI.this.maxTabHeight, var16.height);
                  var16.x = var12;
                  var16.width = BasicTabbedPaneUI.this.maxTabWidth;
               }
            }
            ...
            if (!var11 && !var10) {
               ...
               for(var9 = 0; var9 < var2; ++var9) {
                  BasicTabbedPaneUI.this.rects[var9].x = var17 - BasicTabbedPaneUI.this.rects[var9].x - BasicTabbedPaneUI.this.rects[var9].width;
               }
            }

            BasicTabbedPaneUI.this.tabScroller.tabPanel.setPreferredSize(new Dimension(var14, var15));
            BasicTabbedPaneUI.this.tabScroller.tabPanel.invalidate();
         }
      }

      // $FF: synthetic method
      TabbedPaneScrollLayout(Object var2) {
         this();
      }
   }
   ...
   public class TabbedPaneLayout implements LayoutManager {
      ...
      protected Dimension calculateSize(boolean var1) {
         int var2 = BasicTabbedPaneUI.this.tabPane.getTabPlacement();
         Insets var3 = BasicTabbedPaneUI.this.tabPane.getInsets();
         Insets var4 = BasicTabbedPaneUI.this.getContentBorderInsets(var2);
         Insets var5 = BasicTabbedPaneUI.this.getTabAreaInsets(var2);
         new Dimension(0, 0);
         byte var7 = 0;
         byte var8 = 0;
         int var9 = 0;
         ...
         int var11;
         for(var11 = 0; var11 < BasicTabbedPaneUI.this.tabPane.getTabCount(); ++var11) {
            Component var12 = BasicTabbedPaneUI.this.tabPane.getComponentAt(var11);
            if (var12 != null) {
         ...
         case 3:
         default:
            var15 = Math.max(var15, BasicTabbedPaneUI.this.calculateMaxTabWidth(var2));
            var11 = this.preferredTabAreaHeight(var2, var15 - var5.left - var5.right);
            var14 += var11;
            break;
         case 2:
         case 4:
            var14 = Math.max(var14, BasicTabbedPaneUI.this.calculateMaxTabHeight(var2));
      ...
      protected int preferredTabAreaHeight(int var1, int var2) {
         FontMetrics var3 = BasicTabbedPaneUI.this.getFontMetrics();
         int var4 = BasicTabbedPaneUI.this.tabPane.getTabCount();
         int var5 = 0;
         if (var4 > 0) {
            int var6 = 1;
            int var7 = 0;
            int var8 = BasicTabbedPaneUI.this.calculateMaxTabHeight(var1);

            for(int var9 = 0; var9 < var4; ++var9) {
               int var10 = BasicTabbedPaneUI.this.calculateTabWidth(var1, var9, var3);
            ...
            var5 = BasicTabbedPaneUI.this.calculateTabAreaHeight(var1, var6, var8);
         }
      ...
      protected int preferredTabAreaWidth(int var1, int var2) {
         ...
         if (var4 > 0) {
            ...
            for(int var9 = 0; var9 < var4; ++var9) {
               int var10 = BasicTabbedPaneUI.this.calculateTabHeight(var1, var9, var8);
               if (var7 != 0 && var7 + var10 > var2) {
                  ++var6;
                  var7 = 0;
               }
            ...
            var5 = BasicTabbedPaneUI.this.calculateTabAreaWidth(var1, var6, BasicTabbedPaneUI.this.maxTabWidth);
         }
      ...
      public void layoutContainer(Container var1) {
         ...
         int var2 = BasicTabbedPaneUI.this.tabPane.getTabPlacement();
         Insets var3 = BasicTabbedPaneUI.this.tabPane.getInsets();
         int var4 = BasicTabbedPaneUI.this.tabPane.getSelectedIndex();
         Component var5 = BasicTabbedPaneUI.this.getVisibleComponent();
         this.calculateLayoutInfo();
         Component var6 = null;
         if (var4 < 0) {
            if (var5 != null) {
            ...
            var6 = BasicTabbedPaneUI.this.tabPane.getComponentAt(var4);
         }

         int var11 = 0;
         int var12 = 0;
         Insets var13 = BasicTabbedPaneUI.this.getContentBorderInsets(var2);
         boolean var14 = false;
         if (var6 != null) {
            ...
            BasicTabbedPaneUI.this.setVisibleComponent(var6);
         }

         Rectangle var15 = BasicTabbedPaneUI.this.tabPane.getBounds();
         int var16 = BasicTabbedPaneUI.this.tabPane.getComponentCount();
         if (var16 > 0) {
            int var7;
            int var8;
            switch(var2) {
            ...
            for(int var17 = 0; var17 < var16; ++var17) {
               Component var18 = BasicTabbedPaneUI.this.tabPane.getComponent(var17);
               if (var18 == BasicTabbedPaneUI.this.tabContainer) {
         ...
         if (var14 && !BasicTabbedPaneUI.this.requestFocusForVisibleComponent()) {
            BasicTabbedPaneUI.this.tabPane.requestFocus();
         }
      ...
      public void calculateLayoutInfo() {
         int var1 = BasicTabbedPaneUI.this.tabPane.getTabCount();
         BasicTabbedPaneUI.this.assureRectsCreated(var1);
         this.calculateTabRects(BasicTabbedPaneUI.this.tabPane.getTabPlacement(), var1);
      ...
      private void layoutTabComponents() {
         if (BasicTabbedPaneUI.this.tabContainer != null) {
            ...
            Point var2 = new Point(-BasicTabbedPaneUI.this.tabContainer.getX(), -BasicTabbedPaneUI.this.tabContainer.getY());
            if (BasicTabbedPaneUI.this.scrollableTabLayoutEnabled()) {
               BasicTabbedPaneUI.this.translatePointToTabPanel(0, 0, var2);
            }

            for(int var3 = 0; var3 < BasicTabbedPaneUI.this.tabPane.getTabCount(); ++var3) {
               Component var4 = BasicTabbedPaneUI.this.tabPane.getTabComponentAt(var3);
               if (var4 != null) {
                  BasicTabbedPaneUI.this.getTabBounds(var3, var1);
                  Dimension var5 = var4.getPreferredSize();
                  Insets var6 = BasicTabbedPaneUI.this.getTabInsets(BasicTabbedPaneUI.this.tabPane.getTabPlacement(), var3);
                  ...
                  int var13 = BasicTabbedPaneUI.this.tabPane.getTabPlacement();
                  boolean var14 = var3 == BasicTabbedPaneUI.this.tabPane.getSelectedIndex();
                  var4.setBounds(var11 + BasicTabbedPaneUI.this.getTabLabelShiftX(var13, var3, var14), var12 + BasicTabbedPaneUI.this.getTabLabelShiftY(var13, var3, var14), var5.width, var5.height);
               }
            }
      ...
      protected void calculateTabRects(int var1, int var2) {
         ...
         boolean var16 = BasicGraphicsUtils.isLeftToRight(BasicTabbedPaneUI.this.tabPane);
         int var12;
         int var13;
         int var14;
         switch(var1) {
         ...
         case 3:
            BasicTabbedPaneUI.this.maxTabHeight = BasicTabbedPaneUI.this.calculateMaxTabHeight(var1);
            var12 = var5.left + var6.left;
            var13 = var4.height - var5.bottom - var6.bottom - BasicTabbedPaneUI.this.maxTabHeight;
            var14 = var4.width - (var5.right + var6.right);
            break;
         case 4:
            BasicTabbedPaneUI.this.maxTabWidth = BasicTabbedPaneUI.this.calculateMaxTabWidth(var1);
            var12 = var4.width - var5.right - var6.right - BasicTabbedPaneUI.this.maxTabWidth;
            var13 = var5.top + var6.top;
            var14 = var4.height - (var5.bottom + var6.bottom);
         }

         int var9 = BasicTabbedPaneUI.this.getTabRunOverlay(var1);
         BasicTabbedPaneUI.this.runCount = 0;
         BasicTabbedPaneUI.this.selectedRun = -1;
         if (var2 != 0) {
            int var10;
            ...
            for(var10 = 0; var10 < var2; ++var10) {
               var17 = BasicTabbedPaneUI.this.rects[var10];
               if (!var15) {
                  if (var10 > 0) {
                     var17.x = BasicTabbedPaneUI.this.rects[var10 - 1].x + BasicTabbedPaneUI.this.rects[var10 - 1].width;
                  } else {
                     BasicTabbedPaneUI.this.tabRuns[0] = 0;
                     BasicTabbedPaneUI.this.runCount = 1;
                     BasicTabbedPaneUI.this.maxTabWidth = 0;
                  ...
                  var17.width = BasicTabbedPaneUI.this.calculateTabWidth(var1, var10, var3);
                  BasicTabbedPaneUI.this.maxTabWidth = Math.max(BasicTabbedPaneUI.this.maxTabWidth, var17.width);
                  if (var17.x != var12 && var17.x + var17.width > var14) {
                     if (BasicTabbedPaneUI.this.runCount > BasicTabbedPaneUI.this.tabRuns.length - 1) {
                        BasicTabbedPaneUI.this.expandTabRunsArray();
                     }

                     BasicTabbedPaneUI.this.tabRuns[BasicTabbedPaneUI.this.runCount] = var10;
                     ++BasicTabbedPaneUI.this.runCount;
                     var17.x = var12;
                  }

                  var17.y = var13;
                  var17.height = BasicTabbedPaneUI.this.maxTabHeight;
               } else {
                  if (var10 > 0) {
                     var17.y = BasicTabbedPaneUI.this.rects[var10 - 1].y + BasicTabbedPaneUI.this.rects[var10 - 1].height;
                  } else {
                     BasicTabbedPaneUI.this.tabRuns[0] = 0;
                     BasicTabbedPaneUI.this.runCount = 1;
                     BasicTabbedPaneUI.this.maxTabHeight = 0;
                  ...
                  var17.height = BasicTabbedPaneUI.this.calculateTabHeight(var1, var10, var7);
                  BasicTabbedPaneUI.this.maxTabHeight = Math.max(BasicTabbedPaneUI.this.maxTabHeight, var17.height);
                  if (var17.y != var13 && var17.y + var17.height > var14) {
                     if (BasicTabbedPaneUI.this.runCount > BasicTabbedPaneUI.this.tabRuns.length - 1) {
                        BasicTabbedPaneUI.this.expandTabRunsArray();
                     }
                  ...
                  var17.x = var12;
                  var17.width = BasicTabbedPaneUI.this.maxTabWidth;
               }
            ...
            if (BasicTabbedPaneUI.this.runCount > 1) {
               ...
               BasicTabbedPaneUI.this.selectedRun = BasicTabbedPaneUI.this.getRunForTab(var2, var8);
               if (BasicTabbedPaneUI.this.shouldRotateTabRuns(var1)) {
                  this.rotateTabRuns(var1, BasicTabbedPaneUI.this.selectedRun);
               }
            }

            int var18;
            for(var10 = BasicTabbedPaneUI.this.runCount - 1; var10 >= 0; --var10) {
               var18 = BasicTabbedPaneUI.this.tabRuns[var10];
               int var19 = BasicTabbedPaneUI.this.tabRuns[var10 == BasicTabbedPaneUI.this.runCount - 1 ? 0 : var10 + 1];
               int var20 = var19 != 0 ? var19 - 1 : var2 - 1;
               int var11;
               if (!var15) {
                  for(var11 = var18; var11 <= var20; ++var11) {
                     var17 = BasicTabbedPaneUI.this.rects[var11];
                     var17.y = var13;
                     var17.x += BasicTabbedPaneUI.this.getTabRunIndent(var1, var10);
                  }

                  if (BasicTabbedPaneUI.this.shouldPadTabRun(var1, var10)) {
                     this.padTabRun(var1, var18, var20, var14);
                  }

                  if (var1 == 3) {
                     var13 -= BasicTabbedPaneUI.this.maxTabHeight - var9;
                  } else {
                     var13 += BasicTabbedPaneUI.this.maxTabHeight - var9;
                  }
               } else {
                  for(var11 = var18; var11 <= var20; ++var11) {
                     var17 = BasicTabbedPaneUI.this.rects[var11];
                     var17.x = var12;
                     var17.y += BasicTabbedPaneUI.this.getTabRunIndent(var1, var10);
                  }
                  ...
                  if (var1 == 4) {
                     var12 -= BasicTabbedPaneUI.this.maxTabWidth - var9;
                  } else {
                     var12 += BasicTabbedPaneUI.this.maxTabWidth - var9;
                  }
               }
            ...
            if (!var16 && !var15) {
               ...
               for(var10 = 0; var10 < var2; ++var10) {
                  BasicTabbedPaneUI.this.rects[var10].x = var18 - BasicTabbedPaneUI.this.rects[var10].x - BasicTabbedPaneUI.this.rects[var10].width;
               }
            }
      ...
      protected void rotateTabRuns(int var1, int var2) {
         for(int var3 = 0; var3 < var2; ++var3) {
            int var4 = BasicTabbedPaneUI.this.tabRuns[0];

            for(int var5 = 1; var5 < BasicTabbedPaneUI.this.runCount; ++var5) {
               BasicTabbedPaneUI.this.tabRuns[var5 - 1] = BasicTabbedPaneUI.this.tabRuns[var5];
            }

            BasicTabbedPaneUI.this.tabRuns[BasicTabbedPaneUI.this.runCount - 1] = var4;
         }
      ...
      protected void normalizeTabRuns(int var1, int var2, int var3, int var4) {
         ...
         int var6 = BasicTabbedPaneUI.this.runCount - 1;
         boolean var7 = true;
         double var8 = 1.25D;

         while(var7) {
            int var10 = BasicTabbedPaneUI.this.lastTabInRun(var2, var6);
            int var11 = BasicTabbedPaneUI.this.lastTabInRun(var2, var6 - 1);
            int var12;
            int var13;
            if (!var5) {
               var12 = BasicTabbedPaneUI.this.rects[var10].x + BasicTabbedPaneUI.this.rects[var10].width;
               var13 = (int)((double)BasicTabbedPaneUI.this.maxTabWidth * var8);
            } else {
               var12 = BasicTabbedPaneUI.this.rects[var10].y + BasicTabbedPaneUI.this.rects[var10].height;
               var13 = (int)((double)BasicTabbedPaneUI.this.maxTabHeight * var8 * 2.0D);
            }

            if (var4 - var12 > var13) {
               BasicTabbedPaneUI.this.tabRuns[var6] = var11;
               if (!var5) {
                  BasicTabbedPaneUI.this.rects[var11].x = var3;
               } else {
                  BasicTabbedPaneUI.this.rects[var11].y = var3;
               }

               for(int var14 = var11 + 1; var14 <= var10; ++var14) {
                  if (!var5) {
                     BasicTabbedPaneUI.this.rects[var14].x = BasicTabbedPaneUI.this.rects[var14 - 1].x + BasicTabbedPaneUI.this.rects[var14 - 1].width;
                  } else {
                     BasicTabbedPaneUI.this.rects[var14].y = BasicTabbedPaneUI.this.rects[var14 - 1].y + BasicTabbedPaneUI.this.rects[var14 - 1].height;
                  }
               }
            } else if (var6 == BasicTabbedPaneUI.this.runCount - 1) {
               var7 = false;
            }
            ...
            if (var6 - 1 > 0) {
               ...
               var6 = BasicTabbedPaneUI.this.runCount - 1;
               var8 += 0.25D;
            }
         }
      ...
      protected void padTabRun(int var1, int var2, int var3, int var4) {
         Rectangle var5 = BasicTabbedPaneUI.this.rects[var3];
         int var6;
         int var7;
         float var8;
         int var9;
         Rectangle var10;
         if (var1 != 1 && var1 != 3) {
            var6 = var5.y + var5.height - BasicTabbedPaneUI.this.rects[var2].y;
            var7 = var4 - (var5.y + var5.height);
            var8 = (float)var7 / (float)var6;

            for(var9 = var2; var9 <= var3; ++var9) {
               var10 = BasicTabbedPaneUI.this.rects[var9];
               if (var9 > var2) {
                  var10.y = BasicTabbedPaneUI.this.rects[var9 - 1].y + BasicTabbedPaneUI.this.rects[var9 - 1].height;
               }
            ...
            var6 = var5.x + var5.width - BasicTabbedPaneUI.this.rects[var2].x;
            ...
            for(var9 = var2; var9 <= var3; ++var9) {
               var10 = BasicTabbedPaneUI.this.rects[var9];
               if (var9 > var2) {
                  var10.x = BasicTabbedPaneUI.this.rects[var9 - 1].x + BasicTabbedPaneUI.this.rects[var9 - 1].width;
               }
      ...
      protected void padSelectedTab(int var1, int var2) {
         if (var2 >= 0) {
            Rectangle var3 = BasicTabbedPaneUI.this.rects[var2];
            Insets var4 = BasicTabbedPaneUI.this.getSelectedTabPadInsets(var1);
            var3.x -= var4.left;
            var3.width += var4.left + var4.right;
            var3.y -= var4.top;
            var3.height += var4.top + var4.bottom;
            if (!BasicTabbedPaneUI.this.scrollableTabLayoutEnabled()) {
               Dimension var5 = BasicTabbedPaneUI.this.tabPane.getSize();
               Insets var6 = BasicTabbedPaneUI.this.tabPane.getInsets();
               int var7;
               int var8;
               if (var1 != 2 && var1 != 4) {
   ...
   private static class Actions extends UIAction {
      ...
      public void actionPerformed(ActionEvent var1) {
         ...
         BasicTabbedPaneUI var4 = (BasicTabbedPaneUI)BasicLookAndFeel.getUIOfType(var3.getUI(), BasicTabbedPaneUI.class);
         if (var4 != null) {
            if (var2 == "navigateNext") {
               ...
               if (var2 == "navigatePageUp") {
                  ...
                  if (var8 != null && var8.length() > 0) {
                     ...
                     Integer var7 = (Integer)var4.mnemonicToIndexMap.get(var6);
