...
final class TextAreaPainter extends AbstractRegionPainter {
   ...
   public TextAreaPainter(AbstractRegionPainter.PaintContext var1, int var2) {
      this.state = var2;
      this.ctx = var1;
   }
   ...
   protected void doPaint(Graphics2D var1, JComponent var2, int var3, int var4, Object[] var5) {
      ...
      case 2:
         ...
         break;
      case 3:
         this.paintBackgroundDisabledAndNotInScrollPane(var1);
         break;
      case 4:
         this.paintBackgroundEnabledAndNotInScrollPane(var1);
         break;
      case 5:
         this.paintBackgroundSelected(var1);
         break;
      case 6:
         this.paintBorderDisabledAndNotInScrollPane(var1);
         break;
      case 7:
         this.paintBorderFocusedAndNotInScrollPane(var1);
         break;
      case 8:
         this.paintBorderEnabledAndNotInScrollPane(var1);
      }
   ...
   private void paintBackgroundDisabledAndNotInScrollPane(Graphics2D var1) {
      this.rect = this.decodeRect2();
      var1.setPaint(this.color1);
      var1.fill(this.rect);
   }

   private void paintBackgroundEnabledAndNotInScrollPane(Graphics2D var1) {
      this.rect = this.decodeRect2();
      var1.setPaint((Color)this.componentColors[0]);
      var1.fill(this.rect);
   }
   ...
   private void paintBorderDisabledAndNotInScrollPane(Graphics2D var1) {
   ...
   private void paintBorderFocusedAndNotInScrollPane(Graphics2D var1) {
   ...
   private void paintBorderEnabledAndNotInScrollPane(Graphics2D var1) {
      this.rect = this.decodeRect8();
