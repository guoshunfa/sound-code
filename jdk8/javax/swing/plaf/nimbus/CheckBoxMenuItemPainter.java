...
final class CheckBoxMenuItemPainter extends AbstractRegionPainter {
   ...
   private Color color3 = this.decodeColor("nimbusBlueGrey", 0.055555582F, -0.096827686F, -0.45882353F, 0);
   private Color color4 = this.decodeColor("nimbusBlueGrey", 0.0F, -0.110526316F, 0.25490195F, 0);
   private Object[] componentColors;

   public CheckBoxMenuItemPainter(AbstractRegionPainter.PaintContext var1, int var2) {
      this.state = var2;
      this.ctx = var1;
   }
   ...
   private Path2D decodePath1() {
      this.path.reset();
      this.path.moveTo((double)this.decodeX(0.0F), (double)this.decodeY(1.5F));
      this.path.lineTo((double)this.decodeX(0.4292683F), (double)this.decodeY(1.5F));
      this.path.lineTo((double)this.decodeX(0.7121951F), (double)this.decodeY(2.4780488F));
      this.path.lineTo((double)this.decodeX(2.5926828F), (double)this.decodeY(0.0F));
      ...
      this.path.lineTo((double)this.decodeX(2.8317075F), (double)this.decodeY(0.39512196F));
      this.path.lineTo((double)this.decodeX(0.8F), (double)this.decodeY(3.0F));
      this.path.lineTo((double)this.decodeX(0.5731707F), (double)this.decodeY(3.0F));
      this.path.lineTo((double)this.decodeX(0.0F), (double)this.decodeY(1.5F));
      this.path.closePath();
      return this.path;
   }
}
