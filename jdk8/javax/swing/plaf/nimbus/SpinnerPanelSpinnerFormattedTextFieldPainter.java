...
final class SpinnerPanelSpinnerFormattedTextFieldPainter extends AbstractRegionPainter {
   ...
   private Color color9 = this.decodeColor("nimbusBlueGrey", 0.055555582F, -0.1048766F, -0.08F, 0);
   private Color color10 = this.decodeColor("nimbusBlueGrey", 0.055555582F, -0.105624355F, 0.054901958F, 0);
   private Color color11 = this.decodeColor("nimbusBlueGrey", 0.0F, -0.110526316F, 0.25490195F, 0);
   private Color color12 = this.decodeColor("nimbusBlueGrey", 0.055555582F, -0.105344966F, 0.011764705F, 0);
   private Color color13 = this.decodeColor("nimbusLightBackground", 0.0F, 0.0F, 0.0F, 0);
   private Color color14 = this.decodeColor("nimbusFocus", 0.0F, 0.0F, 0.0F, 0);
   private Color color15 = this.decodeColor("nimbusBlueGrey", 0.055555582F, -0.1048766F, -0.05098039F, 0);
   private Object[] componentColors;

   public SpinnerPanelSpinnerFormattedTextFieldPainter(AbstractRegionPainter.PaintContext var1, int var2) {
      this.state = var2;
      this.ctx = var1;
   }
   ...
   private Rectangle2D decodeRect6() {
      this.rect.setRect((double)this.decodeX(0.22222222F), (double)this.decodeY(0.13333334F), (double)(this.decodeX(2.916668F) - this.decodeX(0.22222222F)), (double)(this.decodeY(2.75F) - this.decodeY(0.13333334F)));
      return this.rect;
   }
   ...
   private Paint decodeGradient4(Shape var1) {
      ...
      float var5 = (float)var2.getWidth();
      float var6 = (float)var2.getHeight();
      return this.decodeGradient(0.5F * var5 + var3, 0.0F * var6 + var4, 0.5F * var5 + var3, 1.0F * var6 + var4, new float[]{0.0F, 0.1684492F, 1.0F}, new Color[]{this.color10, this.decodeColor(this.color10, this.color11, 0.5F), this.color11});
   }
   ...
   private Paint decodeGradient5(Shape var1) {
      ...
      float var5 = (float)var2.getWidth();
      float var6 = (float)var2.getHeight();
      return this.decodeGradient(0.5F * var5 + var3, 0.0F * var6 + var4, 0.5F * var5 + var3, 1.0F * var6 + var4, new float[]{0.0F, 0.49573863F, 0.99147725F}, new Color[]{this.color8, this.decodeColor(this.color8, this.color15, 0.5F), this.color15});
   }
}
