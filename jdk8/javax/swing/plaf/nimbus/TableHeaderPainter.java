...
final class TableHeaderPainter extends AbstractRegionPainter {
   ...
   private Color color1 = this.decodeColor("nimbusBase", 0.0057927966F, -0.21904764F, 0.15686274F, 0);
   private Color color2 = this.decodeColor("nimbusBase", 0.0038565993F, 0.02012986F, 0.054901958F, 0);
   private Object[] componentColors;

   public TableHeaderPainter(AbstractRegionPainter.PaintContext var1, int var2) {
      this.state = var2;
      this.ctx = var1;
   }
   ...
   protected void doPaint(Graphics2D var1, JComponent var2, int var3, int var4, Object[] var5) {
      ...
      switch(this.state) {
      case 1:
         this.paintascendingSortIconEnabled(var1);
         break;
      case 2:
         this.paintdescendingSortIconEnabled(var1);
      }
   ...
   private void paintascendingSortIconEnabled(Graphics2D var1) {
      this.path = this.decodePath1();
      var1.setPaint(this.decodeGradient1(this.path));
      var1.fill(this.path);
   }

   private void paintdescendingSortIconEnabled(Graphics2D var1) {
   ...
   private Path2D decodePath1() {
      ...
      this.path.lineTo((double)this.decodeX(1.7070175F), (double)this.decodeY(0.0F));
      this.path.lineTo((double)this.decodeX(3.0F), (double)this.decodeY(2.0F));
   ...
   private Path2D decodePath2() {
      ...
      this.path.lineTo((double)this.decodeX(1.5025063F), (double)this.decodeY(2.0F));
