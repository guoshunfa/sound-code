...
public class MultiPopupMenuUI extends PopupMenuUI {
   ...
   public boolean isPopupTrigger(MouseEvent var1) {
      boolean var2 = ((PopupMenuUI)((PopupMenuUI)this.uis.elementAt(0))).isPopupTrigger(var1);

      for(int var3 = 1; var3 < this.uis.size(); ++var3) {
         ((PopupMenuUI)((PopupMenuUI)this.uis.elementAt(var3))).isPopupTrigger(var1);
      }
   ...
   public Popup getPopup(JPopupMenu var1, int var2, int var3) {
      Popup var4 = ((PopupMenuUI)((PopupMenuUI)this.uis.elementAt(0))).getPopup(var1, var2, var3);

      for(int var5 = 1; var5 < this.uis.size(); ++var5) {
         ((PopupMenuUI)((PopupMenuUI)this.uis.elementAt(var5))).getPopup(var1, var2, var3);
      }
   ...
   public static ComponentUI createUI(JComponent var0) {
      MultiPopupMenuUI var1 = new MultiPopupMenuUI();
      return MultiLookAndFeel.createUIs(var1, ((MultiPopupMenuUI)var1).uis, var0);
   }
