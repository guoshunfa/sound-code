...
public class MultiTabbedPaneUI extends TabbedPaneUI {
   ...
   public int tabForCoordinate(JTabbedPane var1, int var2, int var3) {
      int var4 = ((TabbedPaneUI)((TabbedPaneUI)this.uis.elementAt(0))).tabForCoordinate(var1, var2, var3);

      for(int var5 = 1; var5 < this.uis.size(); ++var5) {
         ((TabbedPaneUI)((TabbedPaneUI)this.uis.elementAt(var5))).tabForCoordinate(var1, var2, var3);
      }
   ...
   public Rectangle getTabBounds(JTabbedPane var1, int var2) {
      Rectangle var3 = ((TabbedPaneUI)((TabbedPaneUI)this.uis.elementAt(0))).getTabBounds(var1, var2);

      for(int var4 = 1; var4 < this.uis.size(); ++var4) {
         ((TabbedPaneUI)((TabbedPaneUI)this.uis.elementAt(var4))).getTabBounds(var1, var2);
      }
   ...
   public int getTabRunCount(JTabbedPane var1) {
      int var2 = ((TabbedPaneUI)((TabbedPaneUI)this.uis.elementAt(0))).getTabRunCount(var1);

      for(int var3 = 1; var3 < this.uis.size(); ++var3) {
         ((TabbedPaneUI)((TabbedPaneUI)this.uis.elementAt(var3))).getTabRunCount(var1);
      }
   ...
   public static ComponentUI createUI(JComponent var0) {
      MultiTabbedPaneUI var1 = new MultiTabbedPaneUI();
      return MultiLookAndFeel.createUIs(var1, ((MultiTabbedPaneUI)var1).uis, var0);
   }
