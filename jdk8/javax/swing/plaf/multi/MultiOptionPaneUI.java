...
public class MultiOptionPaneUI extends OptionPaneUI {
   ...
   public void selectInitialValue(JOptionPane var1) {
      for(int var2 = 0; var2 < this.uis.size(); ++var2) {
         ((OptionPaneUI)((OptionPaneUI)this.uis.elementAt(var2))).selectInitialValue(var1);
      }

   }

   public boolean containsCustomComponents(JOptionPane var1) {
      boolean var2 = ((OptionPaneUI)((OptionPaneUI)this.uis.elementAt(0))).containsCustomComponents(var1);

      for(int var3 = 1; var3 < this.uis.size(); ++var3) {
         ((OptionPaneUI)((OptionPaneUI)this.uis.elementAt(var3))).containsCustomComponents(var1);
      }
   ...
   public static ComponentUI createUI(JComponent var0) {
      MultiOptionPaneUI var1 = new MultiOptionPaneUI();
      return MultiLookAndFeel.createUIs(var1, ((MultiOptionPaneUI)var1).uis, var0);
   }
