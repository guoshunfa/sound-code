...
public class MultiComboBoxUI extends ComboBoxUI {
   ...
   public boolean isFocusTraversable(JComboBox var1) {
      boolean var2 = ((ComboBoxUI)((ComboBoxUI)this.uis.elementAt(0))).isFocusTraversable(var1);

      for(int var3 = 1; var3 < this.uis.size(); ++var3) {
         ((ComboBoxUI)((ComboBoxUI)this.uis.elementAt(var3))).isFocusTraversable(var1);
      }
   ...
   public void setPopupVisible(JComboBox var1, boolean var2) {
      for(int var3 = 0; var3 < this.uis.size(); ++var3) {
         ((ComboBoxUI)((ComboBoxUI)this.uis.elementAt(var3))).setPopupVisible(var1, var2);
      }

   }

   public boolean isPopupVisible(JComboBox var1) {
      boolean var2 = ((ComboBoxUI)((ComboBoxUI)this.uis.elementAt(0))).isPopupVisible(var1);

      for(int var3 = 1; var3 < this.uis.size(); ++var3) {
         ((ComboBoxUI)((ComboBoxUI)this.uis.elementAt(var3))).isPopupVisible(var1);
      }
   ...
   public static ComponentUI createUI(JComponent var0) {
      MultiComboBoxUI var1 = new MultiComboBoxUI();
      return MultiLookAndFeel.createUIs(var1, ((MultiComboBoxUI)var1).uis, var0);
   }
