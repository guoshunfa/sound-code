...
class FactoryFinder {
   ...
   static <T> T newInstance(Class<T> type, String className, ClassLoader cl, boolean doFallback, boolean useBSClsLoader) throws FactoryConfigurationError {
      ...
      try {
         ...
         throw new FactoryConfigurationError(var7, "Provider " + className + " not found");
      } catch (Exception var8) {
         throw new FactoryConfigurationError(var8, "Provider " + className + " could not be instantiated: " + var8);
      }
   }
