...
class FactoryFinder {
   ...
   static <T> T newInstance(Class<T> type, String className, ClassLoader cl, boolean doFallback) throws TransformerFactoryConfigurationError {
      ...
      if (System.getSecurityManager() != null && className != null && className.startsWith("com.sun.org.apache.xalan.internal.")) {
         cl = null;
         useBSClsLoader = true;
      }
      ...
      try {
         ...
         throw new TransformerFactoryConfigurationError(var7, "Provider " + className + " not found");
      } catch (Exception var8) {
         throw new TransformerFactoryConfigurationError(var8, "Provider " + className + " could not be instantiated: " + var8);
      }
   }
   ...
   static <T> T find(Class<T> type, String fallbackClassName) throws TransformerFactoryConfigurationError {
      ...
      if (provider != null) {
         ...
         throw new TransformerFactoryConfigurationError((Exception)null, "Provider for " + factoryId + " cannot be found");
      } else {
