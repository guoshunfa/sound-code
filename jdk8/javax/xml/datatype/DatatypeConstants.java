...
public final class DatatypeConstants {
   ...
   public static final DatatypeConstants.Field YEARS = new DatatypeConstants.Field("YEARS", 0);
   public static final DatatypeConstants.Field MONTHS = new DatatypeConstants.Field("MONTHS", 1);
   public static final DatatypeConstants.Field DAYS = new DatatypeConstants.Field("DAYS", 2);
   public static final DatatypeConstants.Field HOURS = new DatatypeConstants.Field("HOURS", 3);
   public static final DatatypeConstants.Field MINUTES = new DatatypeConstants.Field("MINUTES", 4);
   public static final DatatypeConstants.Field SECONDS = new DatatypeConstants.Field("SECONDS", 5);
   ...
   public static final class Field {
      ...
      // $FF: synthetic method
      Field(String x0, int x1, Object x2) {
         this(x0, x1);
      }
   }
}
