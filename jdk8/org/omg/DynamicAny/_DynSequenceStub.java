...
public class _DynSequenceStub extends ObjectImpl implements DynSequence {
   ...
   private static String[] __ids = new String[]{"IDL:omg.org/DynamicAny/DynSequence:1.0", "IDL:omg.org/DynamicAny/DynAny:1.0"};

   public int get_length() {
      ServantObject var1 = this._servant_preinvoke("get_length", _opsClass);
      DynSequenceOperations var2 = (DynSequenceOperations)var1.servant;

      int var3;
      try {
         var3 = var2.get_length();
      } finally {
   ...
   public void set_length(int var1) throws InvalidValue {
      ServantObject var2 = this._servant_preinvoke("set_length", _opsClass);
      DynSequenceOperations var3 = (DynSequenceOperations)var2.servant;

      try {
         var3.set_length(var1);
      } finally {
   ...
   public Any[] get_elements() {
      ServantObject var1 = this._servant_preinvoke("get_elements", _opsClass);
      DynSequenceOperations var2 = (DynSequenceOperations)var1.servant;

      Any[] var3;
      try {
         var3 = var2.get_elements();
      } finally {
         this._servant_postinvoke(var1);
      }
   ...
   public void set_elements(Any[] var1) throws TypeMismatch, InvalidValue {
      ServantObject var2 = this._servant_preinvoke("set_elements", _opsClass);
      DynSequenceOperations var3 = (DynSequenceOperations)var2.servant;

      try {
         var3.set_elements(var1);
      } finally {
         this._servant_postinvoke(var2);
      }
   ...
   public DynAny[] get_elements_as_dyn_any() {
      ServantObject var1 = this._servant_preinvoke("get_elements_as_dyn_any", _opsClass);
      DynSequenceOperations var2 = (DynSequenceOperations)var1.servant;

      DynAny[] var3;
      try {
         var3 = var2.get_elements_as_dyn_any();
      } finally {
         this._servant_postinvoke(var1);
      }
   ...
   public void set_elements_as_dyn_any(DynAny[] var1) throws TypeMismatch, InvalidValue {
      ServantObject var2 = this._servant_preinvoke("set_elements_as_dyn_any", _opsClass);
      DynSequenceOperations var3 = (DynSequenceOperations)var2.servant;

      try {
         var3.set_elements_as_dyn_any(var1);
      } finally {
         this._servant_postinvoke(var2);
      }
   ...
   public void insert_double(double var1) throws TypeMismatch, InvalidValue {
      ...
      DynSequenceOperations var4 = (DynSequenceOperations)var3.servant;
