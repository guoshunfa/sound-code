...
public class _DynFixedStub extends ObjectImpl implements DynFixed {
   ...
   private static String[] __ids = new String[]{"IDL:omg.org/DynamicAny/DynFixed:1.0", "IDL:omg.org/DynamicAny/DynAny:1.0"};

   public String get_value() {
      ServantObject var1 = this._servant_preinvoke("get_value", _opsClass);
      DynFixedOperations var2 = (DynFixedOperations)var1.servant;
   ...
   public boolean set_value(String var1) throws TypeMismatch, InvalidValue {
      ServantObject var2 = this._servant_preinvoke("set_value", _opsClass);
      DynFixedOperations var3 = (DynFixedOperations)var2.servant;

      boolean var4;
      try {
         var4 = var3.set_value(var1);
      } finally {
   ...
   public void insert_double(double var1) throws TypeMismatch, InvalidValue {
      ...
      DynFixedOperations var4 = (DynFixedOperations)var3.servant;
