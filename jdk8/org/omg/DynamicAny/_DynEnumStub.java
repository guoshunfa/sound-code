...
public class _DynEnumStub extends ObjectImpl implements DynEnum {
   ...
   private static String[] __ids = new String[]{"IDL:omg.org/DynamicAny/DynEnum:1.0", "IDL:omg.org/DynamicAny/DynAny:1.0"};

   public String get_as_string() {
      ServantObject var1 = this._servant_preinvoke("get_as_string", _opsClass);
      DynEnumOperations var2 = (DynEnumOperations)var1.servant;

      String var3;
      try {
         var3 = var2.get_as_string();
      } finally {
   ...
   public void set_as_string(String var1) throws InvalidValue {
      ServantObject var2 = this._servant_preinvoke("set_as_string", _opsClass);
      DynEnumOperations var3 = (DynEnumOperations)var2.servant;

      try {
         var3.set_as_string(var1);
      } finally {
   ...
   public int get_as_ulong() {
      ServantObject var1 = this._servant_preinvoke("get_as_ulong", _opsClass);
      DynEnumOperations var2 = (DynEnumOperations)var1.servant;

      int var3;
      try {
         var3 = var2.get_as_ulong();
      } finally {
         this._servant_postinvoke(var1);
      }
   ...
   public void set_as_ulong(int var1) throws InvalidValue {
      ServantObject var2 = this._servant_preinvoke("set_as_ulong", _opsClass);
      DynEnumOperations var3 = (DynEnumOperations)var2.servant;

      try {
         var3.set_as_ulong(var1);
      } finally {
         this._servant_postinvoke(var2);
      }
   ...
   public void insert_double(double var1) throws TypeMismatch, InvalidValue {
      ...
      DynEnumOperations var4 = (DynEnumOperations)var3.servant;
