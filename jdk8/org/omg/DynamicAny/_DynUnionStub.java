...
public class _DynUnionStub extends ObjectImpl implements DynUnion {
   ...
   private static String[] __ids = new String[]{"IDL:omg.org/DynamicAny/DynUnion:1.0", "IDL:omg.org/DynamicAny/DynAny:1.0"};

   public DynAny get_discriminator() {
      ServantObject var1 = this._servant_preinvoke("get_discriminator", _opsClass);
      DynUnionOperations var2 = (DynUnionOperations)var1.servant;

      DynAny var3;
      try {
         var3 = var2.get_discriminator();
      } finally {
   ...
   public void set_discriminator(DynAny var1) throws TypeMismatch {
      ServantObject var2 = this._servant_preinvoke("set_discriminator", _opsClass);
      DynUnionOperations var3 = (DynUnionOperations)var2.servant;

      try {
         var3.set_discriminator(var1);
      } finally {
   ...
   public void set_to_default_member() throws TypeMismatch {
      ServantObject var1 = this._servant_preinvoke("set_to_default_member", _opsClass);
      DynUnionOperations var2 = (DynUnionOperations)var1.servant;

      try {
         var2.set_to_default_member();
      } finally {
         this._servant_postinvoke(var1);
      }
   ...
   public void set_to_no_active_member() throws TypeMismatch {
      ServantObject var1 = this._servant_preinvoke("set_to_no_active_member", _opsClass);
      DynUnionOperations var2 = (DynUnionOperations)var1.servant;

      try {
         var2.set_to_no_active_member();
      } finally {
         this._servant_postinvoke(var1);
      }
   ...
   public boolean has_no_active_member() {
      ServantObject var1 = this._servant_preinvoke("has_no_active_member", _opsClass);
      DynUnionOperations var2 = (DynUnionOperations)var1.servant;

      boolean var3;
      try {
         var3 = var2.has_no_active_member();
      } finally {
         this._servant_postinvoke(var1);
      }
   ...
   public TCKind discriminator_kind() {
      ServantObject var1 = this._servant_preinvoke("discriminator_kind", _opsClass);
      DynUnionOperations var2 = (DynUnionOperations)var1.servant;

      TCKind var3;
      try {
         var3 = var2.discriminator_kind();
      } finally {
         this._servant_postinvoke(var1);
      }
   ...
   public TCKind member_kind() throws InvalidValue {
      ServantObject var1 = this._servant_preinvoke("member_kind", _opsClass);
      DynUnionOperations var2 = (DynUnionOperations)var1.servant;

      TCKind var3;
      try {
         var3 = var2.member_kind();
      } finally {
         this._servant_postinvoke(var1);
      }
   ...
   public DynAny member() throws InvalidValue {
      ServantObject var1 = this._servant_preinvoke("member", _opsClass);
      DynUnionOperations var2 = (DynUnionOperations)var1.servant;
   ...
   public String member_name() throws InvalidValue {
      ServantObject var1 = this._servant_preinvoke("member_name", _opsClass);
      DynUnionOperations var2 = (DynUnionOperations)var1.servant;

      String var3;
      try {
         var3 = var2.member_name();
      } finally {
         this._servant_postinvoke(var1);
      }
   ...
   public void insert_double(double var1) throws TypeMismatch, InvalidValue {
      ...
      DynUnionOperations var4 = (DynUnionOperations)var3.servant;
