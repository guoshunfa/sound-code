...
public class BigInteger extends Number implements Comparable<BigInteger> {
   ...
   BigInteger(char[] var1, int var2, int var3) {
      int var4;
      for(var4 = 0; var4 < var3 && Character.digit((char)var1[var4], 10) == 0; ++var4) {
      }
   ...
   private int parseInt(char[] var1, int var2, int var3) {
      int var4 = Character.digit((char)var1[var2++], 10);
      if (var4 == -1) {
         throw new NumberFormatException(new String(var1));
      } else {
         for(int var5 = var2; var5 < var3; ++var5) {
            int var6 = Character.digit((char)var1[var5], 10);
            if (var6 == -1) {
               throw new NumberFormatException(new String(var1));
            }
   ...
   private static BigInteger multiplyByInt(int[] var0, int var1, int var2) {
      if (Integer.bitCount(var1) == 1) {
         ...
         if (var5 == 0L) {
            var4 = Arrays.copyOfRange((int[])var4, 1, var4.length);
         } else {
            var4[var9] = (int)var5;
         }
   ...
   BigInteger multiply(long var1) {
      if (var1 != 0L && this.signum != 0) {
         if (var1 == Long.MIN_VALUE) {
            ...
            if (var11 == 0L) {
               var10 = Arrays.copyOfRange((int[])var10, 1, var10.length);
            }
   ...
   private static BigInteger getRadixConversionCache(int var0, int var1) {
      ...
      if (var1 < var2.length) {
         ...
         int var3 = var2.length;
         var2 = (BigInteger[])Arrays.copyOf((Object[])var2, var1 + 1);
   ...
   private void readObject(ObjectInputStream var1) throws IOException, ClassNotFoundException {
      ...
      int var3 = var2.get("signum", (int)-2);
   ...
   private void writeObject(ObjectOutputStream var1) throws IOException {
      ...
      var2.put("bitCount", (int)-1);
      var2.put("bitLength", (int)-1);
      var2.put("lowestSetBit", (int)-2);
      var2.put("firstNonzeroByteNum", (int)-2);
      var1.writeFields();
   }
