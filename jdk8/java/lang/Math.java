...
public final class Math {
   ...
   public static long multiplyExact(long var0, long var2) {
      ...
      long var6 = abs(var0);
      long var8 = abs(var2);
      if ((var6 | var8) >>> 31 == 0L || (var2 == 0L || var4 / var2 == var0) && (var0 != Long.MIN_VALUE || var2 != -1L)) {
         return var4;
      } else {
         throw new ArithmeticException("long overflow");
      }
   ...
   public static double nextDown(double var0) {
      if (!Double.isNaN(var0) && var0 != Double.NEGATIVE_INFINITY) {
   ...
   public static float nextDown(float var0) {
      if (!Float.isNaN(var0) && var0 != Float.NEGATIVE_INFINITY) {
