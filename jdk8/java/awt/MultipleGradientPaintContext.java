...
abstract class MultipleGradientPaintContext implements PaintContext {
   ...
   protected MultipleGradientPaintContext(MultipleGradientPaint var1, ColorModel var2, Rectangle var3, Rectangle2D var4, AffineTransform var5, RenderingHints var6, float[] var7, Color[] var8, MultipleGradientPaint.CycleMethod var9, MultipleGradientPaint.ColorSpaceType var10) {
      if (var3 == null) {
         ...
         try {
            var5.invert();
            var11 = var5;
         } catch (NoninvertibleTransformException var15) {
         ...
         this.fractions = var7;
         int[] var13 = var1.gradient != null ? (int[])var1.gradient.get() : null;
         int[][] var14 = var1.gradients != null ? (int[][])var1.gradients.get() : (int[][])null;
   ...
   private void interpolate(int var1, int var2, int[] var3) {
      ...
      for(int var13 = 0; var13 < var3.length; ++var13) {
         var3[var13] = (int)((double)((float)var4 + (float)(var13 * var8) * var12) + 0.5D) << 24 | (int)((double)((float)var5 + (float)(var13 * var9) * var12) + 0.5D) << 16 | (int)((double)((float)var6 + (float)(var13 * var10) * var12) + 0.5D) << 8 | (int)((double)((float)var7 + (float)(var13 * var11) * var12) + 0.5D);
      }
   ...
   private static int convertLinearRGBtoSRGB(int var0) {
      float var1 = (float)var0 / 255.0F;
      float var2;
      if ((double)var1 <= 0.0031308D) {
         var2 = var1 * 12.92F;
      } else {
         var2 = 1.055F * (float)Math.pow((double)var1, 0.4166666666666667D) - 0.055F;
      }
