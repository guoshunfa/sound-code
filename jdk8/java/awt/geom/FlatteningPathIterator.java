...
public class FlatteningPathIterator implements PathIterator {
   ...
   public FlatteningPathIterator(PathIterator var1, double var2) {
      this(var1, var2, 10);
   }

   public FlatteningPathIterator(PathIterator var1, double var2, int var4) {
   ...
   public int currentSegment(float[] var1) {
      if (this.isDone()) {
         ...
         if (var2 != 4) {
            var1[0] = (float)this.hold[this.holdIndex + 0];
            var1[1] = (float)this.hold[this.holdIndex + 1];
            if (var2 != 0) {
               var2 = 1;
            }
         }
