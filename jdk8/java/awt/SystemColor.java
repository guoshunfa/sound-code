...
public final class SystemColor extends Color implements Serializable {
   ...
   private static void updateSystemColors() {
      ...
      for(int var0 = 0; var0 < systemColors.length; ++var0) {
         systemColorObjects[var0].value = systemColors[var0];
      }

   }

   private SystemColor(byte var1) {
      super(systemColors[var1]);
      this.index = var1;
   }
