...
class DirectCharBufferS extends CharBuffer implements DirectBuffer {
   ...
   DirectCharBufferS(DirectBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public CharBuffer slice() {
      ...
      return new DirectCharBufferS(this, -1, 0, var3, var3, var4);
   }
   ...
   public char get() {
      return Bits.swap(unsafe.getChar(this.ix(this.nextGetIndex())));
   }

   public char get(int var1) {
      return Bits.swap(unsafe.getChar(this.ix(this.checkIndex(var1))));
   }

   char getUnchecked(int var1) {
      return Bits.swap(unsafe.getChar(this.ix(var1)));
   }
   ...
   public CharBuffer put(char var1) {
      unsafe.putChar(this.ix(this.nextPutIndex()), Bits.swap(var1));
      return this;
   }

   public CharBuffer put(int var1, char var2) {
      unsafe.putChar(this.ix(this.checkIndex(var1)), Bits.swap(var2));
      return this;
   }
   ...
   public CharBuffer put(CharBuffer var1) {
      int var3;
      int var4;
      if (var1 instanceof DirectCharBufferS) {
         if (var1 == this) {
            throw new IllegalArgumentException();
         }

         DirectCharBufferS var2 = (DirectCharBufferS)var1;
         var3 = var2.position();
         var4 = var2.limit();
   ...
   public CharBuffer subSequence(int var1, int var2) {
      ...
      if (var1 >= 0 && var2 <= var5 && var1 <= var2) {
         return new DirectCharBufferS(this, -1, var3 + var1, var3 + var2, this.capacity(), this.offset);
      } else {
         throw new IndexOutOfBoundsException();
      }
   }
