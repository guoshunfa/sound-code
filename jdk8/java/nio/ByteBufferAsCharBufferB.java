...
class ByteBufferAsCharBufferB extends CharBuffer {
   ...
   ByteBufferAsCharBufferB(ByteBuffer var1) {
   ...
   ByteBufferAsCharBufferB(ByteBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public CharBuffer slice() {
      ...
      return new ByteBufferAsCharBufferB(this.bb, -1, 0, var3, var3, var4);
   }
   ...
   public char get(int var1) {
      return Bits.getCharB(this.bb, this.ix(this.checkIndex(var1)));
   }

   char getUnchecked(int var1) {
      return Bits.getCharB(this.bb, this.ix(var1));
   }

   public CharBuffer put(char var1) {
      Bits.putCharB(this.bb, this.ix(this.nextPutIndex()), var1);
      return this;
   }

   public CharBuffer put(int var1, char var2) {
      Bits.putCharB(this.bb, this.ix(this.checkIndex(var1)), var2);
      return this;
   }
   ...
   public CharBuffer subSequence(int var1, int var2) {
      ...
      if (var1 >= 0 && var2 <= var5 && var1 <= var2) {
         return new ByteBufferAsCharBufferB(this.bb, -1, var3 + var1, var3 + var2, this.capacity(), this.offset);
      } else {
         throw new IndexOutOfBoundsException();
      }
   }
