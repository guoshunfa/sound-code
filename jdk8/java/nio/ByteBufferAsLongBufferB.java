...
class ByteBufferAsLongBufferB extends LongBuffer {
   ...
   ByteBufferAsLongBufferB(ByteBuffer var1) {
   ...
   ByteBufferAsLongBufferB(ByteBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public LongBuffer slice() {
      ...
      return new ByteBufferAsLongBufferB(this.bb, -1, 0, var3, var3, var4);
   }
   ...
   public long get(int var1) {
      return Bits.getLongB(this.bb, this.ix(this.checkIndex(var1)));
   }

   public LongBuffer put(long var1) {
      Bits.putLongB(this.bb, this.ix(this.nextPutIndex()), var1);
      return this;
   }

   public LongBuffer put(int var1, long var2) {
      Bits.putLongB(this.bb, this.ix(this.checkIndex(var1)), var2);
      return this;
   }
