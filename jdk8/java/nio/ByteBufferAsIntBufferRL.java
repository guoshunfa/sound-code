...
class ByteBufferAsIntBufferRL extends ByteBufferAsIntBufferL {
   ByteBufferAsIntBufferRL(ByteBuffer var1) {
      super(var1);
   }

   ByteBufferAsIntBufferRL(ByteBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public IntBuffer slice() {
      ...
      return new ByteBufferAsIntBufferRL(this.bb, -1, 0, var3, var3, var4);
   }
