...
class DirectCharBufferRU extends DirectCharBufferU implements DirectBuffer {
   DirectCharBufferRU(DirectBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public CharBuffer slice() {
      ...
      return new DirectCharBufferRU(this, -1, 0, var3, var3, var4);
   }
   ...
   public CharBuffer subSequence(int var1, int var2) {
      ...
      if (var1 >= 0 && var2 <= var5 && var1 <= var2) {
         return new DirectCharBufferRU(this, -1, var3 + var1, var3 + var2, this.capacity(), this.offset);
      } else {
         throw new IndexOutOfBoundsException();
      }
   }
