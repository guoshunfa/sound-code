...
class ByteBufferAsShortBufferB extends ShortBuffer {
   ...
   ByteBufferAsShortBufferB(ByteBuffer var1) {
   ...
   ByteBufferAsShortBufferB(ByteBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public ShortBuffer slice() {
      ...
      return new ByteBufferAsShortBufferB(this.bb, -1, 0, var3, var3, var4);
   }
   ...
   public short get(int var1) {
      return Bits.getShortB(this.bb, this.ix(this.checkIndex(var1)));
   }

   public ShortBuffer put(short var1) {
      Bits.putShortB(this.bb, this.ix(this.nextPutIndex()), var1);
      return this;
   }

   public ShortBuffer put(int var1, short var2) {
      Bits.putShortB(this.bb, this.ix(this.checkIndex(var1)), var2);
      return this;
   }
