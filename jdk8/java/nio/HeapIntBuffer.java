...
class HeapIntBuffer extends IntBuffer {
   HeapIntBuffer(int var1, int var2) {
      super(-1, 0, var2, var1, new int[var1], 0);
   }

   HeapIntBuffer(int[] var1, int var2, int var3) {
      super(-1, var2, var2 + var3, var1.length, var1, 0);
   }

   protected HeapIntBuffer(int[] var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public IntBuffer put(IntBuffer var1) {
      if (var1 instanceof HeapIntBuffer) {
         if (var1 == this) {
            throw new IllegalArgumentException();
         }

         HeapIntBuffer var2 = (HeapIntBuffer)var1;
