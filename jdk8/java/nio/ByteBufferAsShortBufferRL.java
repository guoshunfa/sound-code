...
class ByteBufferAsShortBufferRL extends ByteBufferAsShortBufferL {
   ByteBufferAsShortBufferRL(ByteBuffer var1) {
      super(var1);
   }

   ByteBufferAsShortBufferRL(ByteBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public ShortBuffer slice() {
      ...
      return new ByteBufferAsShortBufferRL(this.bb, -1, 0, var3, var3, var4);
   }
