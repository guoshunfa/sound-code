...
class DirectFloatBufferU extends FloatBuffer implements DirectBuffer {
   ...
   DirectFloatBufferU(DirectBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public FloatBuffer slice() {
      ...
      return new DirectFloatBufferU(this, -1, 0, var3, var3, var4);
   }
   ...
   public float get(int var1) {
      return unsafe.getFloat(this.ix(this.checkIndex(var1)));
   }
   ...
   public FloatBuffer put(float var1) {
      unsafe.putFloat(this.ix(this.nextPutIndex()), var1);
      return this;
   }

   public FloatBuffer put(int var1, float var2) {
      unsafe.putFloat(this.ix(this.checkIndex(var1)), var2);
      return this;
   }
   ...
   public FloatBuffer put(FloatBuffer var1) {
      int var3;
      int var4;
      if (var1 instanceof DirectFloatBufferU) {
         if (var1 == this) {
            throw new IllegalArgumentException();
         }

         DirectFloatBufferU var2 = (DirectFloatBufferU)var1;
         var3 = var2.position();
         var4 = var2.limit();
