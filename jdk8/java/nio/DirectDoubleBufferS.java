...
class DirectDoubleBufferS extends DoubleBuffer implements DirectBuffer {
   ...
   DirectDoubleBufferS(DirectBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public DoubleBuffer slice() {
      ...
      return new DirectDoubleBufferS(this, -1, 0, var3, var3, var4);
   }
   ...
   public double get() {
      return Double.longBitsToDouble(Bits.swap(unsafe.getLong(this.ix(this.nextGetIndex()))));
   }

   public double get(int var1) {
      return Double.longBitsToDouble(Bits.swap(unsafe.getLong(this.ix(this.checkIndex(var1)))));
   }
   ...
   public DoubleBuffer put(double var1) {
      unsafe.putLong(this.ix(this.nextPutIndex()), Bits.swap(Double.doubleToRawLongBits(var1)));
      return this;
   }

   public DoubleBuffer put(int var1, double var2) {
      unsafe.putLong(this.ix(this.checkIndex(var1)), Bits.swap(Double.doubleToRawLongBits(var2)));
      return this;
   }
   ...
   public DoubleBuffer put(DoubleBuffer var1) {
      int var3;
      int var4;
      if (var1 instanceof DirectDoubleBufferS) {
         if (var1 == this) {
            throw new IllegalArgumentException();
         }

         DirectDoubleBufferS var2 = (DirectDoubleBufferS)var1;
         var3 = var2.position();
         var4 = var2.limit();
