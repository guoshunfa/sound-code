...
class ByteBufferAsCharBufferRB extends ByteBufferAsCharBufferB {
   ByteBufferAsCharBufferRB(ByteBuffer var1) {
      super(var1);
   }

   ByteBufferAsCharBufferRB(ByteBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public CharBuffer slice() {
      ...
      return new ByteBufferAsCharBufferRB(this.bb, -1, 0, var3, var3, var4);
   }
   ...
   public CharBuffer subSequence(int var1, int var2) {
      ...
      if (var1 >= 0 && var2 <= var5 && var1 <= var2) {
         return new ByteBufferAsCharBufferRB(this.bb, -1, var3 + var1, var3 + var2, this.capacity(), this.offset);
      } else {
         throw new IndexOutOfBoundsException();
      }
   }
