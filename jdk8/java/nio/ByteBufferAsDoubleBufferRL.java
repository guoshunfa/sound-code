...
class ByteBufferAsDoubleBufferRL extends ByteBufferAsDoubleBufferL {
   ByteBufferAsDoubleBufferRL(ByteBuffer var1) {
      super(var1);
   }

   ByteBufferAsDoubleBufferRL(ByteBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public DoubleBuffer slice() {
      ...
      return new ByteBufferAsDoubleBufferRL(this.bb, -1, 0, var3, var3, var4);
   }
