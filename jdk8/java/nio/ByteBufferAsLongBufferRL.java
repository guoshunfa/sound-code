...
class ByteBufferAsLongBufferRL extends ByteBufferAsLongBufferL {
   ByteBufferAsLongBufferRL(ByteBuffer var1) {
      super(var1);
   }

   ByteBufferAsLongBufferRL(ByteBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public LongBuffer slice() {
      ...
      return new ByteBufferAsLongBufferRL(this.bb, -1, 0, var3, var3, var4);
   }
