...
class DirectShortBufferS extends ShortBuffer implements DirectBuffer {
   ...
   DirectShortBufferS(DirectBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public ShortBuffer slice() {
      ...
      return new DirectShortBufferS(this, -1, 0, var3, var3, var4);
   }
   ...
   public short get(int var1) {
      return Bits.swap(unsafe.getShort(this.ix(this.checkIndex(var1))));
   }
   ...
   public ShortBuffer put(short var1) {
      unsafe.putShort(this.ix(this.nextPutIndex()), Bits.swap(var1));
      return this;
   }

   public ShortBuffer put(int var1, short var2) {
      unsafe.putShort(this.ix(this.checkIndex(var1)), Bits.swap(var2));
      return this;
   }
   ...
   public ShortBuffer put(ShortBuffer var1) {
      int var3;
      int var4;
      if (var1 instanceof DirectShortBufferS) {
         if (var1 == this) {
            throw new IllegalArgumentException();
         }

         DirectShortBufferS var2 = (DirectShortBufferS)var1;
         var3 = var2.position();
         var4 = var2.limit();
