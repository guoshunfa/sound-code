...
class DirectLongBufferS extends LongBuffer implements DirectBuffer {
   ...
   DirectLongBufferS(DirectBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public LongBuffer slice() {
      ...
      return new DirectLongBufferS(this, -1, 0, var3, var3, var4);
   }
   ...
   public long get(int var1) {
      return Bits.swap(unsafe.getLong(this.ix(this.checkIndex(var1))));
   }
   ...
   public LongBuffer put(long var1) {
      unsafe.putLong(this.ix(this.nextPutIndex()), Bits.swap(var1));
      return this;
   }

   public LongBuffer put(int var1, long var2) {
      unsafe.putLong(this.ix(this.checkIndex(var1)), Bits.swap(var2));
      return this;
   }
   ...
   public LongBuffer put(LongBuffer var1) {
      int var3;
      int var4;
      if (var1 instanceof DirectLongBufferS) {
         if (var1 == this) {
            throw new IllegalArgumentException();
         }

         DirectLongBufferS var2 = (DirectLongBufferS)var1;
         var3 = var2.position();
         var4 = var2.limit();
