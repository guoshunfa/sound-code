...
class DirectIntBufferS extends IntBuffer implements DirectBuffer {
   ...
   public int get(int var1) {
      return Bits.swap(unsafe.getInt(this.ix(this.checkIndex(var1))));
   }
   ...
   public IntBuffer put(int var1) {
      unsafe.putInt(this.ix(this.nextPutIndex()), Bits.swap(var1));
      return this;
   }

   public IntBuffer put(int var1, int var2) {
      unsafe.putInt(this.ix(this.checkIndex(var1)), Bits.swap(var2));
      return this;
   }
