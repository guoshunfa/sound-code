...
class ByteBufferAsFloatBufferRB extends ByteBufferAsFloatBufferB {
   ByteBufferAsFloatBufferRB(ByteBuffer var1) {
      super(var1);
   }

   ByteBufferAsFloatBufferRB(ByteBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public FloatBuffer slice() {
      ...
      return new ByteBufferAsFloatBufferRB(this.bb, -1, 0, var3, var3, var4);
   }
