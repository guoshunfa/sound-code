...
class ByteBufferAsFloatBufferL extends FloatBuffer {
   ...
   ByteBufferAsFloatBufferL(ByteBuffer var1) {
   ...
   ByteBufferAsFloatBufferL(ByteBuffer var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public FloatBuffer slice() {
      ...
      return new ByteBufferAsFloatBufferL(this.bb, -1, 0, var3, var3, var4);
   }
   ...
   public float get(int var1) {
      return Bits.getFloatL(this.bb, this.ix(this.checkIndex(var1)));
   }

   public FloatBuffer put(float var1) {
      Bits.putFloatL(this.bb, this.ix(this.nextPutIndex()), var1);
      return this;
   }

   public FloatBuffer put(int var1, float var2) {
      Bits.putFloatL(this.bb, this.ix(this.checkIndex(var1)), var2);
      return this;
   }
