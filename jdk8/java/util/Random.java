...
public class Random implements Serializable {
   ...
   public IntStream ints(long var1) {
      if (var1 < 0L) {
         ...
         return StreamSupport.intStream(new Random.RandomIntsSpliterator(this, 0L, var1, Integer.MAX_VALUE, 0), false);
      }
   }

   public IntStream ints() {
      return StreamSupport.intStream(new Random.RandomIntsSpliterator(this, 0L, Long.MAX_VALUE, Integer.MAX_VALUE, 0), false);
   }
   ...
   public IntStream ints(int var1, int var2) {
      if (var1 >= var2) {
         ...
         return StreamSupport.intStream(new Random.RandomIntsSpliterator(this, 0L, Long.MAX_VALUE, var1, var2), false);
      }
   }
   ...
   public LongStream longs(long var1) {
      if (var1 < 0L) {
         ...
         return StreamSupport.longStream(new Random.RandomLongsSpliterator(this, 0L, var1, Long.MAX_VALUE, 0L), false);
      }
   }

   public LongStream longs() {
      return StreamSupport.longStream(new Random.RandomLongsSpliterator(this, 0L, Long.MAX_VALUE, Long.MAX_VALUE, 0L), false);
   }
   ...
   public LongStream longs(long var1, long var3) {
      if (var1 >= var3) {
         ...
         return StreamSupport.longStream(new Random.RandomLongsSpliterator(this, 0L, Long.MAX_VALUE, var1, var3), false);
      }
   }
   ...
   public DoubleStream doubles(long var1) {
      if (var1 < 0L) {
         ...
         return StreamSupport.doubleStream(new Random.RandomDoublesSpliterator(this, 0L, var1, Double.MAX_VALUE, 0.0D), false);
      }
   }

   public DoubleStream doubles() {
      return StreamSupport.doubleStream(new Random.RandomDoublesSpliterator(this, 0L, Long.MAX_VALUE, Double.MAX_VALUE, 0.0D), false);
   }
   ...
   public DoubleStream doubles(double var1, double var3) {
      if (var1 >= var3) {
         ...
         return StreamSupport.doubleStream(new Random.RandomDoublesSpliterator(this, 0L, Long.MAX_VALUE, var1, var3), false);
      }
   }
