...
public class HashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, Cloneable, Serializable {
   ...
   final HashMap.Node<K, V> removeNode(int var1, Object var2, Object var3, boolean var4, boolean var5) {
      ...
      int var8;
      int var9;
      if ((var6 = this.table) != null && (var8 = var6.length) > 0 && (var7 = var6[var9 = var8 - 1 & var1]) != null) {
         Object var10 = null;
         Object var12;
         if (var7.hash == var1 && ((var12 = var7.key) == var2 || var2 != null && var2.equals(var12))) {
            var10 = var7;
         } else {
            HashMap.Node var11;
            if ((var11 = var7.next) != null) {
               if (var7 instanceof HashMap.TreeNode) {
                  ...
                  label88: {
                     while(var11.hash != var1 || (var12 = var11.key) != var2 && (var2 == null || !var2.equals(var12))) {
                        var7 = var11;
         ...
         Object var13;
         if (var10 != null && (!var4 || (var13 = ((HashMap.Node)var10).value) == var3 || var3 != null && var3.equals(var13))) {
   ...
   public boolean containsValue(Object var1) {
      HashMap.Node[] var2;
      if ((var2 = this.table) != null && this.size > 0) {
         for(int var4 = 0; var4 < var2.length; ++var4) {
            for(HashMap.Node var5 = var2[var4]; var5 != null; var5 = var5.next) {
               Object var3;
               if ((var3 = var5.value) == var1 || var1 != null && var1.equals(var3)) {
                  return true;
               }
            }
         }
   ...
   public boolean replace(K var1, V var2, V var3) {
      HashMap.Node var4;
      Object var5;
      if ((var4 = this.getNode(hash(var1), var1)) == null || (var5 = var4.value) != var2 && (var5 == null || !var5.equals(var2))) {
         return false;
      } else {
         var4.value = var3;
   ...
   public V computeIfAbsent(K var1, Function<? super K, ? extends V> var2) {
      if (var2 == null) {
         ...
         HashMap.Node[] var4;
         int var6;
         if (this.size > this.threshold || (var4 = this.table) == null || (var6 = var4.length) == 0) {
         ...
         if ((var5 = var4[var7 = var6 - 1 & var3]) != null) {
            if (var5 instanceof HashMap.TreeNode) {
               ...
               label69: {
                  ...
                  Object var12;
                  while(var11.hash != var3 || (var12 = var11.key) != var1 && (var1 == null || !var1.equals(var12))) {
                     ++var8;
                     if ((var11 = var11.next) == null) {
                        break label69;
                     }
            ...
            if (var10 != null && (var13 = ((HashMap.Node)var10).value) != null) {
               this.afterNodeAccess((HashMap.Node)var10);
               return var13;
            }
         }
   ...
   public V computeIfPresent(K var1, BiFunction<? super K, ? super V, ? extends V> var2) {
      if (var2 == null) {
         ...
         HashMap.Node var3;
         Object var4;
         if ((var3 = this.getNode(var5, var1)) != null && (var4 = var3.value) != null) {
   ...
   public V merge(K var1, V var2, BiFunction<? super V, ? super V, ? extends V> var3) {
      if (var2 == null) {
         ...
         int var4 = hash(var1);
         int var9 = 0;
         HashMap.TreeNode var10 = null;
         Object var11 = null;
         HashMap.Node[] var5;
         int var7;
         if (this.size > this.threshold || (var5 = this.table) == null || (var7 = var5.length) == 0) {
         ...
         if ((var6 = var5[var8 = var7 - 1 & var4]) != null) {
            if (var6 instanceof HashMap.TreeNode) {
               ...
               label74: {
                  ...
                  Object var13;
                  while(var12.hash != var4 || (var13 = var12.key) != var1 && (var1 == null || !var1.equals(var13))) {
                     ++var9;
                     if ((var12 = var12.next) == null) {
                        break label74;
                     }
                  }
   ...
   public void forEach(BiConsumer<? super K, ? super V> var1) {
      if (var1 == null) {
         ...
         HashMap.Node[] var2;
         if (this.size > 0 && (var2 = this.table) != null) {
   ...
   static final class TreeNode<K, V> extends LinkedHashMap.Entry<K, V> {
      ...
      final HashMap.TreeNode<K, V> root() {
         HashMap.TreeNode var1;
         HashMap.TreeNode var2;
      ...
      final void removeTreeNode(HashMap<K, V> var1, HashMap.Node<K, V>[] var2, boolean var3) {
         ...
         if (var2 != null && (var4 = var2.length) != 0) {
            ...
            if (var6 != null) {
               ...
               HashMap.TreeNode var8;
               if (var7 != null && var7.right != null && (var8 = var7.left) != null && var8.left != null) {
   ...
   static final class EntrySpliterator<K, V> extends HashMap.HashMapSpliterator<K, V> implements Spliterator<Map.Entry<K, V>> {
      ...
      public void forEachRemaining(Consumer<? super Map.Entry<K, V>> var1) {
         if (var1 == null) {
            ...
            int var2;
            if (var6 != null && var6.length >= var3 && (var2 = this.index) >= 0 && (var2 < (this.index = var3) || this.current != null)) {
   ...
   abstract class HashIterator {
      ...
      final HashMap.Node<K, V> nextNode() {
         ...
         if (HashMap.this.modCount != this.expectedModCount) {
            ...
            HashMap.Node[] var1;
            if ((this.next = (this.current = var2).next) == null && (var1 = HashMap.this.table) != null) {
